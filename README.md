...
This project hosts the Ads common framework for Ruby, as well as the Ruby
client libraries for the various SOAP-based Ads APIs at Google such as
Ad Manager. It also contains example code to help you get started integrating
with our APIs.
...
1. Install your library of choice RubyGems.

        $ gem install google-dfp-api

2. Copy the sample config file (**ad_manager_api.yml**) to your home directory
...
## Logging
 ...
 To enable logging, see the library-specific README files
 [Ad Manager](https://github.com/googleads/google-api-ads-ruby/blob/HEAD/ad_manager_api/README.md#how-do-i-enable-logging).
