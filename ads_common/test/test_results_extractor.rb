...
class TestResultsExtractor < Minitest::Test
  ...
  def test_normalize_item_int
    ...
    result2 = @extractor.normalize_item(2_147_483_648, type: 'int')
    assert_kind_of(Integer, result2)
    assert_equal(2_147_483_648, result2, 'bad conversion')
  end
  ...
  def test_normalize_item_long
    result1 = @extractor.normalize_item(2_147_483_648,
                                        type: 'long')
    assert_kind_of(Integer, result1)
    assert_equal(2_147_483_648, result1, 'bad conversion')
