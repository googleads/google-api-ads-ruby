  ...
  # library setup.
  require 'adwords_api/v200909/GeoLocationServiceDriver.rb'

  module AdwordsApi
    module V200909
      module GeoLocationService

        # Wrapper class for the v200909 GeoLocationService service.
        ...
        class GeoLocationServiceWrapper
          ...
          REGISTRY = AdwordsApi::V200909::GeoLocationService::DefaultMappingRegistry::LiteralRegistry
          ...
          # instead of
          #  AdwordsApi::V200909::GeoLocationService::ClassName
          ...
          def initialize(driver, api)
            @driver = driver
            @api = api
            @module = AdwordsApi::V200909::GeoLocationService
            @version = :v200909
          ...
          # Calls the {get}[http://code.google.com/apis/adwords/docs/reference/v200909/GeoLocationService.html#get] method of the GeoLocationService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v200909/GeoLocationService.html#get].
          #
          # Args:
            # - selector: AdwordsApi::V200909::GeoLocationService::GeoLocationSelector
            #
            # Returns:
            # - rval: SOAP::SOAPArray of AdwordsApi::V200909::GeoLocationService::GeoLocation
          #
          # Raises:
          ...
          def get(selector)
            begin
              arg_array = []
                validate_object(selector, AdwordsApi::V200909::GeoLocationService::GeoLocationSelector)
                arg_array << convert_to_object(selector, AdwordsApi::V200909::GeoLocationService::Get,
                    'selector')
              # Construct request object and make API call
              obj = AdwordsApi::V200909::GeoLocationService::Get.new(*arg_array)
