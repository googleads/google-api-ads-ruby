  ...
  # library setup.
  require 'adwords_api/v200909/AdGroupAdServiceDriver.rb'

  module AdwordsApi
    module V200909
      module AdGroupAdService

        # Wrapper class for the v200909 AdGroupAdService service.
        ...
        class AdGroupAdServiceWrapper
          ...
          REGISTRY = AdwordsApi::V200909::AdGroupAdService::DefaultMappingRegistry::LiteralRegistry
          ...
          # instead of
          #  AdwordsApi::V200909::AdGroupAdService::ClassName
          ...
          def initialize(driver, api)
            @driver = driver
            @api = api
            @module = AdwordsApi::V200909::AdGroupAdService
            @version = :v200909
          ...
          # Calls the {get}[http://code.google.com/apis/adwords/docs/reference/v200909/AdGroupAdService.html#get] method of the AdGroupAdService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v200909/AdGroupAdService.html#get].
          #
          # Args:
          ...
          def get(selector)
            begin
              arg_array = []
                validate_object(selector, AdwordsApi::V200909::AdGroupAdService::AdGroupAdSelector)
                arg_array << convert_to_object(selector, AdwordsApi::V200909::AdGroupAdService::Get,
                    'selector')
              # Construct request object and make API call
              obj = AdwordsApi::V200909::AdGroupAdService::Get.new(*arg_array)
          ...
          # Calls the {mutate}[http://code.google.com/apis/adwords/docs/reference/v200909/AdGroupAdService.html#mutate] method of the AdGroupAdService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v200909/AdGroupAdService.html#mutate].
          #
          # Args:
            # - operations: SOAP::SOAPArray of AdwordsApi::V200909::AdGroupAdService::AdGroupAdOperation
            #
            # Returns:
          ...
          def mutate(operations)
            begin
              arg_array = []
                ...
                arg_array << convert_to_object(operations, AdwordsApi::V200909::AdGroupAdService::Mutate,
                    'operations')
              # Construct request object and make API call
              obj = AdwordsApi::V200909::AdGroupAdService::Mutate.new(*arg_array)
