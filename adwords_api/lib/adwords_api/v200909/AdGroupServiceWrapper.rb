  ...
  # library setup.
  require 'adwords_api/v200909/AdGroupServiceDriver.rb'

  module AdwordsApi
    module V200909
      module AdGroupService

        # Wrapper class for the v200909 AdGroupService service.
        ...
        class AdGroupServiceWrapper
          ...
          REGISTRY = AdwordsApi::V200909::AdGroupService::DefaultMappingRegistry::LiteralRegistry
          ...
          # instead of
          #  AdwordsApi::V200909::AdGroupService::ClassName
          ...
          def initialize(driver, api)
            @driver = driver
            @api = api
            @module = AdwordsApi::V200909::AdGroupService
            @version = :v200909
          ...
          # Calls the {get}[http://code.google.com/apis/adwords/docs/reference/v200909/AdGroupService.html#get] method of the AdGroupService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v200909/AdGroupService.html#get].
          #
          # Args:
          ...
          def get(selector)
            begin
              arg_array = []
                validate_object(selector, AdwordsApi::V200909::AdGroupService::AdGroupSelector)
                arg_array << convert_to_object(selector, AdwordsApi::V200909::AdGroupService::Get,
                    'selector')
              # Construct request object and make API call
              obj = AdwordsApi::V200909::AdGroupService::Get.new(*arg_array)
          ...
          # Calls the {mutate}[http://code.google.com/apis/adwords/docs/reference/v200909/AdGroupService.html#mutate] method of the AdGroupService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v200909/AdGroupService.html#mutate].
          #
          # Args:
            # - operations: SOAP::SOAPArray of AdwordsApi::V200909::AdGroupService::AdGroupOperation
            #
            # Returns:
          ...
          def mutate(operations)
            begin
              arg_array = []
                ...
                arg_array << convert_to_object(operations, AdwordsApi::V200909::AdGroupService::Mutate,
                    'operations')
              # Construct request object and make API call
              obj = AdwordsApi::V200909::AdGroupService::Mutate.new(*arg_array)
