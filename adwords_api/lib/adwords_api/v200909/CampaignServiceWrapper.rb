  ...
  # library setup.
  require 'adwords_api/v200909/CampaignServiceDriver.rb'

  module AdwordsApi
    module V200909
      module CampaignService

        # Wrapper class for the v200909 CampaignService service.
        ...
        class CampaignServiceWrapper
          ...
          REGISTRY = AdwordsApi::V200909::CampaignService::DefaultMappingRegistry::LiteralRegistry
          ...
          # instead of
          #  AdwordsApi::V200909::CampaignService::ClassName
          ...
          def initialize(driver, api)
            @driver = driver
            @api = api
            @module = AdwordsApi::V200909::CampaignService
            @version = :v200909
          ...
          # Calls the {get}[http://code.google.com/apis/adwords/docs/reference/v200909/CampaignService.html#get] method of the CampaignService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v200909/CampaignService.html#get].
          #
          # Args:
          ...
          def get(selector)
            begin
              arg_array = []
                validate_object(selector, AdwordsApi::V200909::CampaignService::CampaignSelector)
                arg_array << convert_to_object(selector, AdwordsApi::V200909::CampaignService::Get,
                    'selector')
              # Construct request object and make API call
              obj = AdwordsApi::V200909::CampaignService::Get.new(*arg_array)
          ...
          # Calls the {mutate}[http://code.google.com/apis/adwords/docs/reference/v200909/CampaignService.html#mutate] method of the CampaignService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v200909/CampaignService.html#mutate].
          #
          # Args:
            # - operations: SOAP::SOAPArray of AdwordsApi::V200909::CampaignService::CampaignOperation
            #
            # Returns:
          ...
          def mutate(operations)
            begin
              arg_array = []
                ...
                arg_array << convert_to_object(operations, AdwordsApi::V200909::CampaignService::Mutate,
                    'operations')
              # Construct request object and make API call
              obj = AdwordsApi::V200909::CampaignService::Mutate.new(*arg_array)
