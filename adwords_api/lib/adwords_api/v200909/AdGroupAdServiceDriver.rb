...
require 'adwords_api/v200909/AdGroupAdServiceMappingRegistry'
...
class AdGroupAdServiceInterface < ::SOAP::RPC::Driver
  DefaultEndpointUrl = "https://adwords.google.com:443/api/adwords/cm/v200909/AdGroupAdService"
  ...
  Methods = [
    [ "",
      ...
      { :request_style =>  :document, :request_use =>  :literal,
        ...
        :faults => {"AdwordsApi::V200909::AdGroupAdService::ApiException"=>{:encodingstyle=>"document", :namespace=>nil, :ns=>"https://adwords.google.com/api/adwords/cm/v200909", :use=>"literal", :name=>"ApiException"}} }
    ],
    [ "",
      "mutate",
