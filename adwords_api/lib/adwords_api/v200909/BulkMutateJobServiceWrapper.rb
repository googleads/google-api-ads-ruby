  ...
  # library setup.
  require 'adwords_api/v200909/BulkMutateJobServiceDriver.rb'

  module AdwordsApi
    module V200909
      module BulkMutateJobService

        # Wrapper class for the v200909 BulkMutateJobService service.
        ...
        class BulkMutateJobServiceWrapper
          ...
          REGISTRY = AdwordsApi::V200909::BulkMutateJobService::DefaultMappingRegistry::LiteralRegistry
          ...
          # instead of
          #  AdwordsApi::V200909::BulkMutateJobService::ClassName
          ...
          def initialize(driver, api)
            @driver = driver
            @api = api
            @module = AdwordsApi::V200909::BulkMutateJobService
            @version = :v200909
          ...
          # Calls the {get}[http://code.google.com/apis/adwords/docs/reference/v200909/BulkMutateJobService.html#get] method of the BulkMutateJobService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v200909/BulkMutateJobService.html#get].
          #
          # Args:
            # - selector: AdwordsApi::V200909::BulkMutateJobService::BulkMutateJobSelector
            #
            # Returns:
            # - rval: SOAP::SOAPArray of AdwordsApi::V200909::BulkMutateJobService::BulkMutateJob
          #
          # Raises:
          ...
          def get(selector)
            begin
              arg_array = []
                validate_object(selector, AdwordsApi::V200909::BulkMutateJobService::BulkMutateJobSelector)
                arg_array << convert_to_object(selector, AdwordsApi::V200909::BulkMutateJobService::Get,
                    'selector')
              # Construct request object and make API call
              obj = AdwordsApi::V200909::BulkMutateJobService::Get.new(*arg_array)
          ...
          # Calls the {mutate}[http://code.google.com/apis/adwords/docs/reference/v200909/BulkMutateJobService.html#mutate] method of the BulkMutateJobService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v200909/BulkMutateJobService.html#mutate].
          #
          # Args:
          ...
          def mutate(operation)
            begin
              arg_array = []
                validate_object(operation, AdwordsApi::V200909::BulkMutateJobService::JobOperation)
                arg_array << convert_to_object(operation, AdwordsApi::V200909::BulkMutateJobService::Mutate,
                    'operation')
              # Construct request object and make API call
              obj = AdwordsApi::V200909::BulkMutateJobService::Mutate.new(*arg_array)
