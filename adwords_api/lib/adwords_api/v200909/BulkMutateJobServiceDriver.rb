...
require 'adwords_api/v200909/BulkMutateJobServiceMappingRegistry'
  ...
  Methods = [
    [ "",
      ...
      { :request_style =>  :document, :request_use =>  :literal,
        ...
        :faults => {"AdwordsApi::V200909::BulkMutateJobService::ApiException"=>{:ns=>"https://adwords.google.com/api/adwords/cm/v200909", :encodingstyle=>"document", :use=>"literal", :name=>"ApiException", :namespace=>nil}} }
    ],
    [ "",
      "mutate",
