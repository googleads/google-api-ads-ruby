  ...
  # library setup.
  require 'adwords_api/v200909/TargetingIdeaServiceDriver.rb'

  module AdwordsApi
    module V200909
      module TargetingIdeaService

        # Wrapper class for the v200909 TargetingIdeaService service.
        ...
        class TargetingIdeaServiceWrapper
          ...
          REGISTRY = AdwordsApi::V200909::TargetingIdeaService::DefaultMappingRegistry::LiteralRegistry
          ...
          # instead of
          #  AdwordsApi::V200909::TargetingIdeaService::ClassName
          ...
          def initialize(driver, api)
            @driver = driver
            @api = api
            @module = AdwordsApi::V200909::TargetingIdeaService
            @version = :v200909
          ...
          # Calls the {get}[http://code.google.com/apis/adwords/docs/reference/v200909/TargetingIdeaService.html#get] method of the TargetingIdeaService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v200909/TargetingIdeaService.html#get].
          #
          # Args:
          ...
          def get(selector)
            begin
              arg_array = []
                validate_object(selector, AdwordsApi::V200909::TargetingIdeaService::TargetingIdeaSelector)
                arg_array << convert_to_object(selector, AdwordsApi::V200909::TargetingIdeaService::Get,
                    'selector')
              # Construct request object and make API call
              obj = AdwordsApi::V200909::TargetingIdeaService::Get.new(*arg_array)
          ...
          # Calls the {getBulkKeywordIdeas}[http://code.google.com/apis/adwords/docs/reference/v200909/TargetingIdeaService.html#getBulkKeywordIdeas] method of the TargetingIdeaService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v200909/TargetingIdeaService.html#getBulkKeywordIdeas].
          #
          # Args:
            # - selector: AdwordsApi::V200909::TargetingIdeaService::TargetingIdeaSelector
            #
          ...
          def getBulkKeywordIdeas(selector)
            begin
              arg_array = []
                validate_object(selector, AdwordsApi::V200909::TargetingIdeaService::TargetingIdeaSelector)
                arg_array << convert_to_object(selector, AdwordsApi::V200909::TargetingIdeaService::GetBulkKeywordIdeas,
                    'selector')
              # Construct request object and make API call
              obj = AdwordsApi::V200909::TargetingIdeaService::GetBulkKeywordIdeas.new(*arg_array)
