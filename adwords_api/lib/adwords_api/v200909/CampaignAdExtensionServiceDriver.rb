  ...
  Methods = [
    [ "",
      ...
      { :request_style =>  :document, :request_use =>  :literal,
        ...
        :faults => {"AdwordsApi::V200909::CampaignAdExtensionService::ApiException"=>{:encodingstyle=>"document", :ns=>"https://adwords.google.com/api/adwords/cm/v200909", :name=>"ApiException", :use=>"literal", :namespace=>nil}} }
    ],
    [ "",
      "mutate",
