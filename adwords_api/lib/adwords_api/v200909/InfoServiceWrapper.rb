  ...
  # library setup.
  require 'adwords_api/v200909/InfoServiceDriver.rb'

  module AdwordsApi
    module V200909
      module InfoService

        # Wrapper class for the v200909 InfoService service.
        ...
        class InfoServiceWrapper
          ...
          REGISTRY = AdwordsApi::V200909::InfoService::DefaultMappingRegistry::LiteralRegistry
          ...
          # instead of
          #  AdwordsApi::V200909::InfoService::ClassName
          ...
          def initialize(driver, api)
            @driver = driver
            @api = api
            @module = AdwordsApi::V200909::InfoService
            @version = :v200909
            @service = :InfoService
          end
          ...
          # Calls the {get}[http://code.google.com/apis/adwords/docs/reference/v200909/InfoService.html#get] method of the InfoService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v200909/InfoService.html#get].
          #
          # Args:
          ...
          def get(selector)
            begin
              arg_array = []
                validate_object(selector, AdwordsApi::V200909::InfoService::InfoSelector)
                arg_array << convert_to_object(selector, AdwordsApi::V200909::InfoService::Get,
                    'selector')
              # Construct request object and make API call
              obj = AdwordsApi::V200909::InfoService::Get.new(*arg_array)
