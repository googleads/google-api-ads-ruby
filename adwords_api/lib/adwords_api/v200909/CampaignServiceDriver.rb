...
require 'adwords_api/v200909/CampaignServiceMappingRegistry'
  ...
  Methods = [
    [ "",
      ...
      { :request_style =>  :document, :request_use =>  :literal,
        ...
        :faults => {"AdwordsApi::V200909::CampaignService::ApiException"=>{:ns=>"https://adwords.google.com/api/adwords/cm/v200909", :encodingstyle=>"document", :use=>"literal", :name=>"ApiException", :namespace=>nil}} }
    ],
    [ "",
      "mutate",
