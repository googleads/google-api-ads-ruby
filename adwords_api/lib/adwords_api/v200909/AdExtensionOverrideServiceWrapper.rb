  ...
  # library setup.
  require 'adwords_api/v200909/AdExtensionOverrideServiceDriver.rb'

  module AdwordsApi
    module V200909
      module AdExtensionOverrideService

        # Wrapper class for the v200909 AdExtensionOverrideService service.
        ...
        class AdExtensionOverrideServiceWrapper
          ...
          REGISTRY = AdwordsApi::V200909::AdExtensionOverrideService::DefaultMappingRegistry::LiteralRegistry
          ...
          # instead of
          #  AdwordsApi::V200909::AdExtensionOverrideService::ClassName
          ...
          def initialize(driver, api)
            @driver = driver
            @api = api
            @module = AdwordsApi::V200909::AdExtensionOverrideService
            @version = :v200909
          ...
          # Calls the {get}[http://code.google.com/apis/adwords/docs/reference/v200909/AdExtensionOverrideService.html#get] method of the AdExtensionOverrideService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v200909/AdExtensionOverrideService.html#get].
          #
          # Args:
          ...
          def get(selector)
            begin
              arg_array = []
                validate_object(selector, AdwordsApi::V200909::AdExtensionOverrideService::AdExtensionOverrideSelector)
                arg_array << convert_to_object(selector, AdwordsApi::V200909::AdExtensionOverrideService::Get,
                    'selector')
              # Construct request object and make API call
              obj = AdwordsApi::V200909::AdExtensionOverrideService::Get.new(*arg_array)
          ...
          # Calls the {mutate}[http://code.google.com/apis/adwords/docs/reference/v200909/AdExtensionOverrideService.html#mutate] method of the AdExtensionOverrideService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v200909/AdExtensionOverrideService.html#mutate].
          #
          # Args:
            # - operations: SOAP::SOAPArray of AdwordsApi::V200909::AdExtensionOverrideService::AdExtensionOverrideOperation
            #
            # Returns:
          ...
          def mutate(operations)
            begin
              arg_array = []
                ...
                arg_array << convert_to_object(operations, AdwordsApi::V200909::AdExtensionOverrideService::Mutate,
                    'operations')
              # Construct request object and make API call
              obj = AdwordsApi::V200909::AdExtensionOverrideService::Mutate.new(*arg_array)
