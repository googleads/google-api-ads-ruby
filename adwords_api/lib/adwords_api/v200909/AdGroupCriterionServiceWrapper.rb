  ...
  # library setup.
  require 'adwords_api/v200909/AdGroupCriterionServiceDriver.rb'

  module AdwordsApi
    module V200909
      module AdGroupCriterionService

        # Wrapper class for the v200909 AdGroupCriterionService service.
        ...
        class AdGroupCriterionServiceWrapper
          ...
          REGISTRY = AdwordsApi::V200909::AdGroupCriterionService::DefaultMappingRegistry::LiteralRegistry
          ...
          # instead of
          #  AdwordsApi::V200909::AdGroupCriterionService::ClassName
          ...
          def initialize(driver, api)
            @driver = driver
            @api = api
            @module = AdwordsApi::V200909::AdGroupCriterionService
            @version = :v200909
          ...
          # Calls the {get}[http://code.google.com/apis/adwords/docs/reference/v200909/AdGroupCriterionService.html#get] method of the AdGroupCriterionService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v200909/AdGroupCriterionService.html#get].
          #
          # Args:
          ...
          def get(selector)
            begin
              arg_array = []
                validate_object(selector, AdwordsApi::V200909::AdGroupCriterionService::AdGroupCriterionSelector)
                arg_array << convert_to_object(selector, AdwordsApi::V200909::AdGroupCriterionService::Get,
                    'selector')
              # Construct request object and make API call
              obj = AdwordsApi::V200909::AdGroupCriterionService::Get.new(*arg_array)
          ...
          # Calls the {mutate}[http://code.google.com/apis/adwords/docs/reference/v200909/AdGroupCriterionService.html#mutate] method of the AdGroupCriterionService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v200909/AdGroupCriterionService.html#mutate].
          #
          # Args:
            # - operations: SOAP::SOAPArray of AdwordsApi::V200909::AdGroupCriterionService::AdGroupCriterionOperation
            #
            # Returns:
          ...
          def mutate(operations)
            begin
              arg_array = []
                ...
                arg_array << convert_to_object(operations, AdwordsApi::V200909::AdGroupCriterionService::Mutate,
                    'operations')
              # Construct request object and make API call
              obj = AdwordsApi::V200909::AdGroupCriterionService::Mutate.new(*arg_array)
