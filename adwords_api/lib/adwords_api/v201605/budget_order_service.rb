...
#
# Code generated by AdsCommon library 0.12.3 on 2016-05-30 12:51:10.

require 'ads_common/savon_service'
require 'adwords_api/v201605/budget_order_service_registry'

module AdwordsApi; module V201605; module BudgetOrderService
  class BudgetOrderService < AdsCommon::SavonService
    def initialize(config, endpoint)
      namespace = 'https://adwords.google.com/api/adwords/billing/v201605'
    ...
    def get_module()
      return AdwordsApi::V201605::BudgetOrderService
    end
  end
end; end; end
