...
#
# Code generated by AdsCommon library 0.12.3 on 2016-05-30 12:51:08.

require 'ads_common/savon_service'
require 'adwords_api/v201605/adwords_user_list_service_registry'

module AdwordsApi; module V201605; module AdwordsUserListService
  class AdwordsUserListService < AdsCommon::SavonService
    def initialize(config, endpoint)
      namespace = 'https://adwords.google.com/api/adwords/rm/v201605'
    ...
    def get_module()
      return AdwordsApi::V201605::AdwordsUserListService
    end
  end
end; end; end
