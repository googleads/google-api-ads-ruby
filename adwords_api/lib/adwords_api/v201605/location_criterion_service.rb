...
require 'adwords_api/v201605/location_criterion_service_registry'

module AdwordsApi; module V201605; module LocationCriterionService
  class LocationCriterionService < AdsCommon::SavonService
    ...
    def get_module()
      return AdwordsApi::V201605::LocationCriterionService
    end
  end
end; end; end
