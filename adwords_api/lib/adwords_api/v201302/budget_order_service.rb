...
require 'adwords_api/v201302/budget_order_service_registry'

module AdwordsApi; module V201302; module BudgetOrderService
  class BudgetOrderService < AdsCommon::SavonService
    def initialize(config, endpoint)
      namespace = 'https://adwords.google.com/api/adwords/billing/v201302'
    ...
    def get_module()
      return AdwordsApi::V201302::BudgetOrderService
    end
  end
end; end; end
