...
require 'adwords_api/v201101/ServicedAccountServiceMappingRegistry'
  ...
  Methods = [
    [ "",
      ...
      { :request_style =>  :document, :request_use =>  :literal,
        ...
        :faults => {"AdwordsApi::V201101::ServicedAccountService::ApiException_"=>{:ns=>"https://adwords.google.com/api/adwords/mcm/v201101", :encodingstyle=>"document", :use=>"literal", :name=>"ApiException", :namespace=>nil}} }
    ]
  ]
