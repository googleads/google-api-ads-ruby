...
#
# Code generated by AdsCommon library 1.0.1 on 2018-05-08 12:05:12.

require 'ads_common/savon_service'
require 'adwords_api/v201802/budget_order_service_registry'

module AdwordsApi; module V201802; module BudgetOrderService
  class BudgetOrderService < AdsCommon::SavonService
    def initialize(config, endpoint)
      namespace = 'https://adwords.google.com/api/adwords/billing/v201802'
    ...
    def get_module()
      return AdwordsApi::V201802::BudgetOrderService
    end
  end
end; end; end
