...
require 'adwords_api/v201802/ad_customizer_feed_service_registry'

module AdwordsApi; module V201802; module AdCustomizerFeedService
  class AdCustomizerFeedService < AdsCommon::SavonService
    ...
    def get_module()
      return AdwordsApi::V201802::AdCustomizerFeedService
    end
  end
end; end; end
