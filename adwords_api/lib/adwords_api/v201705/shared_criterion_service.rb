...
require 'adwords_api/v201705/shared_criterion_service_registry'

module AdwordsApi; module V201705; module SharedCriterionService
  class SharedCriterionService < AdsCommon::SavonService
    ...
    def get_module()
      return AdwordsApi::V201705::SharedCriterionService
    end
  end
end; end; end
