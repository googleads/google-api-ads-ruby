...
require 'adwords_api/v201509/shared_criterion_service_registry'

module AdwordsApi; module V201509; module SharedCriterionService
  class SharedCriterionService < AdsCommon::SavonService
    ...
    def get_module()
      return AdwordsApi::V201509::SharedCriterionService
    end
  end
end; end; end
