...
#
# Code generated by AdsCommon library 0.11.0 on 2015-10-08 10:50:16.

require 'ads_common/savon_service'
require 'adwords_api/v201509/budget_order_service_registry'

module AdwordsApi; module V201509; module BudgetOrderService
  class BudgetOrderService < AdsCommon::SavonService
    def initialize(config, endpoint)
      namespace = 'https://adwords.google.com/api/adwords/billing/v201509'
    ...
    def get_module()
      return AdwordsApi::V201509::BudgetOrderService
    end
  end
end; end; end
