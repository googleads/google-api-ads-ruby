...
#
# Code generated by AdsCommon library 0.11.2 on 2016-01-27 10:48:41.

require 'ads_common/savon_service'
require 'adwords_api/v201601/budget_order_service_registry'

module AdwordsApi; module V201601; module BudgetOrderService
  class BudgetOrderService < AdsCommon::SavonService
    def initialize(config, endpoint)
      namespace = 'https://adwords.google.com/api/adwords/billing/v201601'
    ...
    def get_module()
      return AdwordsApi::V201601::BudgetOrderService
    end
  end
end; end; end
