  ...
  # library setup.
  require 'adwords_api/v13/TrafficEstimatorServiceDriver.rb'

  module AdwordsApi
    module V13
      module TrafficEstimatorService

        # Wrapper class for the v13 TrafficEstimatorService service.
        ...
        class TrafficEstimatorServiceWrapper
          ...
          REGISTRY = AdwordsApi::V13::TrafficEstimatorService::DefaultMappingRegistry::LiteralRegistry
          ...
          # instead of
          #  AdwordsApi::V13::TrafficEstimatorService::ClassName
          ...
          def initialize(driver, api)
            @driver = driver
            @api = api
            @module = AdwordsApi::V13::TrafficEstimatorService
            @version = :v13
          ...
          # Calls the {checkKeywordTraffic}[http://code.google.com/apis/adwords/docs/developer/TrafficEstimatorService.html#checkKeywordTraffic] method of the TrafficEstimatorService service.
          ...
          #
          # Args:
            # - requests: SOAP::SOAPArray of AdwordsApi::V13::TrafficEstimatorService::KeywordTrafficRequest
            #
            # Returns:
            # - checkKeywordTrafficReturn: SOAP::SOAPArray of AdwordsApi::V13::TrafficEstimatorService::KeywordTraffic
          #
          # Raises:
          ...
          def checkKeywordTraffic(requests)
            begin
              arg_array = []
                validate_object(requests, SOAP::SOAPArray)
                arg_array << convert_to_object(requests, AdwordsApi::V13::TrafficEstimatorService::CheckKeywordTraffic,
                    'requests')
              # Construct request object and make API call
              obj = AdwordsApi::V13::TrafficEstimatorService::CheckKeywordTraffic.new(*arg_array)
              reply = convert_from_object(@driver.checkKeywordTraffic(obj))
          ...
          alias check_keyword_traffic checkKeywordTraffic


          # Calls the {estimateAdGroupList}[http://code.google.com/apis/adwords/docs/developer/TrafficEstimatorService.html#estimateAdGroupList] method of the TrafficEstimatorService service.
          ...
          #
          # Args:
            # - adGroupRequests: SOAP::SOAPArray of AdwordsApi::V13::TrafficEstimatorService::AdGroupRequest
            #
            # Returns:
            # - estimateAdGroupListReturn: SOAP::SOAPArray of AdwordsApi::V13::TrafficEstimatorService::AdGroupEstimate
          #
          # Raises:
          # Error::ApiError (or a subclass thereof) if a SOAP fault occurs.
          #
          def estimateAdGroupList(adGroupRequests)
            begin
              arg_array = []
                validate_object(adGroupRequests, SOAP::SOAPArray)
                arg_array << convert_to_object(adGroupRequests, AdwordsApi::V13::TrafficEstimatorService::EstimateAdGroupList,
                    'adGroupRequests')
              # Construct request object and make API call
              obj = AdwordsApi::V13::TrafficEstimatorService::EstimateAdGroupList.new(*arg_array)
              reply = convert_from_object(@driver.estimateAdGroupList(obj))
              reply = reply[:rval] if reply.include?(:rval)
              return reply
            rescue SOAP::FaultError => fault
              raise AdwordsApi::Errors.create_api_exception(fault,
          ...
          alias estimate_ad_group_list estimateAdGroupList


          # Calls the {estimateCampaignList}[http://code.google.com/apis/adwords/docs/developer/TrafficEstimatorService.html#estimateCampaignList] method of the TrafficEstimatorService service.
          ...
          #
          # Args:
            # - campaignRequests: SOAP::SOAPArray of AdwordsApi::V13::TrafficEstimatorService::CampaignRequest
            #
            # Returns:
            # - estimateCampaignListReturn: SOAP::SOAPArray of AdwordsApi::V13::TrafficEstimatorService::CampaignEstimate
          #
          # Raises:
          # Error::ApiError (or a subclass thereof) if a SOAP fault occurs.
          #
          def estimateCampaignList(campaignRequests)
            begin
              arg_array = []
                validate_object(campaignRequests, SOAP::SOAPArray)
                arg_array << convert_to_object(campaignRequests, AdwordsApi::V13::TrafficEstimatorService::EstimateCampaignList,
                    'campaignRequests')
              # Construct request object and make API call
              obj = AdwordsApi::V13::TrafficEstimatorService::EstimateCampaignList.new(*arg_array)
              reply = convert_from_object(@driver.estimateCampaignList(obj))
              reply = reply[:rval] if reply.include?(:rval)
              return reply
            rescue SOAP::FaultError => fault
              raise AdwordsApi::Errors.create_api_exception(fault,
          ...
          alias estimate_campaign_list estimateCampaignList


          # Calls the {estimateKeywordList}[http://code.google.com/apis/adwords/docs/developer/TrafficEstimatorService.html#estimateKeywordList] method of the TrafficEstimatorService service.
          ...
          #
          # Args:
            # - keywordRequests: SOAP::SOAPArray of AdwordsApi::V13::TrafficEstimatorService::KeywordRequest
            #
            # Returns:
            # - estimateKeywordListReturn: SOAP::SOAPArray of AdwordsApi::V13::TrafficEstimatorService::KeywordEstimate
          #
          # Raises:
          # Error::ApiError (or a subclass thereof) if a SOAP fault occurs.
          #
          def estimateKeywordList(keywordRequests)
            begin
              arg_array = []
                validate_object(keywordRequests, SOAP::SOAPArray)
                arg_array << convert_to_object(keywordRequests, AdwordsApi::V13::TrafficEstimatorService::EstimateKeywordList,
                    'keywordRequests')
              # Construct request object and make API call
              obj = AdwordsApi::V13::TrafficEstimatorService::EstimateKeywordList.new(*arg_array)
              reply = convert_from_object(@driver.estimateKeywordList(obj))
              reply = reply[:rval] if reply.include?(:rval)
              return reply
            rescue SOAP::FaultError => fault
              raise AdwordsApi::Errors.create_api_exception(fault,
          ...
          alias estimate_keyword_list estimateKeywordList
