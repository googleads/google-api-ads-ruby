  ...
  # library setup.
  require 'adwords_api/v13/AccountServiceDriver.rb'

  module AdwordsApi
    module V13
      module AccountService

        # Wrapper class for the v13 AccountService service.
        ...
        class AccountServiceWrapper
          ...
          REGISTRY = AdwordsApi::V13::AccountService::DefaultMappingRegistry::LiteralRegistry
          ...
          # instead of
          #  AdwordsApi::V13::AccountService::ClassName
          ...
          def initialize(driver, api)
            @driver = driver
            @api = api
            @module = AdwordsApi::V13::AccountService
            @version = :v13
          ...
          # Calls the {getAccountInfo}[http://code.google.com/apis/adwords/docs/developer/AccountService.html#getAccountInfo] method of the AccountService service.
          ...
          def getAccountInfo()
            begin
              ...
              obj = AdwordsApi::V13::AccountService::GetAccountInfo.new(*arg_array)
              reply = convert_from_object(@driver.getAccountInfo(obj))
          ...
          alias get_account_info getAccountInfo


          # Calls the {getClientAccountInfos}[http://code.google.com/apis/adwords/docs/developer/AccountService.html#getClientAccountInfos] method of the AccountService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/developer/AccountService.html#getClientAccountInfos].
            #
            # Returns:
            # - getClientAccountInfosReturn: SOAP::SOAPArray of AdwordsApi::V13::AccountService::ClientAccountInfo
          #
          # Raises:
          # Error::ApiError (or a subclass thereof) if a SOAP fault occurs.
          #
          def getClientAccountInfos()
            begin
              arg_array = []
              # Construct request object and make API call
              obj = AdwordsApi::V13::AccountService::GetClientAccountInfos.new(*arg_array)
              reply = convert_from_object(@driver.getClientAccountInfos(obj))
              reply = reply[:rval] if reply.include?(:rval)
              return reply
            rescue SOAP::FaultError => fault
              raise AdwordsApi::Errors.create_api_exception(fault,
          ...
          alias get_client_account_infos getClientAccountInfos


          # Calls the {getClientAccounts}[http://code.google.com/apis/adwords/docs/developer/AccountService.html#getClientAccounts] method of the AccountService service.
          ...
          def getClientAccounts()
            begin
              arg_array = []
              # Construct request object and make API call
              obj = AdwordsApi::V13::AccountService::GetClientAccounts.new(*arg_array)
              reply = convert_from_object(@driver.getClientAccounts(obj))
              reply = reply[:rval] if reply.include?(:rval)
              return reply
            rescue SOAP::FaultError => fault
              raise AdwordsApi::Errors.create_api_exception(fault,
          ...
          alias get_client_accounts getClientAccounts


          # Calls the {getMccAlerts}[http://code.google.com/apis/adwords/docs/developer/AccountService.html#getMccAlerts] method of the AccountService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/developer/AccountService.html#getMccAlerts].
            #
            # Returns:
            # - getMccAlertsReturn: SOAP::SOAPArray of AdwordsApi::V13::AccountService::MccAlert
          #
          # Raises:
          # Error::ApiError (or a subclass thereof) if a SOAP fault occurs.
          #
          def getMccAlerts()
            begin
              arg_array = []
              # Construct request object and make API call
              obj = AdwordsApi::V13::AccountService::GetMccAlerts.new(*arg_array)
              reply = convert_from_object(@driver.getMccAlerts(obj))
              reply = reply[:rval] if reply.include?(:rval)
              return reply
            rescue SOAP::FaultError => fault
              raise AdwordsApi::Errors.create_api_exception(fault,
          ...
          alias get_mcc_alerts getMccAlerts


          # Calls the {updateAccountInfo}[http://code.google.com/apis/adwords/docs/developer/AccountService.html#updateAccountInfo] method of the AccountService service.
          ...
          def updateAccountInfo(accountInfo)
            begin
              arg_array = []
                validate_object(accountInfo, AdwordsApi::V13::AccountService::AccountInfo)
                arg_array << convert_to_object(accountInfo, AdwordsApi::V13::AccountService::UpdateAccountInfo,
                    'accountInfo')
              # Construct request object and make API call
              obj = AdwordsApi::V13::AccountService::UpdateAccountInfo.new(*arg_array)
              reply = convert_from_object(@driver.updateAccountInfo(obj))
              reply = reply[:rval] if reply.include?(:rval)
              return reply
            rescue SOAP::FaultError => fault
              raise AdwordsApi::Errors.create_api_exception(fault,
          ...
          alias update_account_info updateAccountInfo
