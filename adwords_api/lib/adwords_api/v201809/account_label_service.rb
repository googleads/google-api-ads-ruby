...
require 'adwords_api/v201809/account_label_service_registry'

module AdwordsApi; module V201809; module AccountLabelService
  class AccountLabelService < AdsCommon::SavonService
    ...
    def get_module()
      return AdwordsApi::V201809::AccountLabelService
    end
  end
end; end; end
