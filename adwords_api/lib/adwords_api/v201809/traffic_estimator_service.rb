...
require 'adwords_api/v201809/traffic_estimator_service_registry'

module AdwordsApi; module V201809; module TrafficEstimatorService
  class TrafficEstimatorService < AdsCommon::SavonService
    ...
    def get_module()
      return AdwordsApi::V201809::TrafficEstimatorService
    end
  end
end; end; end
