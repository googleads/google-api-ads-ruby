...
require 'adwords_api/v201809/customer_feed_service_registry'

module AdwordsApi; module V201809; module CustomerFeedService
  class CustomerFeedService < AdsCommon::SavonService
    ...
    def get_module()
      return AdwordsApi::V201809::CustomerFeedService
    end
  end
end; end; end
