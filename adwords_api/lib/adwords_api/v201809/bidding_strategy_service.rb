...
require 'adwords_api/v201809/bidding_strategy_service_registry'

module AdwordsApi; module V201809; module BiddingStrategyService
  class BiddingStrategyService < AdsCommon::SavonService
    ...
    def get_module()
      return AdwordsApi::V201809::BiddingStrategyService
    end
  end
end; end; end
