...
require 'adwords_api/v201609/ad_group_criterion_service_registry'

module AdwordsApi; module V201609; module AdGroupCriterionService
  class AdGroupCriterionService < AdsCommon::SavonService
    ...
    def get_module()
      return AdwordsApi::V201609::AdGroupCriterionService
    end
  end
end; end; end
