...
#
# Code generated by AdsCommon library 0.14.2 on 2017-08-09 18:00:54.

require 'ads_common/savon_service'
require 'adwords_api/v201609/budget_order_service_registry'

module AdwordsApi; module V201609; module BudgetOrderService
  class BudgetOrderService < AdsCommon::SavonService
    def initialize(config, endpoint)
      namespace = 'https://adwords.google.com/api/adwords/billing/v201609'
    ...
    def get_module()
      return AdwordsApi::V201609::BudgetOrderService
    end
  end
end; end; end
