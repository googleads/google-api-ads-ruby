...
require 'adwords_api/v201406/adwords_user_list_service_registry'

module AdwordsApi; module V201406; module AdwordsUserListService
  class AdwordsUserListService < AdsCommon::SavonService
    def initialize(config, endpoint)
      namespace = 'https://adwords.google.com/api/adwords/rm/v201406'
    ...
    def get_module()
      return AdwordsApi::V201406::AdwordsUserListService
    end
  end
end; end; end
