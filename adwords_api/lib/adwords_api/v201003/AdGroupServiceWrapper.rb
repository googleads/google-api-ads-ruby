  ...
  # library setup.
  require 'adwords_api/v201003/AdGroupServiceDriver.rb'

  module AdwordsApi
    module V201003
      module AdGroupService

        # Wrapper class for the v201003 AdGroupService service.
        ...
        class AdGroupServiceWrapper
          ...
          REGISTRY = AdwordsApi::V201003::AdGroupService::DefaultMappingRegistry::LiteralRegistry
          ...
          # instead of
          #  AdwordsApi::V201003::AdGroupService::ClassName
          ...
          def initialize(driver, api)
            @driver = driver
            @api = api
            @module = AdwordsApi::V201003::AdGroupService
            @version = :v201003
          ...
          # Calls the {get}[http://code.google.com/apis/adwords/docs/reference/v201003/AdGroupService.html#get] method of the AdGroupService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201003/AdGroupService.html#get].
          #
          # Args:
          ...
          def get(selector)
            begin
              arg_array = []
                validate_object(selector, AdwordsApi::V201003::AdGroupService::AdGroupSelector)
                arg_array << convert_to_object(selector, AdwordsApi::V201003::AdGroupService::Get,
                    'selector')
              # Construct request object and make API call
              obj = AdwordsApi::V201003::AdGroupService::Get.new(*arg_array)
          ...
          # Calls the {mutate}[http://code.google.com/apis/adwords/docs/reference/v201003/AdGroupService.html#mutate] method of the AdGroupService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201003/AdGroupService.html#mutate].
          #
          # Args:
            # - operations: SOAP::SOAPArray of AdwordsApi::V201003::AdGroupService::AdGroupOperation
            #
            # Returns:
          ...
          def mutate(operations)
            begin
              arg_array = []
                ...
                arg_array << convert_to_object(operations, AdwordsApi::V201003::AdGroupService::Mutate,
                    'operations')
              # Construct request object and make API call
              obj = AdwordsApi::V201003::AdGroupService::Mutate.new(*arg_array)
