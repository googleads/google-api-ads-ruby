...
require 'adwords_api/v201003/BidLandscapeServiceMappingRegistry'
  ...
  Methods = [
    [ "",
      ...
      { :request_style =>  :document, :request_use =>  :literal,
        ...
        :faults => {"AdwordsApi::V201003::BidLandscapeService::ApiException"=>{:encodingstyle=>"document", :namespace=>nil, :ns=>"https://adwords.google.com/api/adwords/cm/v201003", :use=>"literal", :name=>"ApiException"}} }
    ]
  ]
