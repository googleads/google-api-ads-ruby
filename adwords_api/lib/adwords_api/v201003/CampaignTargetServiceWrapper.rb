  ...
  # library setup.
  require 'adwords_api/v201003/CampaignTargetServiceDriver.rb'

  module AdwordsApi
    module V201003
      module CampaignTargetService

        # Wrapper class for the v201003 CampaignTargetService service.
        ...
        class CampaignTargetServiceWrapper
          ...
          REGISTRY = AdwordsApi::V201003::CampaignTargetService::DefaultMappingRegistry::LiteralRegistry
          ...
          # instead of
          #  AdwordsApi::V201003::CampaignTargetService::ClassName
          ...
          def initialize(driver, api)
            @driver = driver
            @api = api
            @module = AdwordsApi::V201003::CampaignTargetService
            @version = :v201003
          ...
          # Calls the {get}[http://code.google.com/apis/adwords/docs/reference/v201003/CampaignTargetService.html#get] method of the CampaignTargetService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201003/CampaignTargetService.html#get].
          #
          # Args:
          ...
          def get(selector)
            begin
              arg_array = []
                validate_object(selector, AdwordsApi::V201003::CampaignTargetService::CampaignTargetSelector)
                arg_array << convert_to_object(selector, AdwordsApi::V201003::CampaignTargetService::Get,
                    'selector')
              # Construct request object and make API call
              obj = AdwordsApi::V201003::CampaignTargetService::Get.new(*arg_array)
          ...
          # Calls the {mutate}[http://code.google.com/apis/adwords/docs/reference/v201003/CampaignTargetService.html#mutate] method of the CampaignTargetService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201003/CampaignTargetService.html#mutate].
          #
          # Args:
            # - operations: SOAP::SOAPArray of AdwordsApi::V201003::CampaignTargetService::CampaignTargetOperation
            #
            # Returns:
          ...
          def mutate(operations)
            begin
              arg_array = []
                ...
                arg_array << convert_to_object(operations, AdwordsApi::V201003::CampaignTargetService::Mutate,
                    'operations')
              # Construct request object and make API call
              obj = AdwordsApi::V201003::CampaignTargetService::Mutate.new(*arg_array)
