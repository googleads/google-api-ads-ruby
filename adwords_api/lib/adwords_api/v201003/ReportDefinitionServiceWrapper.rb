  ...
  # library setup.
  require 'adwords_api/v201003/ReportDefinitionServiceDriver.rb'

  module AdwordsApi
    module V201003
      module ReportDefinitionService

        # Wrapper class for the v201003 ReportDefinitionService service.
        ...
        class ReportDefinitionServiceWrapper
          ...
          REGISTRY = AdwordsApi::V201003::ReportDefinitionService::DefaultMappingRegistry::LiteralRegistry
          ...
          # instead of
          #  AdwordsApi::V201003::ReportDefinitionService::ClassName
          ...
          def initialize(driver, api)
            @driver = driver
            @api = api
            @module = AdwordsApi::V201003::ReportDefinitionService
            @version = :v201003
          ...
          # Calls the {get}[http://code.google.com/apis/adwords/docs/reference/v201003/ReportDefinitionService.html#get] method of the ReportDefinitionService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201003/ReportDefinitionService.html#get].
          #
          # Args:
          ...
          def get(selector)
            begin
              arg_array = []
                validate_object(selector, AdwordsApi::V201003::ReportDefinitionService::ReportDefinitionSelector)
                arg_array << convert_to_object(selector, AdwordsApi::V201003::ReportDefinitionService::Get,
                    'selector')
              # Construct request object and make API call
              obj = AdwordsApi::V201003::ReportDefinitionService::Get.new(*arg_array)
          ...
          # Calls the {getReportFields}[http://code.google.com/apis/adwords/docs/reference/v201003/ReportDefinitionService.html#getReportFields] method of the ReportDefinitionService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201003/ReportDefinitionService.html#getReportFields].
          #
          # Args:
            # - reportType: AdwordsApi::V201003::ReportDefinitionService::ReportDefinitionReportType
            #
            # Returns:
            # - rval: SOAP::SOAPArray of AdwordsApi::V201003::ReportDefinitionService::ReportDefinitionField
          #
          # Raises:
          # Error::ApiError (or a subclass thereof) if a SOAP fault occurs.
          #
          def getReportFields(reportType)
            begin
              arg_array = []
                validate_object(reportType, AdwordsApi::V201003::ReportDefinitionService::ReportDefinitionReportType)
                arg_array << convert_to_object(reportType, AdwordsApi::V201003::ReportDefinitionService::GetReportFields,
                    'reportType')
              # Construct request object and make API call
              obj = AdwordsApi::V201003::ReportDefinitionService::GetReportFields.new(*arg_array)
          ...
          # Calls the {mutate}[http://code.google.com/apis/adwords/docs/reference/v201003/ReportDefinitionService.html#mutate] method of the ReportDefinitionService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201003/ReportDefinitionService.html#mutate].
          #
          # Args:
            # - operations: SOAP::SOAPArray of AdwordsApi::V201003::ReportDefinitionService::ReportDefinitionOperation
            #
            # Returns:
            # - rval: SOAP::SOAPArray of AdwordsApi::V201003::ReportDefinitionService::ReportDefinition
          #
          # Raises:
          # Error::ApiError (or a subclass thereof) if a SOAP fault occurs.
          #
          def mutate(operations)
            begin
              arg_array = []
                ...
                arg_array << convert_to_object(operations, AdwordsApi::V201003::ReportDefinitionService::Mutate,
                    'operations')
              # Construct request object and make API call
              obj = AdwordsApi::V201003::ReportDefinitionService::Mutate.new(*arg_array)
