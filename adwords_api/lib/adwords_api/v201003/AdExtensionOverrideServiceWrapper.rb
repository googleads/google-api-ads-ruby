  ...
  # library setup.
  require 'adwords_api/v201003/AdExtensionOverrideServiceDriver.rb'

  module AdwordsApi
    module V201003
      module AdExtensionOverrideService

        # Wrapper class for the v201003 AdExtensionOverrideService service.
        ...
        class AdExtensionOverrideServiceWrapper
          ...
          REGISTRY = AdwordsApi::V201003::AdExtensionOverrideService::DefaultMappingRegistry::LiteralRegistry
          ...
          # instead of
          #  AdwordsApi::V201003::AdExtensionOverrideService::ClassName
          ...
          def initialize(driver, api)
            @driver = driver
            @api = api
            @module = AdwordsApi::V201003::AdExtensionOverrideService
            @version = :v201003
          ...
          # Calls the {get}[http://code.google.com/apis/adwords/docs/reference/v201003/AdExtensionOverrideService.html#get] method of the AdExtensionOverrideService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201003/AdExtensionOverrideService.html#get].
          #
          # Args:
          ...
          def get(selector)
            begin
              arg_array = []
                validate_object(selector, AdwordsApi::V201003::AdExtensionOverrideService::AdExtensionOverrideSelector)
                arg_array << convert_to_object(selector, AdwordsApi::V201003::AdExtensionOverrideService::Get,
                    'selector')
              # Construct request object and make API call
              obj = AdwordsApi::V201003::AdExtensionOverrideService::Get.new(*arg_array)
          ...
          # Calls the {mutate}[http://code.google.com/apis/adwords/docs/reference/v201003/AdExtensionOverrideService.html#mutate] method of the AdExtensionOverrideService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201003/AdExtensionOverrideService.html#mutate].
          #
          # Args:
            # - operations: SOAP::SOAPArray of AdwordsApi::V201003::AdExtensionOverrideService::AdExtensionOverrideOperation
            #
            # Returns:
          ...
          def mutate(operations)
            begin
              arg_array = []
                ...
                arg_array << convert_to_object(operations, AdwordsApi::V201003::AdExtensionOverrideService::Mutate,
                    'operations')
              # Construct request object and make API call
              obj = AdwordsApi::V201003::AdExtensionOverrideService::Mutate.new(*arg_array)
