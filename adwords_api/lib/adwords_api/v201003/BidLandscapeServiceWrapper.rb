  ...
  # library setup.
  require 'adwords_api/v201003/BidLandscapeServiceDriver.rb'

  module AdwordsApi
    module V201003
      module BidLandscapeService

        # Wrapper class for the v201003 BidLandscapeService service.
        ...
        class BidLandscapeServiceWrapper
          ...
          REGISTRY = AdwordsApi::V201003::BidLandscapeService::DefaultMappingRegistry::LiteralRegistry
          ...
          # instead of
          #  AdwordsApi::V201003::BidLandscapeService::ClassName
          ...
          def initialize(driver, api)
            @driver = driver
            @api = api
            @module = AdwordsApi::V201003::BidLandscapeService
            @version = :v201003
          ...
          # Calls the {getBidLandscape}[http://code.google.com/apis/adwords/docs/reference/v201003/BidLandscapeService.html#getBidLandscape] method of the BidLandscapeService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201003/BidLandscapeService.html#getBidLandscape].
          #
          # Args:
            # - selector: AdwordsApi::V201003::BidLandscapeService::BidLandscapeSelector
            #
            # Returns:
            # - rval: SOAP::SOAPArray of AdwordsApi::V201003::BidLandscapeService::BidLandscape
          #
          # Raises:
          ...
          def getBidLandscape(selector)
            begin
              arg_array = []
                validate_object(selector, AdwordsApi::V201003::BidLandscapeService::BidLandscapeSelector)
                arg_array << convert_to_object(selector, AdwordsApi::V201003::BidLandscapeService::GetBidLandscape,
                    'selector')
              # Construct request object and make API call
              obj = AdwordsApi::V201003::BidLandscapeService::GetBidLandscape.new(*arg_array)
              reply = convert_from_object(@driver.getBidLandscape(obj))
          ...
          alias get_bid_landscape getBidLandscape
