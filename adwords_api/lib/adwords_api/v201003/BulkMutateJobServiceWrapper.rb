  ...
  # library setup.
  require 'adwords_api/v201003/BulkMutateJobServiceDriver.rb'

  module AdwordsApi
    module V201003
      module BulkMutateJobService

        # Wrapper class for the v201003 BulkMutateJobService service.
        ...
        class BulkMutateJobServiceWrapper
          ...
          REGISTRY = AdwordsApi::V201003::BulkMutateJobService::DefaultMappingRegistry::LiteralRegistry
          ...
          # instead of
          #  AdwordsApi::V201003::BulkMutateJobService::ClassName
          ...
          def initialize(driver, api)
            @driver = driver
            @api = api
            @module = AdwordsApi::V201003::BulkMutateJobService
            @version = :v201003
          ...
          # Calls the {get}[http://code.google.com/apis/adwords/docs/reference/v201003/BulkMutateJobService.html#get] method of the BulkMutateJobService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201003/BulkMutateJobService.html#get].
          #
          # Args:
            # - selector: AdwordsApi::V201003::BulkMutateJobService::BulkMutateJobSelector
            #
            # Returns:
            # - rval: SOAP::SOAPArray of AdwordsApi::V201003::BulkMutateJobService::BulkMutateJob
          #
          # Raises:
          ...
          def get(selector)
            begin
              arg_array = []
                validate_object(selector, AdwordsApi::V201003::BulkMutateJobService::BulkMutateJobSelector)
                arg_array << convert_to_object(selector, AdwordsApi::V201003::BulkMutateJobService::Get,
                    'selector')
              # Construct request object and make API call
              obj = AdwordsApi::V201003::BulkMutateJobService::Get.new(*arg_array)
          ...
          # Calls the {mutate}[http://code.google.com/apis/adwords/docs/reference/v201003/BulkMutateJobService.html#mutate] method of the BulkMutateJobService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201003/BulkMutateJobService.html#mutate].
          #
          # Args:
          ...
          def mutate(operation)
            begin
              arg_array = []
                validate_object(operation, AdwordsApi::V201003::BulkMutateJobService::JobOperation)
                arg_array << convert_to_object(operation, AdwordsApi::V201003::BulkMutateJobService::Mutate,
                    'operation')
              # Construct request object and make API call
              obj = AdwordsApi::V201003::BulkMutateJobService::Mutate.new(*arg_array)
