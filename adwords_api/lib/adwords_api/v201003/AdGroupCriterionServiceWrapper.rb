  ...
  # library setup.
  require 'adwords_api/v201003/AdGroupCriterionServiceDriver.rb'

  module AdwordsApi
    module V201003
      module AdGroupCriterionService

        # Wrapper class for the v201003 AdGroupCriterionService service.
        ...
        class AdGroupCriterionServiceWrapper
          ...
          REGISTRY = AdwordsApi::V201003::AdGroupCriterionService::DefaultMappingRegistry::LiteralRegistry
          ...
          # instead of
          #  AdwordsApi::V201003::AdGroupCriterionService::ClassName
          ...
          def initialize(driver, api)
            @driver = driver
            @api = api
            @module = AdwordsApi::V201003::AdGroupCriterionService
            @version = :v201003
          ...
          # Calls the {get}[http://code.google.com/apis/adwords/docs/reference/v201003/AdGroupCriterionService.html#get] method of the AdGroupCriterionService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201003/AdGroupCriterionService.html#get].
          #
          # Args:
          ...
          def get(selector)
            begin
              arg_array = []
                validate_object(selector, AdwordsApi::V201003::AdGroupCriterionService::AdGroupCriterionSelector)
                arg_array << convert_to_object(selector, AdwordsApi::V201003::AdGroupCriterionService::Get,
                    'selector')
              # Construct request object and make API call
              obj = AdwordsApi::V201003::AdGroupCriterionService::Get.new(*arg_array)
          ...
          # Calls the {mutate}[http://code.google.com/apis/adwords/docs/reference/v201003/AdGroupCriterionService.html#mutate] method of the AdGroupCriterionService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201003/AdGroupCriterionService.html#mutate].
          #
          # Args:
            # - operations: SOAP::SOAPArray of AdwordsApi::V201003::AdGroupCriterionService::AdGroupCriterionOperation
            #
            # Returns:
          ...
          def mutate(operations)
            begin
              arg_array = []
                ...
                arg_array << convert_to_object(operations, AdwordsApi::V201003::AdGroupCriterionService::Mutate,
                    'operations')
              # Construct request object and make API call
              obj = AdwordsApi::V201003::AdGroupCriterionService::Mutate.new(*arg_array)
