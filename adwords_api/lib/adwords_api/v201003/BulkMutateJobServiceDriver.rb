...
require 'adwords_api/v201003/BulkMutateJobServiceMappingRegistry'
...
class BulkMutateJobServiceInterface < ::SOAP::RPC::Driver
  DefaultEndpointUrl = "https://adwords.google.com:443/api/adwords/job/v201003/BulkMutateJobService"
  ...
  Methods = [
    [ "",
      ...
      { :request_style =>  :document, :request_use =>  :literal,
        ...
        :faults => {"AdwordsApi::V201003::BulkMutateJobService::ApiException"=>{:encodingstyle=>"document", :namespace=>nil, :ns=>"https://adwords.google.com/api/adwords/cm/v201003", :use=>"literal", :name=>"ApiException"}} }
    ],
    [ "",
      "mutate",
