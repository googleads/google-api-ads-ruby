  ...
  # library setup.
  require 'adwords_api/v201003/AdGroupAdServiceDriver.rb'

  module AdwordsApi
    module V201003
      module AdGroupAdService

        # Wrapper class for the v201003 AdGroupAdService service.
        ...
        class AdGroupAdServiceWrapper
          ...
          REGISTRY = AdwordsApi::V201003::AdGroupAdService::DefaultMappingRegistry::LiteralRegistry
          ...
          # instead of
          #  AdwordsApi::V201003::AdGroupAdService::ClassName
          ...
          def initialize(driver, api)
            @driver = driver
            @api = api
            @module = AdwordsApi::V201003::AdGroupAdService
            @version = :v201003
          ...
          # Calls the {get}[http://code.google.com/apis/adwords/docs/reference/v201003/AdGroupAdService.html#get] method of the AdGroupAdService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201003/AdGroupAdService.html#get].
          #
          # Args:
          ...
          def get(selector)
            begin
              arg_array = []
                validate_object(selector, AdwordsApi::V201003::AdGroupAdService::AdGroupAdSelector)
                arg_array << convert_to_object(selector, AdwordsApi::V201003::AdGroupAdService::Get,
                    'selector')
              # Construct request object and make API call
              obj = AdwordsApi::V201003::AdGroupAdService::Get.new(*arg_array)
          ...
          # Calls the {mutate}[http://code.google.com/apis/adwords/docs/reference/v201003/AdGroupAdService.html#mutate] method of the AdGroupAdService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201003/AdGroupAdService.html#mutate].
          #
          # Args:
            # - operations: SOAP::SOAPArray of AdwordsApi::V201003::AdGroupAdService::AdGroupAdOperation
            #
            # Returns:
          ...
          def mutate(operations)
            begin
              arg_array = []
                ...
                arg_array << convert_to_object(operations, AdwordsApi::V201003::AdGroupAdService::Mutate,
                    'operations')
              # Construct request object and make API call
              obj = AdwordsApi::V201003::AdGroupAdService::Mutate.new(*arg_array)
