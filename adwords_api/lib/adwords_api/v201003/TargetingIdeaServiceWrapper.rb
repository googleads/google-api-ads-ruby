  ...
  # library setup.
  require 'adwords_api/v201003/TargetingIdeaServiceDriver.rb'

  module AdwordsApi
    module V201003
      module TargetingIdeaService

        # Wrapper class for the v201003 TargetingIdeaService service.
        ...
        class TargetingIdeaServiceWrapper
          ...
          REGISTRY = AdwordsApi::V201003::TargetingIdeaService::DefaultMappingRegistry::LiteralRegistry
          ...
          # instead of
          #  AdwordsApi::V201003::TargetingIdeaService::ClassName
          ...
          def initialize(driver, api)
            @driver = driver
            @api = api
            @module = AdwordsApi::V201003::TargetingIdeaService
            @version = :v201003
          ...
          # Calls the {get}[http://code.google.com/apis/adwords/docs/reference/v201003/TargetingIdeaService.html#get] method of the TargetingIdeaService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201003/TargetingIdeaService.html#get].
          #
          # Args:
          ...
          def get(selector)
            begin
              arg_array = []
                validate_object(selector, AdwordsApi::V201003::TargetingIdeaService::TargetingIdeaSelector)
                arg_array << convert_to_object(selector, AdwordsApi::V201003::TargetingIdeaService::Get,
                    'selector')
              # Construct request object and make API call
              obj = AdwordsApi::V201003::TargetingIdeaService::Get.new(*arg_array)
          ...
          # Calls the {getBulkKeywordIdeas}[http://code.google.com/apis/adwords/docs/reference/v201003/TargetingIdeaService.html#getBulkKeywordIdeas] method of the TargetingIdeaService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201003/TargetingIdeaService.html#getBulkKeywordIdeas].
          #
          # Args:
            # - selector: AdwordsApi::V201003::TargetingIdeaService::TargetingIdeaSelector
            #
          ...
          def getBulkKeywordIdeas(selector)
            begin
              arg_array = []
                validate_object(selector, AdwordsApi::V201003::TargetingIdeaService::TargetingIdeaSelector)
                arg_array << convert_to_object(selector, AdwordsApi::V201003::TargetingIdeaService::GetBulkKeywordIdeas,
                    'selector')
              # Construct request object and make API call
              obj = AdwordsApi::V201003::TargetingIdeaService::GetBulkKeywordIdeas.new(*arg_array)
