  ...
  Methods = [
    [ "",
      ...
      { :request_style =>  :document, :request_use =>  :literal,
        ...
        :faults => {"AdwordsApi::V201003::CampaignCriterionService::ApiException"=>{:encodingstyle=>"document", :namespace=>nil, :ns=>"https://adwords.google.com/api/adwords/cm/v201003", :use=>"literal", :name=>"ApiException"}} }
    ],
    [ "",
      "mutate",
