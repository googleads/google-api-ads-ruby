  ...
  Methods = [
    [ "",
      ...
      { :request_style =>  :document, :request_use =>  :literal,
        ...
        :faults => {"AdwordsApi::V201003::TargetingIdeaService::ApiException_"=>{:ns=>"https://adwords.google.com/api/adwords/o/v201003", :encodingstyle=>"document", :use=>"literal", :name=>"ApiException", :namespace=>nil}} }
    ],
    [ "",
      "getBulkKeywordIdeas",
