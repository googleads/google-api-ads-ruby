...
require 'adwords_api/v201506/shared_criterion_service_registry'

module AdwordsApi; module V201506; module SharedCriterionService
  class SharedCriterionService < AdsCommon::SavonService
    ...
    def get_module()
      return AdwordsApi::V201506::SharedCriterionService
    end
  end
end; end; end
