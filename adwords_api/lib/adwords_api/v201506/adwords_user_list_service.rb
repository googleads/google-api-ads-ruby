...
#
# Code generated by AdsCommon library 0.11.0 on 2015-10-08 10:49:20.

require 'ads_common/savon_service'
require 'adwords_api/v201506/adwords_user_list_service_registry'

module AdwordsApi; module V201506; module AdwordsUserListService
  class AdwordsUserListService < AdsCommon::SavonService
    def initialize(config, endpoint)
      namespace = 'https://adwords.google.com/api/adwords/rm/v201506'
    ...
    def get_module()
      return AdwordsApi::V201506::AdwordsUserListService
    end
  end
end; end; end
