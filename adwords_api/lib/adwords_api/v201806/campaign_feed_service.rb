...
require 'adwords_api/v201806/campaign_feed_service_registry'

module AdwordsApi; module V201806; module CampaignFeedService
  class CampaignFeedService < AdsCommon::SavonService
    ...
    def get_module()
      return AdwordsApi::V201806::CampaignFeedService
    end
  end
end; end; end
