...
require 'adwords_api/v201806/targeting_idea_service_registry'

module AdwordsApi; module V201806; module TargetingIdeaService
  class TargetingIdeaService < AdsCommon::SavonService
    ...
    def get_module()
      return AdwordsApi::V201806::TargetingIdeaService
    end
  end
end; end; end
