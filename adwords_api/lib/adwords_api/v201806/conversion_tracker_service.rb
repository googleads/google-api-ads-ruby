...
require 'adwords_api/v201806/conversion_tracker_service_registry'

module AdwordsApi; module V201806; module ConversionTrackerService
  class ConversionTrackerService < AdsCommon::SavonService
    ...
    def get_module()
      return AdwordsApi::V201806::ConversionTrackerService
    end
  end
end; end; end
