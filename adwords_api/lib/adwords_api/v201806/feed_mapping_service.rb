...
require 'adwords_api/v201806/feed_mapping_service_registry'

module AdwordsApi; module V201806; module FeedMappingService
  class FeedMappingService < AdsCommon::SavonService
    ...
    def get_module()
      return AdwordsApi::V201806::FeedMappingService
    end
  end
end; end; end
