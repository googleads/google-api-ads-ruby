...
require 'adwords_api/v201806/location_criterion_service_registry'

module AdwordsApi; module V201806; module LocationCriterionService
  class LocationCriterionService < AdsCommon::SavonService
    ...
    def get_module()
      return AdwordsApi::V201806::LocationCriterionService
    end
  end
end; end; end
