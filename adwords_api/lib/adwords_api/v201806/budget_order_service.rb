...
#
# Code generated by AdsCommon library 1.0.2 on 2019-01-28 16:54:04.

require 'ads_common/savon_service'
require 'adwords_api/v201806/budget_order_service_registry'

module AdwordsApi; module V201806; module BudgetOrderService
  class BudgetOrderService < AdsCommon::SavonService
    def initialize(config, endpoint)
      namespace = 'https://adwords.google.com/api/adwords/billing/v201806'
    ...
    def get_module()
      return AdwordsApi::V201806::BudgetOrderService
    end
  end
end; end; end
