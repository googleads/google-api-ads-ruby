...
require 'adwords_api/v201806/campaign_shared_set_service_registry'

module AdwordsApi; module V201806; module CampaignSharedSetService
  class CampaignSharedSetService < AdsCommon::SavonService
    ...
    def get_module()
      return AdwordsApi::V201806::CampaignSharedSetService
    end
  end
end; end; end
