...
#
# Code generated by AdsCommon library 0.8.0 on 2012-08-03 17:39:31.
...
module AdwordsApi; module V201109; module CreateAccountService
  ...
  class ApiException < ApplicationException
    ...
    def initialize(exception_fault)
      @array_fields ||= []
      @array_fields << 'errors'
      super(exception_fault, CreateAccountServiceRegistry)
    end
  end
end; end; end
