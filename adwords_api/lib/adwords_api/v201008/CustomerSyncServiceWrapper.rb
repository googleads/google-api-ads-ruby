  ...
  # library setup.
  require 'adwords_api/v201008/CustomerSyncServiceDriver.rb'

  module AdwordsApi
    module V201008
      module CustomerSyncService

        # Wrapper class for the v201008 CustomerSyncService service.
        ...
        class CustomerSyncServiceWrapper
          ...
          REGISTRY = AdwordsApi::V201008::CustomerSyncService::DefaultMappingRegistry::LiteralRegistry
          ...
          # instead of
          #  AdwordsApi::V201008::CustomerSyncService::ClassName
          ...
          def initialize(driver, api)
            @driver = driver
            @api = api
            @module = AdwordsApi::V201008::CustomerSyncService
            @version = :v201008
          ...
          # Calls the {get}[http://code.google.com/apis/adwords/docs/reference/v201008/CustomerSyncService.html#get] method of the CustomerSyncService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201008/CustomerSyncService.html#get].
          #
          # Args:
          ...
          def get(selector)
            begin
              arg_array = []
                validate_object(selector, AdwordsApi::V201008::CustomerSyncService::CustomerSyncSelector)
                arg_array << convert_to_object(selector, AdwordsApi::V201008::CustomerSyncService::Get,
                    'selector')
              # Construct request object and make API call
              obj = AdwordsApi::V201008::CustomerSyncService::Get.new(*arg_array)
