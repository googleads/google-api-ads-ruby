  ...
  # library setup.
  require 'adwords_api/v201008/UserListServiceDriver.rb'

  module AdwordsApi
    module V201008
      module UserListService

        # Wrapper class for the v201008 UserListService service.
        ...
        class UserListServiceWrapper
          ...
          REGISTRY = AdwordsApi::V201008::UserListService::DefaultMappingRegistry::LiteralRegistry
          ...
          # instead of
          #  AdwordsApi::V201008::UserListService::ClassName
          ...
          def initialize(driver, api)
            @driver = driver
            @api = api
            @module = AdwordsApi::V201008::UserListService
            @version = :v201008
          ...
          # Calls the {get}[http://code.google.com/apis/adwords/docs/reference/v201008/UserListService.html#get] method of the UserListService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201008/UserListService.html#get].
          #
          # Args:
          ...
          def get(selector)
            begin
              arg_array = []
                validate_object(selector, AdwordsApi::V201008::UserListService::UserListSelector)
                arg_array << convert_to_object(selector, AdwordsApi::V201008::UserListService::Get,
                    'selector')
              # Construct request object and make API call
              obj = AdwordsApi::V201008::UserListService::Get.new(*arg_array)
          ...
          # Calls the {mutate}[http://code.google.com/apis/adwords/docs/reference/v201008/UserListService.html#mutate] method of the UserListService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201008/UserListService.html#mutate].
          #
          # Args:
            # - operations: SOAP::SOAPArray of AdwordsApi::V201008::UserListService::UserListOperation
            #
            # Returns:
          ...
          def mutate(operations)
            begin
              arg_array = []
                ...
                arg_array << convert_to_object(operations, AdwordsApi::V201008::UserListService::Mutate,
                    'operations')
              # Construct request object and make API call
              obj = AdwordsApi::V201008::UserListService::Mutate.new(*arg_array)
