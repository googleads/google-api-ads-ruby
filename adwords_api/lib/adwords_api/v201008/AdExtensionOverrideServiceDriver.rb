...
require 'adwords_api/v201008/AdExtensionOverrideServiceMappingRegistry'
...
class AdExtensionOverrideServiceInterface < ::SOAP::RPC::Driver
  DefaultEndpointUrl = "https://adwords.google.com:443/api/adwords/cm/v201008/AdExtensionOverrideService"
  ...
  Methods = [
    [ "",
      ...
      { :request_style =>  :document, :request_use =>  :literal,
        ...
        :faults => {"AdwordsApi::V201008::AdExtensionOverrideService::ApiException"=>{:encodingstyle=>"document", :namespace=>nil, :ns=>"https://adwords.google.com/api/adwords/cm/v201008", :use=>"literal", :name=>"ApiException"}} }
    ],
    [ "",
      "mutate",
