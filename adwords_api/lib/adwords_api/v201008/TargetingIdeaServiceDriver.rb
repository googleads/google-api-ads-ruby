  ...
  Methods = [
    [ "",
      ...
      { :request_style =>  :document, :request_use =>  :literal,
        ...
        :faults => {"AdwordsApi::V201008::TargetingIdeaService::ApiException_"=>{:encodingstyle=>"document", :ns=>"https://adwords.google.com/api/adwords/o/v201008", :name=>"ApiException", :use=>"literal", :namespace=>nil}} }
    ],
    [ "",
      "getBulkKeywordIdeas",
