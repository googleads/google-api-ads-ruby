  ...
  Methods = [
    [ "",
      ...
      { :request_style =>  :document, :request_use =>  :literal,
        ...
        :faults => {"AdwordsApi::V201008::TargetingIdeaService::ApiException_"=>{:use=>"literal", :namespace=>nil, :name=>"ApiException", :ns=>"https://adwords.google.com/api/adwords/o/v201008", :encodingstyle=>"document"}} }
    ],
    [ "",
      "getBulkKeywordIdeas",
