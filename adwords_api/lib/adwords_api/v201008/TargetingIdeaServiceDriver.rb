  ...
  Methods = [
    [ "",
      ...
      { :request_style =>  :document, :request_use =>  :literal,
        ...
        :faults => {"AdwordsApi::V201008::TargetingIdeaService::ApiException_"=>{:ns=>"https://adwords.google.com/api/adwords/o/v201008", :encodingstyle=>"document", :use=>"literal", :name=>"ApiException", :namespace=>nil}} }
    ],
    [ "",
      "getBulkKeywordIdeas",
