  ...
  # library setup.
  require 'adwords_api/v201008/ExperimentServiceDriver.rb'

  module AdwordsApi
    module V201008
      module ExperimentService

        # Wrapper class for the v201008 ExperimentService service.
        ...
        class ExperimentServiceWrapper
          ...
          REGISTRY = AdwordsApi::V201008::ExperimentService::DefaultMappingRegistry::LiteralRegistry
          ...
          # instead of
          #  AdwordsApi::V201008::ExperimentService::ClassName
          ...
          def initialize(driver, api)
            @driver = driver
            @api = api
            @module = AdwordsApi::V201008::ExperimentService
            @version = :v201008
          ...
          # Calls the {get}[http://code.google.com/apis/adwords/docs/reference/v201008/ExperimentService.html#get] method of the ExperimentService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201008/ExperimentService.html#get].
          #
          # Args:
          ...
          def get(selector)
            begin
              arg_array = []
                validate_object(selector, AdwordsApi::V201008::ExperimentService::ExperimentSelector)
                arg_array << convert_to_object(selector, AdwordsApi::V201008::ExperimentService::Get,
                    'selector')
              # Construct request object and make API call
              obj = AdwordsApi::V201008::ExperimentService::Get.new(*arg_array)
          ...
          # Calls the {mutate}[http://code.google.com/apis/adwords/docs/reference/v201008/ExperimentService.html#mutate] method of the ExperimentService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201008/ExperimentService.html#mutate].
          #
          # Args:
            # - operations: SOAP::SOAPArray of AdwordsApi::V201008::ExperimentService::ExperimentOperation
            #
            # Returns:
          ...
          def mutate(operations)
            begin
              arg_array = []
                ...
                arg_array << convert_to_object(operations, AdwordsApi::V201008::ExperimentService::Mutate,
                    'operations')
              # Construct request object and make API call
              obj = AdwordsApi::V201008::ExperimentService::Mutate.new(*arg_array)
