  ...
  # library setup.
  require 'adwords_api/v201008/CampaignAdExtensionServiceDriver.rb'

  module AdwordsApi
    module V201008
      module CampaignAdExtensionService

        # Wrapper class for the v201008 CampaignAdExtensionService service.
        ...
        class CampaignAdExtensionServiceWrapper
          ...
          REGISTRY = AdwordsApi::V201008::CampaignAdExtensionService::DefaultMappingRegistry::LiteralRegistry
          ...
          # instead of
          #  AdwordsApi::V201008::CampaignAdExtensionService::ClassName
          ...
          def initialize(driver, api)
            @driver = driver
            @api = api
            @module = AdwordsApi::V201008::CampaignAdExtensionService
            @version = :v201008
          ...
          # Calls the {get}[http://code.google.com/apis/adwords/docs/reference/v201008/CampaignAdExtensionService.html#get] method of the CampaignAdExtensionService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201008/CampaignAdExtensionService.html#get].
          #
          # Args:
          ...
          def get(selector)
            begin
              arg_array = []
                validate_object(selector, AdwordsApi::V201008::CampaignAdExtensionService::CampaignAdExtensionSelector)
                arg_array << convert_to_object(selector, AdwordsApi::V201008::CampaignAdExtensionService::Get,
                    'selector')
              # Construct request object and make API call
              obj = AdwordsApi::V201008::CampaignAdExtensionService::Get.new(*arg_array)
          ...
          # Calls the {mutate}[http://code.google.com/apis/adwords/docs/reference/v201008/CampaignAdExtensionService.html#mutate] method of the CampaignAdExtensionService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201008/CampaignAdExtensionService.html#mutate].
          #
          # Args:
            # - operations: SOAP::SOAPArray of AdwordsApi::V201008::CampaignAdExtensionService::CampaignAdExtensionOperation
            #
            # Returns:
          ...
          def mutate(operations)
            begin
              arg_array = []
                ...
                arg_array << convert_to_object(operations, AdwordsApi::V201008::CampaignAdExtensionService::Mutate,
                    'operations')
              # Construct request object and make API call
              obj = AdwordsApi::V201008::CampaignAdExtensionService::Mutate.new(*arg_array)
