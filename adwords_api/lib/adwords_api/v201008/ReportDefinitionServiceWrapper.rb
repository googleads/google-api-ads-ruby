  ...
  # library setup.
  require 'adwords_api/v201008/ReportDefinitionServiceDriver.rb'

  module AdwordsApi
    module V201008
      module ReportDefinitionService

        # Wrapper class for the v201008 ReportDefinitionService service.
        ...
        class ReportDefinitionServiceWrapper
          ...
          REGISTRY = AdwordsApi::V201008::ReportDefinitionService::DefaultMappingRegistry::LiteralRegistry
          ...
          # instead of
          #  AdwordsApi::V201008::ReportDefinitionService::ClassName
          ...
          def initialize(driver, api)
            @driver = driver
            @api = api
            @module = AdwordsApi::V201008::ReportDefinitionService
            @version = :v201008
          ...
          # Calls the {get}[http://code.google.com/apis/adwords/docs/reference/v201008/ReportDefinitionService.html#get] method of the ReportDefinitionService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201008/ReportDefinitionService.html#get].
          #
          # Args:
          ...
          def get(selector)
            begin
              arg_array = []
                validate_object(selector, AdwordsApi::V201008::ReportDefinitionService::ReportDefinitionSelector)
                arg_array << convert_to_object(selector, AdwordsApi::V201008::ReportDefinitionService::Get,
                    'selector')
              # Construct request object and make API call
              obj = AdwordsApi::V201008::ReportDefinitionService::Get.new(*arg_array)
          ...
          # Calls the {getReportFields}[http://code.google.com/apis/adwords/docs/reference/v201008/ReportDefinitionService.html#getReportFields] method of the ReportDefinitionService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201008/ReportDefinitionService.html#getReportFields].
          #
          # Args:
            # - reportType: AdwordsApi::V201008::ReportDefinitionService::ReportDefinitionReportType
            #
            # Returns:
            # - rval: SOAP::SOAPArray of AdwordsApi::V201008::ReportDefinitionService::ReportDefinitionField
          #
          # Raises:
          # Error::ApiError (or a subclass thereof) if a SOAP fault occurs.
          #
          def getReportFields(reportType)
            begin
              arg_array = []
                validate_object(reportType, AdwordsApi::V201008::ReportDefinitionService::ReportDefinitionReportType)
                arg_array << convert_to_object(reportType, AdwordsApi::V201008::ReportDefinitionService::GetReportFields,
                    'reportType')
              # Construct request object and make API call
              obj = AdwordsApi::V201008::ReportDefinitionService::GetReportFields.new(*arg_array)
          ...
          # Calls the {mutate}[http://code.google.com/apis/adwords/docs/reference/v201008/ReportDefinitionService.html#mutate] method of the ReportDefinitionService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201008/ReportDefinitionService.html#mutate].
          #
          # Args:
            # - operations: SOAP::SOAPArray of AdwordsApi::V201008::ReportDefinitionService::ReportDefinitionOperation
            #
            # Returns:
            # - rval: SOAP::SOAPArray of AdwordsApi::V201008::ReportDefinitionService::ReportDefinition
          #
          # Raises:
          # Error::ApiError (or a subclass thereof) if a SOAP fault occurs.
          #
          def mutate(operations)
            begin
              arg_array = []
                ...
                arg_array << convert_to_object(operations, AdwordsApi::V201008::ReportDefinitionService::Mutate,
                    'operations')
              # Construct request object and make API call
              obj = AdwordsApi::V201008::ReportDefinitionService::Mutate.new(*arg_array)
