  ...
  # library setup.
  require 'adwords_api/v201008/TrafficEstimatorServiceDriver.rb'

  module AdwordsApi
    module V201008
      module TrafficEstimatorService

        # Wrapper class for the v201008 TrafficEstimatorService service.
        ...
        class TrafficEstimatorServiceWrapper
          ...
          REGISTRY = AdwordsApi::V201008::TrafficEstimatorService::DefaultMappingRegistry::LiteralRegistry
          ...
          # instead of
          #  AdwordsApi::V201008::TrafficEstimatorService::ClassName
          ...
          def initialize(driver, api)
            @driver = driver
            @api = api
            @module = AdwordsApi::V201008::TrafficEstimatorService
            @version = :v201008
          ...
          # Calls the {get}[http://code.google.com/apis/adwords/docs/reference/v201008/TrafficEstimatorService.html#get] method of the TrafficEstimatorService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201008/TrafficEstimatorService.html#get].
          #
          # Args:
          ...
          def get(selector)
            begin
              arg_array = []
                validate_object(selector, AdwordsApi::V201008::TrafficEstimatorService::TrafficEstimatorSelector)
                arg_array << convert_to_object(selector, AdwordsApi::V201008::TrafficEstimatorService::Get,
                    'selector')
              # Construct request object and make API call
              obj = AdwordsApi::V201008::TrafficEstimatorService::Get.new(*arg_array)
