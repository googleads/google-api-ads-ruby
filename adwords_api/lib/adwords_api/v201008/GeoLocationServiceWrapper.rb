  ...
  # library setup.
  require 'adwords_api/v201008/GeoLocationServiceDriver.rb'

  module AdwordsApi
    module V201008
      module GeoLocationService

        # Wrapper class for the v201008 GeoLocationService service.
        ...
        class GeoLocationServiceWrapper
          ...
          REGISTRY = AdwordsApi::V201008::GeoLocationService::DefaultMappingRegistry::LiteralRegistry
          ...
          # instead of
          #  AdwordsApi::V201008::GeoLocationService::ClassName
          ...
          def initialize(driver, api)
            @driver = driver
            @api = api
            @module = AdwordsApi::V201008::GeoLocationService
            @version = :v201008
          ...
          # Calls the {get}[http://code.google.com/apis/adwords/docs/reference/v201008/GeoLocationService.html#get] method of the GeoLocationService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201008/GeoLocationService.html#get].
          #
          # Args:
            # - selector: AdwordsApi::V201008::GeoLocationService::GeoLocationSelector
            #
            # Returns:
            # - rval: SOAP::SOAPArray of AdwordsApi::V201008::GeoLocationService::GeoLocation
          #
          # Raises:
          ...
          def get(selector)
            begin
              arg_array = []
                validate_object(selector, AdwordsApi::V201008::GeoLocationService::GeoLocationSelector)
                arg_array << convert_to_object(selector, AdwordsApi::V201008::GeoLocationService::Get,
                    'selector')
              # Construct request object and make API call
              obj = AdwordsApi::V201008::GeoLocationService::Get.new(*arg_array)
