  ...
  # library setup.
  require 'adwords_api/v201008/BidLandscapeServiceDriver.rb'

  module AdwordsApi
    module V201008
      module BidLandscapeService

        # Wrapper class for the v201008 BidLandscapeService service.
        ...
        class BidLandscapeServiceWrapper
          ...
          REGISTRY = AdwordsApi::V201008::BidLandscapeService::DefaultMappingRegistry::LiteralRegistry
          ...
          # instead of
          #  AdwordsApi::V201008::BidLandscapeService::ClassName
          ...
          def initialize(driver, api)
            @driver = driver
            @api = api
            @module = AdwordsApi::V201008::BidLandscapeService
            @version = :v201008
          ...
          # Calls the {getBidLandscape}[http://code.google.com/apis/adwords/docs/reference/v201008/BidLandscapeService.html#getBidLandscape] method of the BidLandscapeService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201008/BidLandscapeService.html#getBidLandscape].
          #
          # Args:
            # - selector: AdwordsApi::V201008::BidLandscapeService::BidLandscapeSelector
            #
            # Returns:
            # - rval: SOAP::SOAPArray of AdwordsApi::V201008::BidLandscapeService::BidLandscape
          #
          # Raises:
          ...
          def getBidLandscape(selector)
            begin
              arg_array = []
                validate_object(selector, AdwordsApi::V201008::BidLandscapeService::BidLandscapeSelector)
                arg_array << convert_to_object(selector, AdwordsApi::V201008::BidLandscapeService::GetBidLandscape,
                    'selector')
              # Construct request object and make API call
              obj = AdwordsApi::V201008::BidLandscapeService::GetBidLandscape.new(*arg_array)
