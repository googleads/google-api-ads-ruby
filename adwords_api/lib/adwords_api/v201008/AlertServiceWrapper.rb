  ...
  # library setup.
  require 'adwords_api/v201008/AlertServiceDriver.rb'

  module AdwordsApi
    module V201008
      module AlertService

        # Wrapper class for the v201008 AlertService service.
        ...
        class AlertServiceWrapper
          ...
          REGISTRY = AdwordsApi::V201008::AlertService::DefaultMappingRegistry::LiteralRegistry
          ...
          # instead of
          #  AdwordsApi::V201008::AlertService::ClassName
          ...
          def initialize(driver, api)
            @driver = driver
            @api = api
            @module = AdwordsApi::V201008::AlertService
            @version = :v201008
          ...
          # Calls the {get}[http://code.google.com/apis/adwords/docs/reference/v201008/AlertService.html#get] method of the AlertService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201008/AlertService.html#get].
          #
          # Args:
          ...
          def get(selector)
            begin
              arg_array = []
                validate_object(selector, AdwordsApi::V201008::AlertService::AlertSelector)
                arg_array << convert_to_object(selector, AdwordsApi::V201008::AlertService::Get,
                    'selector')
              # Construct request object and make API call
              obj = AdwordsApi::V201008::AlertService::Get.new(*arg_array)
