  ...
  # library setup.
  require 'adwords_api/v201008/ServicedAccountServiceDriver.rb'

  module AdwordsApi
    module V201008
      module ServicedAccountService

        # Wrapper class for the v201008 ServicedAccountService service.
        ...
        class ServicedAccountServiceWrapper
          ...
          REGISTRY = AdwordsApi::V201008::ServicedAccountService::DefaultMappingRegistry::LiteralRegistry
          ...
          # instead of
          #  AdwordsApi::V201008::ServicedAccountService::ClassName
          ...
          def initialize(driver, api)
            @driver = driver
            @api = api
            @module = AdwordsApi::V201008::ServicedAccountService
            @version = :v201008
          ...
          # Calls the {get}[http://code.google.com/apis/adwords/docs/reference/v201008/ServicedAccountService.html#get] method of the ServicedAccountService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201008/ServicedAccountService.html#get].
          #
          # Args:
          ...
          def get(selector)
            begin
              arg_array = []
                validate_object(selector, AdwordsApi::V201008::ServicedAccountService::ServicedAccountSelector)
                arg_array << convert_to_object(selector, AdwordsApi::V201008::ServicedAccountService::Get,
                    'selector')
              # Construct request object and make API call
              obj = AdwordsApi::V201008::ServicedAccountService::Get.new(*arg_array)
