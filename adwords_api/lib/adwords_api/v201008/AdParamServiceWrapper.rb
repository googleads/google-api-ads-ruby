  ...
  # library setup.
  require 'adwords_api/v201008/AdParamServiceDriver.rb'

  module AdwordsApi
    module V201008
      module AdParamService

        # Wrapper class for the v201008 AdParamService service.
        ...
        class AdParamServiceWrapper
          ...
          REGISTRY = AdwordsApi::V201008::AdParamService::DefaultMappingRegistry::LiteralRegistry
          ...
          # instead of
          #  AdwordsApi::V201008::AdParamService::ClassName
          ...
          def initialize(driver, api)
            @driver = driver
            @api = api
            @module = AdwordsApi::V201008::AdParamService
            @version = :v201008
          ...
          # Calls the {get}[http://code.google.com/apis/adwords/docs/reference/v201008/AdParamService.html#get] method of the AdParamService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201008/AdParamService.html#get].
          #
          # Args:
          ...
          def get(selector)
            begin
              arg_array = []
                validate_object(selector, AdwordsApi::V201008::AdParamService::AdParamSelector)
                arg_array << convert_to_object(selector, AdwordsApi::V201008::AdParamService::Get,
                    'selector')
              # Construct request object and make API call
              obj = AdwordsApi::V201008::AdParamService::Get.new(*arg_array)
          ...
          # Calls the {mutate}[http://code.google.com/apis/adwords/docs/reference/v201008/AdParamService.html#mutate] method of the AdParamService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201008/AdParamService.html#mutate].
          #
          # Args:
            # - operations: SOAP::SOAPArray of AdwordsApi::V201008::AdParamService::AdParamOperation
            #
            # Returns:
            # - rval: SOAP::SOAPArray of AdwordsApi::V201008::AdParamService::AdParam
          #
          # Raises:
          # Error::ApiError (or a subclass thereof) if a SOAP fault occurs.
          #
          def mutate(operations)
            begin
              arg_array = []
                ...
                arg_array << convert_to_object(operations, AdwordsApi::V201008::AdParamService::Mutate,
                    'operations')
              # Construct request object and make API call
              obj = AdwordsApi::V201008::AdParamService::Mutate.new(*arg_array)
