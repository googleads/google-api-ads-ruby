  ...
  # library setup.
  require 'adwords_api/v201008/InfoServiceDriver.rb'

  module AdwordsApi
    module V201008
      module InfoService

        # Wrapper class for the v201008 InfoService service.
        ...
        class InfoServiceWrapper
          ...
          REGISTRY = AdwordsApi::V201008::InfoService::DefaultMappingRegistry::LiteralRegistry
          ...
          # instead of
          #  AdwordsApi::V201008::InfoService::ClassName
          ...
          def initialize(driver, api)
            @driver = driver
            @api = api
            @module = AdwordsApi::V201008::InfoService
            @version = :v201008
            @service = :InfoService
          end
          ...
          # Calls the {get}[http://code.google.com/apis/adwords/docs/reference/v201008/InfoService.html#get] method of the InfoService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201008/InfoService.html#get].
          #
          # Args:
          ...
          def get(selector)
            begin
              arg_array = []
                validate_object(selector, AdwordsApi::V201008::InfoService::InfoSelector)
                arg_array << convert_to_object(selector, AdwordsApi::V201008::InfoService::Get,
                    'selector')
              # Construct request object and make API call
              obj = AdwordsApi::V201008::InfoService::Get.new(*arg_array)
