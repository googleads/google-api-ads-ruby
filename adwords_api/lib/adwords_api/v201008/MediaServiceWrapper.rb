  ...
  # library setup.
  require 'adwords_api/v201008/MediaServiceDriver.rb'

  module AdwordsApi
    module V201008
      module MediaService

        # Wrapper class for the v201008 MediaService service.
        ...
        class MediaServiceWrapper
          ...
          REGISTRY = AdwordsApi::V201008::MediaService::DefaultMappingRegistry::LiteralRegistry
          ...
          # instead of
          #  AdwordsApi::V201008::MediaService::ClassName
          ...
          def initialize(driver, api)
            @driver = driver
            @api = api
            @module = AdwordsApi::V201008::MediaService
            @version = :v201008
          ...
          # Calls the {get}[http://code.google.com/apis/adwords/docs/reference/v201008/MediaService.html#get] method of the MediaService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201008/MediaService.html#get].
          #
          # Args:
          ...
          def get(selector)
            begin
              arg_array = []
                validate_object(selector, AdwordsApi::V201008::MediaService::MediaSelector)
                arg_array << convert_to_object(selector, AdwordsApi::V201008::MediaService::Get,
                    'selector')
              # Construct request object and make API call
              obj = AdwordsApi::V201008::MediaService::Get.new(*arg_array)
          ...
          # Calls the {upload}[http://code.google.com/apis/adwords/docs/reference/v201008/MediaService.html#upload] method of the MediaService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201008/MediaService.html#upload].
          #
          # Args:
            # - media: SOAP::SOAPArray of AdwordsApi::V201008::MediaService::Media
            #
            # Returns:
            # - rval: SOAP::SOAPArray of AdwordsApi::V201008::MediaService::Media
          #
          # Raises:
          # Error::ApiError (or a subclass thereof) if a SOAP fault occurs.
          #
          def upload(media)
            begin
              arg_array = []
                ...
                arg_array << convert_to_object(media, AdwordsApi::V201008::MediaService::Upload,
                    'media')
              # Construct request object and make API call
              obj = AdwordsApi::V201008::MediaService::Upload.new(*arg_array)
