  ...
  # library setup.
  require 'adwords_api/v201008/AdExtensionOverrideServiceDriver.rb'

  module AdwordsApi
    module V201008
      module AdExtensionOverrideService

        # Wrapper class for the v201008 AdExtensionOverrideService service.
        ...
        class AdExtensionOverrideServiceWrapper
          ...
          REGISTRY = AdwordsApi::V201008::AdExtensionOverrideService::DefaultMappingRegistry::LiteralRegistry
          ...
          # instead of
          #  AdwordsApi::V201008::AdExtensionOverrideService::ClassName
          ...
          def initialize(driver, api)
            @driver = driver
            @api = api
            @module = AdwordsApi::V201008::AdExtensionOverrideService
            @version = :v201008
          ...
          # Calls the {get}[http://code.google.com/apis/adwords/docs/reference/v201008/AdExtensionOverrideService.html#get] method of the AdExtensionOverrideService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201008/AdExtensionOverrideService.html#get].
          #
          # Args:
          ...
          def get(selector)
            begin
              arg_array = []
                validate_object(selector, AdwordsApi::V201008::AdExtensionOverrideService::AdExtensionOverrideSelector)
                arg_array << convert_to_object(selector, AdwordsApi::V201008::AdExtensionOverrideService::Get,
                    'selector')
              # Construct request object and make API call
              obj = AdwordsApi::V201008::AdExtensionOverrideService::Get.new(*arg_array)
          ...
          # Calls the {mutate}[http://code.google.com/apis/adwords/docs/reference/v201008/AdExtensionOverrideService.html#mutate] method of the AdExtensionOverrideService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201008/AdExtensionOverrideService.html#mutate].
          #
          # Args:
            # - operations: SOAP::SOAPArray of AdwordsApi::V201008::AdExtensionOverrideService::AdExtensionOverrideOperation
            #
            # Returns:
          ...
          def mutate(operations)
            begin
              arg_array = []
                ...
                arg_array << convert_to_object(operations, AdwordsApi::V201008::AdExtensionOverrideService::Mutate,
                    'operations')
              # Construct request object and make API call
              obj = AdwordsApi::V201008::AdExtensionOverrideService::Mutate.new(*arg_array)
