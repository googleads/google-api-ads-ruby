  ...
  # library setup.
  require 'adwords_api/v201008/CampaignCriterionServiceDriver.rb'

  module AdwordsApi
    module V201008
      module CampaignCriterionService

        # Wrapper class for the v201008 CampaignCriterionService service.
        ...
        class CampaignCriterionServiceWrapper
          ...
          REGISTRY = AdwordsApi::V201008::CampaignCriterionService::DefaultMappingRegistry::LiteralRegistry
          ...
          # instead of
          #  AdwordsApi::V201008::CampaignCriterionService::ClassName
          ...
          def initialize(driver, api)
            @driver = driver
            @api = api
            @module = AdwordsApi::V201008::CampaignCriterionService
            @version = :v201008
          ...
          # Calls the {get}[http://code.google.com/apis/adwords/docs/reference/v201008/CampaignCriterionService.html#get] method of the CampaignCriterionService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201008/CampaignCriterionService.html#get].
          #
          # Args:
          ...
          def get(selector)
            begin
              arg_array = []
                validate_object(selector, AdwordsApi::V201008::CampaignCriterionService::CampaignCriterionSelector)
                arg_array << convert_to_object(selector, AdwordsApi::V201008::CampaignCriterionService::Get,
                    'selector')
              # Construct request object and make API call
              obj = AdwordsApi::V201008::CampaignCriterionService::Get.new(*arg_array)
          ...
          # Calls the {mutate}[http://code.google.com/apis/adwords/docs/reference/v201008/CampaignCriterionService.html#mutate] method of the CampaignCriterionService service.
          # Check {the online documentation for this method}[http://code.google.com/apis/adwords/docs/reference/v201008/CampaignCriterionService.html#mutate].
          #
          # Args:
            # - operations: SOAP::SOAPArray of AdwordsApi::V201008::CampaignCriterionService::CampaignCriterionOperation
            #
            # Returns:
          ...
          def mutate(operations)
            begin
              arg_array = []
                ...
                arg_array << convert_to_object(operations, AdwordsApi::V201008::CampaignCriterionService::Mutate,
                    'operations')
              # Construct request object and make API call
              obj = AdwordsApi::V201008::CampaignCriterionService::Mutate.new(*arg_array)
