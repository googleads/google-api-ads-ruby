...
require 'adwords_api/v201702/batch_job_service_registry'

module AdwordsApi; module V201702; module BatchJobService
  class BatchJobService < AdsCommon::SavonService
    ...
    def get_module()
      return AdwordsApi::V201702::BatchJobService
    end
  end
end; end; end
