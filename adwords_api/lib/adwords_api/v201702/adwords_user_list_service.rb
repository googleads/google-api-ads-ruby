...
#
# Code generated by AdsCommon library 0.12.6 on 2017-02-28 08:23:55.

require 'ads_common/savon_service'
require 'adwords_api/v201702/adwords_user_list_service_registry'

module AdwordsApi; module V201702; module AdwordsUserListService
  class AdwordsUserListService < AdsCommon::SavonService
    def initialize(config, endpoint)
      namespace = 'https://adwords.google.com/api/adwords/rm/v201702'
    ...
    def get_module()
      return AdwordsApi::V201702::AdwordsUserListService
    end
  end
end; end; end
