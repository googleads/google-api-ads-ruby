...
#
# Code generated by AdsCommon library 0.12.6 on 2017-02-28 08:23:59.

require 'ads_common/savon_service'
require 'adwords_api/v201702/budget_order_service_registry'

module AdwordsApi; module V201702; module BudgetOrderService
  class BudgetOrderService < AdsCommon::SavonService
    def initialize(config, endpoint)
      namespace = 'https://adwords.google.com/api/adwords/billing/v201702'
    ...
    def get_module()
      return AdwordsApi::V201702::BudgetOrderService
    end
  end
end; end; end
