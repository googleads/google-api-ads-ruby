...
require 'adwords_api/v201702/shared_criterion_service_registry'

module AdwordsApi; module V201702; module SharedCriterionService
  class SharedCriterionService < AdsCommon::SavonService
    ...
    def get_module()
      return AdwordsApi::V201702::SharedCriterionService
    end
  end
end; end; end
