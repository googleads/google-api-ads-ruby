...
require 'adwords_api/v201309/bidding_strategy_service_registry'

module AdwordsApi; module V201309; module BiddingStrategyService
  class BiddingStrategyService < AdsCommon::SavonService
    ...
    def get_module()
      return AdwordsApi::V201309::BiddingStrategyService
    end
  end
end; end; end
