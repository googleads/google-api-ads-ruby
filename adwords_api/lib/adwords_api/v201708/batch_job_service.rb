...
require 'adwords_api/v201708/batch_job_service_registry'

module AdwordsApi; module V201708; module BatchJobService
  class BatchJobService < AdsCommon::SavonService
    ...
    def get_module()
      return AdwordsApi::V201708::BatchJobService
    end
  end
end; end; end
