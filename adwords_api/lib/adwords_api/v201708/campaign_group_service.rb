...
require 'adwords_api/v201708/campaign_group_service_registry'

module AdwordsApi; module V201708; module CampaignGroupService
  class CampaignGroupService < AdsCommon::SavonService
    ...
    def get_module()
      return AdwordsApi::V201708::CampaignGroupService
    end
  end
end; end; end
