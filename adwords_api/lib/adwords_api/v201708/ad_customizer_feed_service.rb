...
require 'adwords_api/v201708/ad_customizer_feed_service_registry'

module AdwordsApi; module V201708; module AdCustomizerFeedService
  class AdCustomizerFeedService < AdsCommon::SavonService
    ...
    def get_module()
      return AdwordsApi::V201708::AdCustomizerFeedService
    end
  end
end; end; end
