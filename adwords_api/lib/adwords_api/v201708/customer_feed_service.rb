...
require 'adwords_api/v201708/customer_feed_service_registry'

module AdwordsApi; module V201708; module CustomerFeedService
  class CustomerFeedService < AdsCommon::SavonService
    ...
    def get_module()
      return AdwordsApi::V201708::CustomerFeedService
    end
  end
end; end; end
