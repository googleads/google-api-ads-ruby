...
require 'adwords_api/v201710/shared_set_service_registry'

module AdwordsApi; module V201710; module SharedSetService
  class SharedSetService < AdsCommon::SavonService
    ...
    def get_module()
      return AdwordsApi::V201710::SharedSetService
    end
  end
end; end; end
