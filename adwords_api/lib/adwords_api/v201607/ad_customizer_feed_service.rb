...
require 'adwords_api/v201607/ad_customizer_feed_service_registry'

module AdwordsApi; module V201607; module AdCustomizerFeedService
  class AdCustomizerFeedService < AdsCommon::SavonService
    ...
    def get_module()
      return AdwordsApi::V201607::AdCustomizerFeedService
    end
  end
end; end; end
