...
#
# Code generated by AdsCommon library 0.12.3 on 2016-07-29 11:21:00.

require 'ads_common/savon_service'
require 'adwords_api/v201607/adwords_user_list_service_registry'

module AdwordsApi; module V201607; module AdwordsUserListService
  class AdwordsUserListService < AdsCommon::SavonService
    def initialize(config, endpoint)
      namespace = 'https://adwords.google.com/api/adwords/rm/v201607'
    ...
    def get_module()
      return AdwordsApi::V201607::AdwordsUserListService
    end
  end
end; end; end
