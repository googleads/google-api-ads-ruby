...
#
# Code generated by AdsCommon library 0.5.1 on 2011-09-21 11:57:42.
...
module AdwordsApi; module V201101; module AdParamService
  class AdParamServiceRegistry
    ...
    ADPARAMSERVICE_TYPES = {:Operation=>{:fields=>[{:type=>"Operator", :min_occurs=>0, :max_occurs=>1, :name=>:operator}, {:type=>"string", :min_occurs=>0, :max_occurs=>1, :name=>:operation_type}], :abstract=>true}, :PolicyViolationKey=>{:fields=>[{:type=>"string", :min_occurs=>0, :max_occurs=>1, :name=>:policy_name}, {:type=>"string", :min_occurs=>0, :max_occurs=>1, :name=>:violating_text}]}, :AdParam=>{:fields=>[{:type=>"long", :min_occurs=>0, :max_occurs=>1, :name=>:ad_group_id}, {:type=>"long", :min_occurs=>0, :max_occurs=>1, :name=>:criterion_id}, {:type=>"string", :min_occurs=>0, :max_occurs=>1, :name=>:insertion_text}, {:type=>"int", :min_occurs=>0, :max_occurs=>1, :name=>:param_index}]}, :OperationAccessDenied=>{:fields=>[{:type=>"OperationAccessDenied.Reason", :min_occurs=>0, :max_occurs=>1, :name=>:reason}], :base=>"ApiError"}, :SoapHeader=>{:fields=>[{:type=>"string", :min_occurs=>0, :max_occurs=>1, :name=>:auth_token}, {:type=>"string", :min_occurs=>0, :max_occurs=>1, :name=>:client_customer_id}, {:type=>"string", :min_occurs=>0, :max_occurs=>1, :name=>:client_email}, {:type=>"string", :min_occurs=>0, :max_occurs=>1, :name=>:developer_token}, {:type=>"string", :min_occurs=>0, :max_occurs=>1, :name=>:user_agent}, {:type=>"boolean", :min_occurs=>0, :max_occurs=>1, :name=>:validate_only}, {:type=>"boolean", :min_occurs=>0, :max_occurs=>1, :name=>:partial_failure}]}, :AdParamOperation=>{:fields=>[{:type=>"AdParam", :min_occurs=>0, :max_occurs=>1, :name=>:operand}], :base=>"Operation"}, :SoapResponseHeader=>{:fields=>[{:type=>"string", :min_occurs=>0, :max_occurs=>1, :name=>:request_id}, {:type=>"long", :min_occurs=>0, :max_occurs=>1, :name=>:operations}, {:type=>"long", :min_occurs=>0, :max_occurs=>1, :name=>:response_time}, {:type=>"long", :min_occurs=>0, :max_occurs=>1, :name=>:units}]}, :"PolicyViolationError.Part"=>{:fields=>[{:type=>"int", :min_occurs=>0, :max_occurs=>1, :name=>:index}, {:type=>"int", :min_occurs=>0, :max_occurs=>1, :name=>:length}]}, :AdParamPage=>{:fields=>[{:type=>"AdParam", :min_occurs=>0, :max_occurs=>:unbounded, :name=>:entries}, {:type=>"int", :min_occurs=>0, :max_occurs=>1, :name=>:total_num_entries}]}, :Paging=>{:fields=>[{:type=>"int", :min_occurs=>0, :max_occurs=>1, :name=>:start_index}, {:type=>"int", :min_occurs=>0, :max_occurs=>1, :name=>:number_results}]}, :AdParamSelector=>{:fields=>[{:type=>"long", :min_occurs=>0, :max_occurs=>:unbounded, :name=>:ad_group_ids}, {:type=>"long", :min_occurs=>0, :max_occurs=>:unbounded, :name=>:criteria_id}, {:type=>"Paging", :min_occurs=>0, :max_occurs=>1, :name=>:paging}]}}
