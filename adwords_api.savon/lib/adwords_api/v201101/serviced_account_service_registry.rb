...
module AdwordsApi; module V201101; module ServicedAccountService
  class ServicedAccountServiceRegistry
    ...
    SERVICEDACCOUNTSERVICE_TYPES = {:ServicedAccountSelector=>{:fields=>[{:type=>"long", :max_occurs=>:unbounded, :min_occurs=>0, :name=>:customer_ids}, {:type=>"boolean", :max_occurs=>1, :min_occurs=>0, :name=>:enable_paging}, {:type=>"ServiceType", :max_occurs=>:unbounded, :min_occurs=>0, :name=>:service_types}, {:type=>"boolean", :max_occurs=>1, :min_occurs=>0, :name=>:submanagers_only}]}, :ServicedAccountGraph=>{:fields=>[{:type=>"Account", :max_occurs=>:unbounded, :min_occurs=>0, :name=>:accounts}, {:type=>"Link", :max_occurs=>:unbounded, :min_occurs=>0, :name=>:links}]}, :SoapHeader=>{:fields=>[{:type=>"string", :max_occurs=>1, :min_occurs=>0, :name=>:auth_token}, {:type=>"string", :max_occurs=>1, :min_occurs=>0, :name=>:client_customer_id}, {:type=>"string", :max_occurs=>1, :min_occurs=>0, :name=>:client_email}, {:type=>"string", :max_occurs=>1, :min_occurs=>0, :name=>:developer_token}, {:type=>"string", :max_occurs=>1, :min_occurs=>0, :name=>:user_agent}, {:type=>"boolean", :max_occurs=>1, :min_occurs=>0, :name=>:validate_only}, {:type=>"boolean", :max_occurs=>1, :min_occurs=>0, :name=>:partial_failure}], :ns=>0}, :Account=>{:fields=>[{:type=>"long", :max_occurs=>1, :min_occurs=>0, :name=>:customer_id}, {:type=>"string", :max_occurs=>1, :min_occurs=>0, :name=>:login}, {:type=>"string", :max_occurs=>1, :min_occurs=>0, :name=>:company_name}, {:type=>"boolean", :max_occurs=>1, :min_occurs=>0, :name=>:can_manage_clients}, {:type=>"string", :max_occurs=>1, :min_occurs=>0, :name=>:currency_code}, {:type=>"string", :max_occurs=>1, :min_occurs=>0, :name=>:date_time_zone}]}, :SoapResponseHeader=>{:fields=>[{:type=>"string", :max_occurs=>1, :min_occurs=>0, :name=>:request_id}, {:type=>"long", :max_occurs=>1, :min_occurs=>0, :name=>:operations}, {:type=>"long", :max_occurs=>1, :min_occurs=>0, :name=>:response_time}, {:type=>"long", :max_occurs=>1, :min_occurs=>0, :name=>:units}], :ns=>0}, :CustomerId=>{:fields=>[{:type=>"long", :max_occurs=>1, :min_occurs=>0, :name=>:id}]}, :Link=>{:fields=>[{:type=>"CustomerId", :max_occurs=>1, :min_occurs=>0, :name=>:manager_id}, {:type=>"CustomerId", :max_occurs=>1, :min_occurs=>0, :name=>:client_id}, {:type=>"ServiceType", :max_occurs=>1, :min_occurs=>0, :name=>:service_type}, {:type=>"LinkType", :max_occurs=>1, :min_occurs=>0, :name=>:type_of_link}, {:type=>"string", :max_occurs=>1, :min_occurs=>0, :name=>:descriptive_name}, {:type=>"string", :max_occurs=>1, :min_occurs=>0, :name=>:link_type}]}}
