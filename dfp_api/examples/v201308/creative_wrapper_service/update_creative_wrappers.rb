...
def update_creative_wrappers()
  ...
  # Get creative wrapper by ID.
  creative_wrapper =
      creative_wrapper_service.get_creative_wrapper(creative_wrapper_id)
  ...
  if return_creative_wrappers
    return_creative_wrappers.each do |creative_wrapper|
      puts ("Creative wrapper ID: %d, label ID: %d was updated with ordering" +
