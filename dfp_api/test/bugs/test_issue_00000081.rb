...
require 'dfp_api/v201805/line_item_service'
...
class StubService81 < AdsCommon::SavonService
  ...
  def get_module()
    return DfpApi::V201805::LineItemService
  end
end
...
class TestDfpIssue81 < Test::Unit::TestCase
  ...
  TEST_ENDPOINT = (
      'https://ads.google.com/apis/ads/publisher/v201805/LineItemService?wsdl')
  TEST_VERSION = :v201805
  ...
  def test_issue_81()
    ...
    savon_service =
        StubService81.new(TEST_NAMESPACE, TEST_ENDPOINT, TEST_VERSION)
    assert_instance_of(DfpApi::V201805::LineItemService::ApiException,
...
<soap:Envelope xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
  <soap:Header>
    <ResponseHeader xmlns="https://www.google.com/apis/ads/publisher/v201805">
  ...
  <soap:Body>
    <soap:Fault>
      ...
      <detail>
        <ApiExceptionFault
         xmlns="https://www.google.com/apis/ads/publisher/v201805">
          <message>
