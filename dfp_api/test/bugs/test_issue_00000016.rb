...
require 'dfp_api/v201201/line_item_service'

class TestDfpApi < Test::Unit::TestCase
  class StubService < DfpApi::V201201::LineItemService::LineItemService
  ...
  def test_issue_16
    assert_nothing_raised do
      service = StubService.new(
          DfpApi::Api.new,
          'https://www.google.com/apis/ads/publisher/v201201/LineItemService')
