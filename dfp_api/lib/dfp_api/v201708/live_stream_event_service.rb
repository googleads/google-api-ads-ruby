...
require 'dfp_api/v201708/live_stream_event_service_registry'

module DfpApi; module V201708; module LiveStreamEventService
  class LiveStreamEventService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201708::LiveStreamEventService
    end
  end
end; end; end
