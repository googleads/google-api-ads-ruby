...
require 'dfp_api/v201708/content_metadata_key_hierarchy_service_registry'

module DfpApi; module V201708; module ContentMetadataKeyHierarchyService
  class ContentMetadataKeyHierarchyService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201708::ContentMetadataKeyHierarchyService
    end
  end
end; end; end
