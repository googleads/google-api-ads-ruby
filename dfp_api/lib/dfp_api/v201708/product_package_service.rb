...
require 'dfp_api/v201708/product_package_service_registry'

module DfpApi; module V201708; module ProductPackageService
  class ProductPackageService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201708::ProductPackageService
    end
  end
end; end; end
