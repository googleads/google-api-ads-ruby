...
require 'dfp_api/v201705/reconciliation_report_service_registry'

module DfpApi; module V201705; module ReconciliationReportService
  class ReconciliationReportService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201705::ReconciliationReportService
    end
  end
end; end; end
