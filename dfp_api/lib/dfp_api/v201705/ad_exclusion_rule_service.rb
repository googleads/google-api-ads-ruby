...
require 'dfp_api/v201705/ad_exclusion_rule_service_registry'

module DfpApi; module V201705; module AdExclusionRuleService
  class AdExclusionRuleService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201705::AdExclusionRuleService
    end
  end
end; end; end
