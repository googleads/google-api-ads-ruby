...
#
# Code generated by AdsCommon library 0.9.5 on 2014-02-26 15:36:25.

require 'ads_common/savon_service'
require 'dfp_api/v201311/exchange_rate_service_registry'
...
module DfpApi; module V201311; module ExchangeRateService
  class ExchangeRateService < AdsCommon::SavonService
    ...
    def get_exchange_rate(*args, &block)
      return execute_action('get_exchange_rate', args, &block)
    end
    ...
    def get_module()
      return DfpApi::V201311::ExchangeRateService
    end
  end
end; end; end
