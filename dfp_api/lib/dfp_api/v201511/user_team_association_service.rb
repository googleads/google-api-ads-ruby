...
require 'dfp_api/v201511/user_team_association_service_registry'

module DfpApi; module V201511; module UserTeamAssociationService
  class UserTeamAssociationService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201511::UserTeamAssociationService
    end
  end
end; end; end
