...
require 'dfp_api/v201511/content_bundle_service_registry'

module DfpApi; module V201511; module ContentBundleService
  class ContentBundleService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201511::ContentBundleService
    end
  end
end; end; end
