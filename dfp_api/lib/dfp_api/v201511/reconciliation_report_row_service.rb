...
require 'dfp_api/v201511/reconciliation_report_row_service_registry'

module DfpApi; module V201511; module ReconciliationReportRowService
  class ReconciliationReportRowService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201511::ReconciliationReportRowService
    end
  end
end; end; end
