...
require 'dfp_api/v201511/creative_wrapper_service_registry'

module DfpApi; module V201511; module CreativeWrapperService
  class CreativeWrapperService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201511::CreativeWrapperService
    end
  end
end; end; end
