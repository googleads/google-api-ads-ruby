...
#
# Code generated by AdsCommon library 0.5.0 on 2011-08-02 15:32:40.
...
module DfpApi; module V201101; module ReportService
  class ReportServiceRegistry
    ...
    REPORTSERVICE_TYPES = {:Date=>{:fields=>[{:type=>"int", :min_occurs=>0, :name=>:year, :max_occurs=>1}, {:type=>"int", :min_occurs=>0, :name=>:month, :max_occurs=>1}, {:type=>"int", :min_occurs=>0, :name=>:day, :max_occurs=>1}]}, :ReportQuery=>{:fields=>[{:type=>"Dimension", :min_occurs=>0, :name=>:dimensions, :max_occurs=>:unbounded}, {:type=>"Column", :min_occurs=>0, :name=>:columns, :max_occurs=>:unbounded}, {:type=>"DateTime", :min_occurs=>0, :name=>:start_date_time, :max_occurs=>1}, {:type=>"DateTime", :min_occurs=>0, :name=>:end_date_time, :max_occurs=>1}, {:type=>"DateRangeType", :min_occurs=>0, :name=>:date_range_type, :max_occurs=>1}, {:type=>"DimensionFilter", :min_occurs=>0, :name=>:dimension_filters, :max_occurs=>:unbounded}]}, :SoapRequestHeader=>{:fields=>[{:type=>"string", :min_occurs=>0, :name=>:auth_token, :max_occurs=>1}, {:type=>"string", :min_occurs=>0, :name=>:network_code, :max_occurs=>1}, {:type=>"string", :min_occurs=>0, :name=>:application_name, :max_occurs=>1}, {:type=>"string", :min_occurs=>0, :name=>:o_auth_token, :max_occurs=>1}]}, :ReportJob=>{:fields=>[{:type=>"long", :min_occurs=>0, :name=>:id, :max_occurs=>1}, {:type=>"ReportQuery", :min_occurs=>0, :name=>:report_query, :max_occurs=>1}, {:type=>"ReportJobStatus", :min_occurs=>0, :name=>:report_job_status, :max_occurs=>1}]}, :DateTime=>{:fields=>[{:type=>"Date", :min_occurs=>0, :name=>:date, :max_occurs=>1}, {:type=>"int", :min_occurs=>0, :name=>:hour, :max_occurs=>1}, {:type=>"int", :min_occurs=>0, :name=>:minute, :max_occurs=>1}, {:type=>"int", :min_occurs=>0, :name=>:second, :max_occurs=>1}, {:type=>"string", :min_occurs=>0, :name=>:time_zone_id, :max_occurs=>1}]}, :SoapResponseHeader=>{:fields=>[{:type=>"string", :min_occurs=>0, :name=>:request_id, :max_occurs=>1}, {:type=>"long", :min_occurs=>0, :name=>:response_time, :max_occurs=>1}]}}
