...
require 'dfp_api/v201602/reconciliation_order_report_service_registry'

module DfpApi; module V201602; module ReconciliationOrderReportService
  class ReconciliationOrderReportService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201602::ReconciliationOrderReportService
    end
  end
end; end; end
