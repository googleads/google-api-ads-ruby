...
require 'dfp_api/v201602/suggested_ad_unit_service_registry'

module DfpApi; module V201602; module SuggestedAdUnitService
  class SuggestedAdUnitService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201602::SuggestedAdUnitService
    end
  end
end; end; end
