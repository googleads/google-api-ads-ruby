...
require 'dfp_api/v201602/reconciliation_report_row_service_registry'

module DfpApi; module V201602; module ReconciliationReportRowService
  class ReconciliationReportRowService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201602::ReconciliationReportRowService
    end
  end
end; end; end
