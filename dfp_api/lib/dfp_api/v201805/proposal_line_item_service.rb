...
require 'dfp_api/v201805/proposal_line_item_service_registry'

module DfpApi; module V201805; module ProposalLineItemService
  class ProposalLineItemService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201805::ProposalLineItemService
    end
  end
end; end; end
