...
require 'dfp_api/v201805/mobile_application_service_registry'

module DfpApi; module V201805; module MobileApplicationService
  class MobileApplicationService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201805::MobileApplicationService
    end
  end
end; end; end
