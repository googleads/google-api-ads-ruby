...
require 'dfp_api/v201805/content_bundle_service_registry'

module DfpApi; module V201805; module ContentBundleService
  class ContentBundleService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201805::ContentBundleService
    end
  end
end; end; end
