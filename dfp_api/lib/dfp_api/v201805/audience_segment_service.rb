...
require 'dfp_api/v201805/audience_segment_service_registry'

module DfpApi; module V201805; module AudienceSegmentService
  class AudienceSegmentService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201805::AudienceSegmentService
    end
  end
end; end; end
