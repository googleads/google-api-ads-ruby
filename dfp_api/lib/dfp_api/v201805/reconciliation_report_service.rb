...
require 'dfp_api/v201805/reconciliation_report_service_registry'

module DfpApi; module V201805; module ReconciliationReportService
  class ReconciliationReportService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201805::ReconciliationReportService
    end
  end
end; end; end
