...
require 'dfp_api/v201805/reconciliation_line_item_report_service_registry'

module DfpApi; module V201805; module ReconciliationLineItemReportService
  class ReconciliationLineItemReportService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201805::ReconciliationLineItemReportService
    end
  end
end; end; end
