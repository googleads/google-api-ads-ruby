...
require 'dfp_api/v201805/creative_template_service_registry'

module DfpApi; module V201805; module CreativeTemplateService
  class CreativeTemplateService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201805::CreativeTemplateService
    end
  end
end; end; end
