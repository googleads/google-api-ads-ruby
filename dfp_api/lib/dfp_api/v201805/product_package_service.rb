...
require 'dfp_api/v201805/product_package_service_registry'

module DfpApi; module V201805; module ProductPackageService
  class ProductPackageService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201805::ProductPackageService
    end
  end
end; end; end
