...
require 'dfp_api/v201805/product_template_service_registry'

module DfpApi; module V201805; module ProductTemplateService
  class ProductTemplateService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201805::ProductTemplateService
    end
  end
end; end; end
