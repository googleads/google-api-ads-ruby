...
require 'dfp_api/v201805/reconciliation_order_report_service_registry'

module DfpApi; module V201805; module ReconciliationOrderReportService
  class ReconciliationOrderReportService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201805::ReconciliationOrderReportService
    end
  end
end; end; end
