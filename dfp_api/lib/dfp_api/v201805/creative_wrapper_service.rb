...
require 'dfp_api/v201805/creative_wrapper_service_registry'

module DfpApi; module V201805; module CreativeWrapperService
  class CreativeWrapperService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201805::CreativeWrapperService
    end
  end
end; end; end
