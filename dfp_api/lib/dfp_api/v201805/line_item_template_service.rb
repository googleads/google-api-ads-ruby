...
require 'dfp_api/v201805/line_item_template_service_registry'

module DfpApi; module V201805; module LineItemTemplateService
  class LineItemTemplateService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201805::LineItemTemplateService
    end
  end
end; end; end
