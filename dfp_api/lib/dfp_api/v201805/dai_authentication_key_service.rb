...
require 'dfp_api/v201805/dai_authentication_key_service_registry'

module DfpApi; module V201805; module DaiAuthenticationKeyService
  class DaiAuthenticationKeyService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201805::DaiAuthenticationKeyService
    end
  end
end; end; end
