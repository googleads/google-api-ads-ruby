...
require 'dfp_api/v201805/content_metadata_key_hierarchy_service_registry'

module DfpApi; module V201805; module ContentMetadataKeyHierarchyService
  class ContentMetadataKeyHierarchyService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201805::ContentMetadataKeyHierarchyService
    end
  end
end; end; end
