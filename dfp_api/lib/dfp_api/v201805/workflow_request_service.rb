...
require 'dfp_api/v201805/workflow_request_service_registry'

module DfpApi; module V201805; module WorkflowRequestService
  class WorkflowRequestService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201805::WorkflowRequestService
    end
  end
end; end; end
