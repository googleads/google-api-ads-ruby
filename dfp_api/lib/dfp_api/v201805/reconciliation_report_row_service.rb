...
require 'dfp_api/v201805/reconciliation_report_row_service_registry'

module DfpApi; module V201805; module ReconciliationReportRowService
  class ReconciliationReportRowService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201805::ReconciliationReportRowService
    end
  end
end; end; end
