...
require 'dfp_api/v201805/suggested_ad_unit_service_registry'

module DfpApi; module V201805; module SuggestedAdUnitService
  class SuggestedAdUnitService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201805::SuggestedAdUnitService
    end
  end
end; end; end
