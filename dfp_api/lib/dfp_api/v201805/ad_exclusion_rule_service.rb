...
require 'dfp_api/v201805/ad_exclusion_rule_service_registry'

module DfpApi; module V201805; module AdExclusionRuleService
  class AdExclusionRuleService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201805::AdExclusionRuleService
    end
  end
end; end; end
