...
require 'dfp_api/v201805/cdn_configuration_service_registry'

module DfpApi; module V201805; module CdnConfigurationService
  class CdnConfigurationService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201805::CdnConfigurationService
    end
  end
end; end; end
