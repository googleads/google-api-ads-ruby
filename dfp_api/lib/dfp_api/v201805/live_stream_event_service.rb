...
require 'dfp_api/v201805/live_stream_event_service_registry'

module DfpApi; module V201805; module LiveStreamEventService
  class LiveStreamEventService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201805::LiveStreamEventService
    end
  end
end; end; end
