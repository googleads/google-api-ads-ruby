...
require 'dfp_api/v201805/publisher_query_language_service_registry'

module DfpApi; module V201805; module PublisherQueryLanguageService
  class PublisherQueryLanguageService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201805::PublisherQueryLanguageService
    end
  end
end; end; end
