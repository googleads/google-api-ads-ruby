...
require 'dfp_api/v201805/line_item_creative_association_service_registry'

module DfpApi; module V201805; module LineItemCreativeAssociationService
  class LineItemCreativeAssociationService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201805::LineItemCreativeAssociationService
    end
  end
end; end; end
