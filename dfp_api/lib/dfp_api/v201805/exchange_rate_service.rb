...
require 'dfp_api/v201805/exchange_rate_service_registry'

module DfpApi; module V201805; module ExchangeRateService
  class ExchangeRateService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201805::ExchangeRateService
    end
  end
end; end; end
