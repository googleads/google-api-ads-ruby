...
require 'dfp_api/v201502/creative_wrapper_service_registry'

module DfpApi; module V201502; module CreativeWrapperService
  class CreativeWrapperService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201502::CreativeWrapperService
    end
  end
end; end; end
