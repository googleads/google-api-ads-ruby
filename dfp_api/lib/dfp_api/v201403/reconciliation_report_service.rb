...
require 'dfp_api/v201403/reconciliation_report_service_registry'

module DfpApi; module V201403; module ReconciliationReportService
  class ReconciliationReportService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201403::ReconciliationReportService
    end
  end
end; end; end
