...
require 'dfp_api/v201411/report_service_registry'

module DfpApi; module V201411; module ReportService
  class ReportService < AdsCommon::SavonService
    ...
    def get_report_job_to_xml(*args)
      return get_soap_xml('get_report_job', args)
    end
    ...
    def get_module()
      return DfpApi::V201411::ReportService
    end
  end
end; end; end
