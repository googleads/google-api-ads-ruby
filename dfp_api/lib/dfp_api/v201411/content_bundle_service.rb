...
require 'dfp_api/v201411/content_bundle_service_registry'

module DfpApi; module V201411; module ContentBundleService
  class ContentBundleService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201411::ContentBundleService
    end
  end
end; end; end
