...
require 'dfp_api/v201608/publisher_query_language_service_registry'

module DfpApi; module V201608; module PublisherQueryLanguageService
  class PublisherQueryLanguageService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201608::PublisherQueryLanguageService
    end
  end
end; end; end
