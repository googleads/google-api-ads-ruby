...
require 'dfp_api/v201608/creative_wrapper_service_registry'

module DfpApi; module V201608; module CreativeWrapperService
  class CreativeWrapperService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201608::CreativeWrapperService
    end
  end
end; end; end
