...
require 'dfp_api/v201408/suggested_ad_unit_service_registry'

module DfpApi; module V201408; module SuggestedAdUnitService
  class SuggestedAdUnitService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201408::SuggestedAdUnitService
    end
  end
end; end; end
