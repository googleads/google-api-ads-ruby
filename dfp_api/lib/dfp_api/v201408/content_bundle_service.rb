...
require 'dfp_api/v201408/content_bundle_service_registry'

module DfpApi; module V201408; module ContentBundleService
  class ContentBundleService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201408::ContentBundleService
    end
  end
end; end; end
