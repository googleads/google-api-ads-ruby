...
require 'dfp_api/v201408/reconciliation_order_report_service_registry'

module DfpApi; module V201408; module ReconciliationOrderReportService
  class ReconciliationOrderReportService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201408::ReconciliationOrderReportService
    end
  end
end; end; end
