...
require 'dfp_api/v201302/content_bundle_service_registry'

module DfpApi; module V201302; module ContentBundleService
  class ContentBundleService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201302::ContentBundleService
    end
  end
end; end; end
