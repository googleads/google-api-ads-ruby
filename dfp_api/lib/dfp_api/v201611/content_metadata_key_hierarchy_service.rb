...
require 'dfp_api/v201611/content_metadata_key_hierarchy_service_registry'

module DfpApi; module V201611; module ContentMetadataKeyHierarchyService
  class ContentMetadataKeyHierarchyService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201611::ContentMetadataKeyHierarchyService
    end
  end
end; end; end
