...
require 'dfp_api/v201611/reconciliation_report_row_service_registry'

module DfpApi; module V201611; module ReconciliationReportRowService
  class ReconciliationReportRowService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201611::ReconciliationReportRowService
    end
  end
end; end; end
