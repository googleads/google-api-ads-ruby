...
require 'dfp_api/v201611/live_stream_event_service_registry'

module DfpApi; module V201611; module LiveStreamEventService
  class LiveStreamEventService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201611::LiveStreamEventService
    end
  end
end; end; end
