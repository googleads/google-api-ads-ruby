...
require 'dfp_api/v201611/workflow_request_service_registry'

module DfpApi; module V201611; module WorkflowRequestService
  class WorkflowRequestService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201611::WorkflowRequestService
    end
  end
end; end; end
