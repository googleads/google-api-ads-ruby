...
require 'dfp_api/v201308/reconciliation_report_service_registry'

module DfpApi; module V201308; module ReconciliationReportService
  class ReconciliationReportService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201308::ReconciliationReportService
    end
  end
end; end; end
