...
require 'dfp_api/v201711/line_item_template_service_registry'

module DfpApi; module V201711; module LineItemTemplateService
  class LineItemTemplateService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201711::LineItemTemplateService
    end
  end
end; end; end
