...
require 'dfp_api/v201711/product_package_service_registry'

module DfpApi; module V201711; module ProductPackageService
  class ProductPackageService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201711::ProductPackageService
    end
  end
end; end; end
