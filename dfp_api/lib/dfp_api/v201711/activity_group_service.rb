...
require 'dfp_api/v201711/activity_group_service_registry'

module DfpApi; module V201711; module ActivityGroupService
  class ActivityGroupService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201711::ActivityGroupService
    end
  end
end; end; end
