...
require 'dfp_api/v201711/user_team_association_service_registry'

module DfpApi; module V201711; module UserTeamAssociationService
  class UserTeamAssociationService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201711::UserTeamAssociationService
    end
  end
end; end; end
