...
require 'dfp_api/v201711/reconciliation_report_row_service_registry'

module DfpApi; module V201711; module ReconciliationReportRowService
  class ReconciliationReportRowService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201711::ReconciliationReportRowService
    end
  end
end; end; end
