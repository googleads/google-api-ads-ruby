...
require 'dfp_api/v201711/line_item_creative_association_service_registry'

module DfpApi; module V201711; module LineItemCreativeAssociationService
  class LineItemCreativeAssociationService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201711::LineItemCreativeAssociationService
    end
  end
end; end; end
