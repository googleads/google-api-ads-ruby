...
require 'dfp_api/v201711/product_package_item_service_registry'

module DfpApi; module V201711; module ProductPackageItemService
  class ProductPackageItemService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201711::ProductPackageItemService
    end
  end
end; end; end
