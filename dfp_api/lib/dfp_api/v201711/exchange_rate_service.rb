...
require 'dfp_api/v201711/exchange_rate_service_registry'

module DfpApi; module V201711; module ExchangeRateService
  class ExchangeRateService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201711::ExchangeRateService
    end
  end
end; end; end
