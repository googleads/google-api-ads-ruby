...
require 'dfp_api/v201711/proposal_line_item_service_registry'

module DfpApi; module V201711; module ProposalLineItemService
  class ProposalLineItemService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201711::ProposalLineItemService
    end
  end
end; end; end
