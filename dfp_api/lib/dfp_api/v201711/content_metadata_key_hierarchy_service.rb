...
require 'dfp_api/v201711/content_metadata_key_hierarchy_service_registry'

module DfpApi; module V201711; module ContentMetadataKeyHierarchyService
  class ContentMetadataKeyHierarchyService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201711::ContentMetadataKeyHierarchyService
    end
  end
end; end; end
