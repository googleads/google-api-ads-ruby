...
require 'dfp_api/v201711/live_stream_event_service_registry'

module DfpApi; module V201711; module LiveStreamEventService
  class LiveStreamEventService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201711::LiveStreamEventService
    end
  end
end; end; end
