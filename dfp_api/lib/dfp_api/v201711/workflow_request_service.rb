...
require 'dfp_api/v201711/workflow_request_service_registry'

module DfpApi; module V201711; module WorkflowRequestService
  class WorkflowRequestService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201711::WorkflowRequestService
    end
  end
end; end; end
