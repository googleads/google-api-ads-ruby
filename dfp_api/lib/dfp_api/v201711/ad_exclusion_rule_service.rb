...
require 'dfp_api/v201711/ad_exclusion_rule_service_registry'

module DfpApi; module V201711; module AdExclusionRuleService
  class AdExclusionRuleService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201711::AdExclusionRuleService
    end
  end
end; end; end
