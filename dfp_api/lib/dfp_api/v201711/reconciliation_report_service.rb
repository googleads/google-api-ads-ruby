...
require 'dfp_api/v201711/reconciliation_report_service_registry'

module DfpApi; module V201711; module ReconciliationReportService
  class ReconciliationReportService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201711::ReconciliationReportService
    end
  end
end; end; end
