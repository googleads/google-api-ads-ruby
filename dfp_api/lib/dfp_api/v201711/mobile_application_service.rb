...
require 'dfp_api/v201711/mobile_application_service_registry'

module DfpApi; module V201711; module MobileApplicationService
  class MobileApplicationService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201711::MobileApplicationService
    end
  end
end; end; end
