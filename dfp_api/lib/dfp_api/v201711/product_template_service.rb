...
require 'dfp_api/v201711/product_template_service_registry'

module DfpApi; module V201711; module ProductTemplateService
  class ProductTemplateService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201711::ProductTemplateService
    end
  end
end; end; end
