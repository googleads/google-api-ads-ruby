...
require 'dfp_api/v201711/reconciliation_order_report_service_registry'

module DfpApi; module V201711; module ReconciliationOrderReportService
  class ReconciliationOrderReportService < AdsCommon::SavonService
    ...
    def get_module()
      return DfpApi::V201711::ReconciliationOrderReportService
    end
  end
end; end; end
