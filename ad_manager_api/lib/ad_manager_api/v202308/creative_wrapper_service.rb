...
require 'ad_manager_api/v202308/creative_wrapper_service_registry'

module AdManagerApi; module V202308; module CreativeWrapperService
  class CreativeWrapperService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202308::CreativeWrapperService
    end
  end
end; end; end
