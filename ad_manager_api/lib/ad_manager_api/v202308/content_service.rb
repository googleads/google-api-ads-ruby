...
require 'ad_manager_api/v202308/content_service_registry'

module AdManagerApi; module V202308; module ContentService
  class ContentService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202308::ContentService
    end
  end
end; end; end
