...
require 'ad_manager_api/v201802/publisher_query_language_service_registry'

module AdManagerApi; module V201802; module PublisherQueryLanguageService
  class PublisherQueryLanguageService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201802::PublisherQueryLanguageService
    end
  end
end; end; end
