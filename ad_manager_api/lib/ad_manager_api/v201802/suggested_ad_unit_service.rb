...
require 'ad_manager_api/v201802/suggested_ad_unit_service_registry'

module AdManagerApi; module V201802; module SuggestedAdUnitService
  class SuggestedAdUnitService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201802::SuggestedAdUnitService
    end
  end
end; end; end
