...
require 'ad_manager_api/v201802/line_item_service_registry'

module AdManagerApi; module V201802; module LineItemService
  class LineItemService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201802::LineItemService
    end
  end
end; end; end
