...
require 'ad_manager_api/v201802/creative_wrapper_service_registry'

module AdManagerApi; module V201802; module CreativeWrapperService
  class CreativeWrapperService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201802::CreativeWrapperService
    end
  end
end; end; end
