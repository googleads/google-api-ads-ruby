...
require 'ad_manager_api/v201802/line_item_template_service_registry'

module AdManagerApi; module V201802; module LineItemTemplateService
  class LineItemTemplateService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201802::LineItemTemplateService
    end
  end
end; end; end
