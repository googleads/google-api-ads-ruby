...
require 'ad_manager_api/v201802/inventory_service_registry'

module AdManagerApi; module V201802; module InventoryService
  class InventoryService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201802::InventoryService
    end
  end
end; end; end
