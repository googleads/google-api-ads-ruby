...
require 'ad_manager_api/v201802/content_metadata_key_hierarchy_service_registry'

module AdManagerApi; module V201802; module ContentMetadataKeyHierarchyService
  class ContentMetadataKeyHierarchyService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201802::ContentMetadataKeyHierarchyService
    end
  end
end; end; end
