...
require 'ad_manager_api/v201802/ad_exclusion_rule_service_registry'

module AdManagerApi; module V201802; module AdExclusionRuleService
  class AdExclusionRuleService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201802::AdExclusionRuleService
    end
  end
end; end; end
