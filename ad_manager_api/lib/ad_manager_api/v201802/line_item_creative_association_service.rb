...
require 'ad_manager_api/v201802/line_item_creative_association_service_registry'

module AdManagerApi; module V201802; module LineItemCreativeAssociationService
  class LineItemCreativeAssociationService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201802::LineItemCreativeAssociationService
    end
  end
end; end; end
