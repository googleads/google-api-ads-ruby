...
require 'ad_manager_api/v201802/live_stream_event_service_registry'

module AdManagerApi; module V201802; module LiveStreamEventService
  class LiveStreamEventService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201802::LiveStreamEventService
    end
  end
end; end; end
