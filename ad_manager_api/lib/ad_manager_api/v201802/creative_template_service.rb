...
require 'ad_manager_api/v201802/creative_template_service_registry'

module AdManagerApi; module V201802; module CreativeTemplateService
  class CreativeTemplateService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201802::CreativeTemplateService
    end
  end
end; end; end
