...
require 'ad_manager_api/v201802/placement_service_registry'

module AdManagerApi; module V201802; module PlacementService
  class PlacementService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201802::PlacementService
    end
  end
end; end; end
