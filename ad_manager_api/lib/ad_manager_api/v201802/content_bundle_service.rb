...
require 'ad_manager_api/v201802/content_bundle_service_registry'

module AdManagerApi; module V201802; module ContentBundleService
  class ContentBundleService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201802::ContentBundleService
    end
  end
end; end; end
