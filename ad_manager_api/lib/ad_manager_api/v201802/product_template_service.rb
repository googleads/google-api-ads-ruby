...
require 'ad_manager_api/v201802/product_template_service_registry'

module AdManagerApi; module V201802; module ProductTemplateService
  class ProductTemplateService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201802::ProductTemplateService
    end
  end
end; end; end
