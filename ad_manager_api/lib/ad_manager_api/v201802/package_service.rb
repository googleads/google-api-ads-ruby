...
require 'ad_manager_api/v201802/package_service_registry'

module AdManagerApi; module V201802; module PackageService
  class PackageService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201802::PackageService
    end
  end
end; end; end
