...
require 'ad_manager_api/v201802/forecast_service_registry'

module AdManagerApi; module V201802; module ForecastService
  class ForecastService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201802::ForecastService
    end
  end
end; end; end
