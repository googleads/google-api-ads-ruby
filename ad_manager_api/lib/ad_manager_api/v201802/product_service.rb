...
require 'ad_manager_api/v201802/product_service_registry'

module AdManagerApi; module V201802; module ProductService
  class ProductService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201802::ProductService
    end
  end
end; end; end
