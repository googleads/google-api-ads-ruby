...
require 'ad_manager_api/v201802/user_team_association_service_registry'

module AdManagerApi; module V201802; module UserTeamAssociationService
  class UserTeamAssociationService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201802::UserTeamAssociationService
    end
  end
end; end; end
