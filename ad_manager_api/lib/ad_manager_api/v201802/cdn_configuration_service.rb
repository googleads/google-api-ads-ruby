...
require 'ad_manager_api/v201802/cdn_configuration_service_registry'

module AdManagerApi; module V201802; module CdnConfigurationService
  class CdnConfigurationService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201802::CdnConfigurationService
    end
  end
end; end; end
