...
require 'ad_manager_api/v201802/ad_rule_service_registry'

module AdManagerApi; module V201802; module AdRuleService
  class AdRuleService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201802::AdRuleService
    end
  end
end; end; end
