...
require 'ad_manager_api/v201802/proposal_line_item_service_registry'

module AdManagerApi; module V201802; module ProposalLineItemService
  class ProposalLineItemService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201802::ProposalLineItemService
    end
  end
end; end; end
