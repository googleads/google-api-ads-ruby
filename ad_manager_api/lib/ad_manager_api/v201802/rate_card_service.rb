...
require 'ad_manager_api/v201802/rate_card_service_registry'

module AdManagerApi; module V201802; module RateCardService
  class RateCardService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201802::RateCardService
    end
  end
end; end; end
