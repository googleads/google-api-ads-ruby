...
require 'ad_manager_api/v201802/premium_rate_service_registry'

module AdManagerApi; module V201802; module PremiumRateService
  class PremiumRateService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201802::PremiumRateService
    end
  end
end; end; end
