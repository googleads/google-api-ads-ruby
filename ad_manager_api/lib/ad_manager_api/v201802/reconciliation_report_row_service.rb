...
require 'ad_manager_api/v201802/reconciliation_report_row_service_registry'

module AdManagerApi; module V201802; module ReconciliationReportRowService
  class ReconciliationReportRowService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201802::ReconciliationReportRowService
    end
  end
end; end; end
