...
require 'ad_manager_api/v201802/native_style_service_registry'

module AdManagerApi; module V201802; module NativeStyleService
  class NativeStyleService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201802::NativeStyleService
    end
  end
end; end; end
