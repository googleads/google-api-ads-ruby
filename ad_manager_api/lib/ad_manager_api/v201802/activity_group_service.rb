...
require 'ad_manager_api/v201802/activity_group_service_registry'

module AdManagerApi; module V201802; module ActivityGroupService
  class ActivityGroupService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201802::ActivityGroupService
    end
  end
end; end; end
