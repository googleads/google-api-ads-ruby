...
require 'ad_manager_api/v201802/reconciliation_report_service_registry'

module AdManagerApi; module V201802; module ReconciliationReportService
  class ReconciliationReportService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201802::ReconciliationReportService
    end
  end
end; end; end
