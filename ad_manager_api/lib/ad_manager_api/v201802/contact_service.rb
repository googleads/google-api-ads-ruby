...
require 'ad_manager_api/v201802/contact_service_registry'

module AdManagerApi; module V201802; module ContactService
  class ContactService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201802::ContactService
    end
  end
end; end; end
