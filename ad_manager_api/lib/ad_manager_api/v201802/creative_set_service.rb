...
require 'ad_manager_api/v201802/creative_set_service_registry'

module AdManagerApi; module V201802; module CreativeSetService
  class CreativeSetService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201802::CreativeSetService
    end
  end
end; end; end
