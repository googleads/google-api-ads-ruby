...
require 'ad_manager_api/v201802/exchange_rate_service_registry'

module AdManagerApi; module V201802; module ExchangeRateService
  class ExchangeRateService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201802::ExchangeRateService
    end
  end
end; end; end
