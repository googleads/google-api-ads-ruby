...
require 'ad_manager_api/v201802/audience_segment_service_registry'

module AdManagerApi; module V201802; module AudienceSegmentService
  class AudienceSegmentService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201802::AudienceSegmentService
    end
  end
end; end; end
