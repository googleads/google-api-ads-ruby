...
require 'ad_manager_api/v201802/reconciliation_order_report_service_registry'

module AdManagerApi; module V201802; module ReconciliationOrderReportService
  class ReconciliationOrderReportService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201802::ReconciliationOrderReportService
    end
  end
end; end; end
