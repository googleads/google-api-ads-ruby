...
require 'ad_manager_api/v201802/report_service_registry'

module AdManagerApi; module V201802; module ReportService
  class ReportService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201802::ReportService
    end
  end
end; end; end
