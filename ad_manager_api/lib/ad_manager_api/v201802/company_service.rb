...
require 'ad_manager_api/v201802/company_service_registry'

module AdManagerApi; module V201802; module CompanyService
  class CompanyService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201802::CompanyService
    end
  end
end; end; end
