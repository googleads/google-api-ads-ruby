...
require 'ad_manager_api/v201802/base_rate_service_registry'

module AdManagerApi; module V201802; module BaseRateService
  class BaseRateService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201802::BaseRateService
    end
  end
end; end; end
