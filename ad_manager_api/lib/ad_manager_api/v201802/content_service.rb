...
require 'ad_manager_api/v201802/content_service_registry'

module AdManagerApi; module V201802; module ContentService
  class ContentService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201802::ContentService
    end
  end
end; end; end
