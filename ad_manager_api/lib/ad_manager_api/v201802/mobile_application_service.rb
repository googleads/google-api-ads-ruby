...
require 'ad_manager_api/v201802/mobile_application_service_registry'

module AdManagerApi; module V201802; module MobileApplicationService
  class MobileApplicationService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201802::MobileApplicationService
    end
  end
end; end; end
