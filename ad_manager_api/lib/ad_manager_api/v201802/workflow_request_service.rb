...
require 'ad_manager_api/v201802/workflow_request_service_registry'

module AdManagerApi; module V201802; module WorkflowRequestService
  class WorkflowRequestService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201802::WorkflowRequestService
    end
  end
end; end; end
