...
require 'ad_manager_api/v201802/activity_service_registry'

module AdManagerApi; module V201802; module ActivityService
  class ActivityService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201802::ActivityService
    end
  end
end; end; end
