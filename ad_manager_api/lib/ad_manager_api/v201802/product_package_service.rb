...
require 'ad_manager_api/v201802/product_package_service_registry'

module AdManagerApi; module V201802; module ProductPackageService
  class ProductPackageService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201802::ProductPackageService
    end
  end
end; end; end
