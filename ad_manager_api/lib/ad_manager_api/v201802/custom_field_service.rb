...
require 'ad_manager_api/v201802/custom_field_service_registry'

module AdManagerApi; module V201802; module CustomFieldService
  class CustomFieldService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201802::CustomFieldService
    end
  end
end; end; end
