...
require 'ad_manager_api/v201802/network_service_registry'

module AdManagerApi; module V201802; module NetworkService
  class NetworkService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201802::NetworkService
    end
  end
end; end; end
