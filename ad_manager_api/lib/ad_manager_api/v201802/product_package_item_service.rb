...
require 'ad_manager_api/v201802/product_package_item_service_registry'

module AdManagerApi; module V201802; module ProductPackageItemService
  class ProductPackageItemService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201802::ProductPackageItemService
    end
  end
end; end; end
