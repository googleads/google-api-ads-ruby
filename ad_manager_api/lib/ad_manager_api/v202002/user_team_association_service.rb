...
require 'ad_manager_api/v202002/user_team_association_service_registry'

module AdManagerApi; module V202002; module UserTeamAssociationService
  class UserTeamAssociationService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202002::UserTeamAssociationService
    end
  end
end; end; end
