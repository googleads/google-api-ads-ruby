...
require 'ad_manager_api/v202002/cdn_configuration_service_registry'

module AdManagerApi; module V202002; module CdnConfigurationService
  class CdnConfigurationService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202002::CdnConfigurationService
    end
  end
end; end; end
