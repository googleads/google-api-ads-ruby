...
require 'ad_manager_api/v202002/custom_field_service_registry'

module AdManagerApi; module V202002; module CustomFieldService
  class CustomFieldService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202002::CustomFieldService
    end
  end
end; end; end
