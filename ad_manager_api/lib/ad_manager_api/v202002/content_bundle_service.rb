...
require 'ad_manager_api/v202002/content_bundle_service_registry'

module AdManagerApi; module V202002; module ContentBundleService
  class ContentBundleService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202002::ContentBundleService
    end
  end
end; end; end
