...
require 'ad_manager_api/v202002/activity_group_service_registry'

module AdManagerApi; module V202002; module ActivityGroupService
  class ActivityGroupService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202002::ActivityGroupService
    end
  end
end; end; end
