...
require 'ad_manager_api/v202002/custom_targeting_service_registry'

module AdManagerApi; module V202002; module CustomTargetingService
  class CustomTargetingService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202002::CustomTargetingService
    end
  end
end; end; end
