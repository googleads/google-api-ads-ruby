...
require 'ad_manager_api/v202002/suggested_ad_unit_service_registry'

module AdManagerApi; module V202002; module SuggestedAdUnitService
  class SuggestedAdUnitService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202002::SuggestedAdUnitService
    end
  end
end; end; end
