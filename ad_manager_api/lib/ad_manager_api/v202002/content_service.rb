...
require 'ad_manager_api/v202002/content_service_registry'

module AdManagerApi; module V202002; module ContentService
  class ContentService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202002::ContentService
    end
  end
end; end; end
