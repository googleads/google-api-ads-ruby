...
require 'ad_manager_api/v202002/ad_exclusion_rule_service_registry'

module AdManagerApi; module V202002; module AdExclusionRuleService
  class AdExclusionRuleService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202002::AdExclusionRuleService
    end
  end
end; end; end
