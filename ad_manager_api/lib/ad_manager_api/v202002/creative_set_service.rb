...
require 'ad_manager_api/v202002/creative_set_service_registry'

module AdManagerApi; module V202002; module CreativeSetService
  class CreativeSetService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202002::CreativeSetService
    end
  end
end; end; end
