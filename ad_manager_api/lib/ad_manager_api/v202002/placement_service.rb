...
require 'ad_manager_api/v202002/placement_service_registry'

module AdManagerApi; module V202002; module PlacementService
  class PlacementService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202002::PlacementService
    end
  end
end; end; end
