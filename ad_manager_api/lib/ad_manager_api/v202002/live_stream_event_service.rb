...
require 'ad_manager_api/v202002/live_stream_event_service_registry'

module AdManagerApi; module V202002; module LiveStreamEventService
  class LiveStreamEventService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202002::LiveStreamEventService
    end
  end
end; end; end
