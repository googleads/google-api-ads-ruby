...
require 'ad_manager_api/v202002/native_style_service_registry'

module AdManagerApi; module V202002; module NativeStyleService
  class NativeStyleService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202002::NativeStyleService
    end
  end
end; end; end
