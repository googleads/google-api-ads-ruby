...
require 'ad_manager_api/v202005/native_style_service_registry'

module AdManagerApi; module V202005; module NativeStyleService
  class NativeStyleService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202005::NativeStyleService
    end
  end
end; end; end
