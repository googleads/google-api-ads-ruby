...
require 'ad_manager_api/v202005/report_service_registry'

module AdManagerApi; module V202005; module ReportService
  class ReportService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202005::ReportService
    end
  end
end; end; end
