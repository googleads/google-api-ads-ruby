...
require 'ad_manager_api/v202005/contact_service_registry'

module AdManagerApi; module V202005; module ContactService
  class ContactService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202005::ContactService
    end
  end
end; end; end
