...
require 'ad_manager_api/v202005/ad_exclusion_rule_service_registry'

module AdManagerApi; module V202005; module AdExclusionRuleService
  class AdExclusionRuleService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202005::AdExclusionRuleService
    end
  end
end; end; end
