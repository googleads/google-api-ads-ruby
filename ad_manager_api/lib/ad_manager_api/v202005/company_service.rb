...
require 'ad_manager_api/v202005/company_service_registry'

module AdManagerApi; module V202005; module CompanyService
  class CompanyService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202005::CompanyService
    end
  end
end; end; end
