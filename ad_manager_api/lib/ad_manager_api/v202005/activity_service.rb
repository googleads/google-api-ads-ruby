...
require 'ad_manager_api/v202005/activity_service_registry'

module AdManagerApi; module V202005; module ActivityService
  class ActivityService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202005::ActivityService
    end
  end
end; end; end
