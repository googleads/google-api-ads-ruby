...
require 'ad_manager_api/v202005/creative_service_registry'

module AdManagerApi; module V202005; module CreativeService
  class CreativeService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202005::CreativeService
    end
  end
end; end; end
