...
require 'ad_manager_api/v202005/custom_field_service_registry'

module AdManagerApi; module V202005; module CustomFieldService
  class CustomFieldService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202005::CustomFieldService
    end
  end
end; end; end
