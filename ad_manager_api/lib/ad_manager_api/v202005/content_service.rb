...
require 'ad_manager_api/v202005/content_service_registry'

module AdManagerApi; module V202005; module ContentService
  class ContentService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202005::ContentService
    end
  end
end; end; end
