...
require 'ad_manager_api/v202005/content_bundle_service_registry'

module AdManagerApi; module V202005; module ContentBundleService
  class ContentBundleService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202005::ContentBundleService
    end
  end
end; end; end
