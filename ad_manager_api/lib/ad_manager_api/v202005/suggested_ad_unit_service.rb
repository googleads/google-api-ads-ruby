...
require 'ad_manager_api/v202005/suggested_ad_unit_service_registry'

module AdManagerApi; module V202005; module SuggestedAdUnitService
  class SuggestedAdUnitService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202005::SuggestedAdUnitService
    end
  end
end; end; end
