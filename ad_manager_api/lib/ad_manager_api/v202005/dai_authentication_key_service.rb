...
require 'ad_manager_api/v202005/dai_authentication_key_service_registry'

module AdManagerApi; module V202005; module DaiAuthenticationKeyService
  class DaiAuthenticationKeyService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202005::DaiAuthenticationKeyService
    end
  end
end; end; end
