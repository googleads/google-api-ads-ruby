...
require 'ad_manager_api/v202005/creative_wrapper_service_registry'

module AdManagerApi; module V202005; module CreativeWrapperService
  class CreativeWrapperService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202005::CreativeWrapperService
    end
  end
end; end; end
