...
require 'ad_manager_api/v201911/cdn_configuration_service_registry'

module AdManagerApi; module V201911; module CdnConfigurationService
  class CdnConfigurationService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201911::CdnConfigurationService
    end
  end
end; end; end
