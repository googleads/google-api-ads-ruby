...
require 'ad_manager_api/v201911/cms_metadata_service_registry'

module AdManagerApi; module V201911; module CmsMetadataService
  class CmsMetadataService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201911::CmsMetadataService
    end
  end
end; end; end
