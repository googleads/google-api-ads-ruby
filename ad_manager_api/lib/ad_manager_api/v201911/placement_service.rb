...
require 'ad_manager_api/v201911/placement_service_registry'

module AdManagerApi; module V201911; module PlacementService
  class PlacementService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201911::PlacementService
    end
  end
end; end; end
