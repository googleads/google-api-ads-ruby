...
require 'ad_manager_api/v201911/creative_service_registry'

module AdManagerApi; module V201911; module CreativeService
  class CreativeService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201911::CreativeService
    end
  end
end; end; end
