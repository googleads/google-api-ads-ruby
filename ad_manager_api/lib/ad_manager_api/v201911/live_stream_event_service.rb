...
require 'ad_manager_api/v201911/live_stream_event_service_registry'

module AdManagerApi; module V201911; module LiveStreamEventService
  class LiveStreamEventService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201911::LiveStreamEventService
    end
  end
end; end; end
