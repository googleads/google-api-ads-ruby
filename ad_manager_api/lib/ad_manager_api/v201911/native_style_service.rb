...
require 'ad_manager_api/v201911/native_style_service_registry'

module AdManagerApi; module V201911; module NativeStyleService
  class NativeStyleService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201911::NativeStyleService
    end
  end
end; end; end
