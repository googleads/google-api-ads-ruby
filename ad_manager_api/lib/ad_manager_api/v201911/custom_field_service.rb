...
require 'ad_manager_api/v201911/custom_field_service_registry'

module AdManagerApi; module V201911; module CustomFieldService
  class CustomFieldService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201911::CustomFieldService
    end
  end
end; end; end
