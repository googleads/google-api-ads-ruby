...
require 'ad_manager_api/v201911/creative_wrapper_service_registry'

module AdManagerApi; module V201911; module CreativeWrapperService
  class CreativeWrapperService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201911::CreativeWrapperService
    end
  end
end; end; end
