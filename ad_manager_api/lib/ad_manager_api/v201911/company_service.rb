...
require 'ad_manager_api/v201911/company_service_registry'

module AdManagerApi; module V201911; module CompanyService
  class CompanyService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201911::CompanyService
    end
  end
end; end; end
