...
require 'ad_manager_api/v201911/activity_service_registry'

module AdManagerApi; module V201911; module ActivityService
  class ActivityService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201911::ActivityService
    end
  end
end; end; end
