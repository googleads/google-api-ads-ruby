...
require 'ad_manager_api/v201911/targeting_preset_service_registry'

module AdManagerApi; module V201911; module TargetingPresetService
  class TargetingPresetService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201911::TargetingPresetService
    end
  end
end; end; end
