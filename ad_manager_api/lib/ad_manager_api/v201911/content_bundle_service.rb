...
require 'ad_manager_api/v201911/content_bundle_service_registry'

module AdManagerApi; module V201911; module ContentBundleService
  class ContentBundleService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201911::ContentBundleService
    end
  end
end; end; end
