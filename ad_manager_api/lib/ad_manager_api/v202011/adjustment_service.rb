...
require 'ad_manager_api/v202011/adjustment_service_registry'

module AdManagerApi; module V202011; module AdjustmentService
  class AdjustmentService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202011::AdjustmentService
    end
  end
end; end; end
