...
require 'ad_manager_api/v202011/targeting_preset_service_registry'

module AdManagerApi; module V202011; module TargetingPresetService
  class TargetingPresetService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202011::TargetingPresetService
    end
  end
end; end; end
