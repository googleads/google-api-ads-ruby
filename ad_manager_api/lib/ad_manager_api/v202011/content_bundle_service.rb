...
require 'ad_manager_api/v202011/content_bundle_service_registry'

module AdManagerApi; module V202011; module ContentBundleService
  class ContentBundleService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202011::ContentBundleService
    end
  end
end; end; end
