...
require 'ad_manager_api/v202011/live_stream_event_service_registry'

module AdManagerApi; module V202011; module LiveStreamEventService
  class LiveStreamEventService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202011::LiveStreamEventService
    end
  end
end; end; end
