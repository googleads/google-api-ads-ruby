...
require 'ad_manager_api/v202011/content_service_registry'

module AdManagerApi; module V202011; module ContentService
  class ContentService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202011::ContentService
    end
  end
end; end; end
