...
require 'ad_manager_api/v202011/contact_service_registry'

module AdManagerApi; module V202011; module ContactService
  class ContactService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202011::ContactService
    end
  end
end; end; end
