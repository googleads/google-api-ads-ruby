...
require 'ad_manager_api/v202011/activity_service_registry'

module AdManagerApi; module V202011; module ActivityService
  class ActivityService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202011::ActivityService
    end
  end
end; end; end
