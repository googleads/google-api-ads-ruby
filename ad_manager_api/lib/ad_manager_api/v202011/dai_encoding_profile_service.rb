...
require 'ad_manager_api/v202011/dai_encoding_profile_service_registry'

module AdManagerApi; module V202011; module DaiEncodingProfileService
  class DaiEncodingProfileService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202011::DaiEncodingProfileService
    end
  end
end; end; end
