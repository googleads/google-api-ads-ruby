...
require 'ad_manager_api/v202011/company_service_registry'

module AdManagerApi; module V202011; module CompanyService
  class CompanyService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202011::CompanyService
    end
  end
end; end; end
