...
require 'ad_manager_api/v202011/custom_field_service_registry'

module AdManagerApi; module V202011; module CustomFieldService
  class CustomFieldService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202011::CustomFieldService
    end
  end
end; end; end
