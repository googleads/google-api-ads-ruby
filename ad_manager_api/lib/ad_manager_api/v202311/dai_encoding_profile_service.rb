...
require 'ad_manager_api/v202311/dai_encoding_profile_service_registry'

module AdManagerApi; module V202311; module DaiEncodingProfileService
  class DaiEncodingProfileService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202311::DaiEncodingProfileService
    end
  end
end; end; end
