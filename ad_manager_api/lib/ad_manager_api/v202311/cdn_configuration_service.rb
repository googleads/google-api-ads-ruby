...
require 'ad_manager_api/v202311/cdn_configuration_service_registry'

module AdManagerApi; module V202311; module CdnConfigurationService
  class CdnConfigurationService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202311::CdnConfigurationService
    end
  end
end; end; end
