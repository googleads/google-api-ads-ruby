...
require 'ad_manager_api/v202508/creative_set_service_registry'

module AdManagerApi; module V202508; module CreativeSetService
  class CreativeSetService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202508::CreativeSetService
    end
  end
end; end; end
