...
require 'ad_manager_api/v202508/cdn_configuration_service_registry'

module AdManagerApi; module V202508; module CdnConfigurationService
  class CdnConfigurationService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202508::CdnConfigurationService
    end
  end
end; end; end
