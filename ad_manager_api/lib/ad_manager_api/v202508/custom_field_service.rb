...
require 'ad_manager_api/v202508/custom_field_service_registry'

module AdManagerApi; module V202508; module CustomFieldService
  class CustomFieldService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202508::CustomFieldService
    end
  end
end; end; end
