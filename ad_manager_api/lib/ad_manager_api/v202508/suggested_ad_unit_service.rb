...
require 'ad_manager_api/v202508/suggested_ad_unit_service_registry'

module AdManagerApi; module V202508; module SuggestedAdUnitService
  class SuggestedAdUnitService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202508::SuggestedAdUnitService
    end
  end
end; end; end
