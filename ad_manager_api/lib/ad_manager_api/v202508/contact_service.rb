...
require 'ad_manager_api/v202508/contact_service_registry'

module AdManagerApi; module V202508; module ContactService
  class ContactService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202508::ContactService
    end
  end
end; end; end
