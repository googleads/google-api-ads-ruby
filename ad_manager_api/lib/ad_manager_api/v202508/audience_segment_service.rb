...
require 'ad_manager_api/v202508/audience_segment_service_registry'

module AdManagerApi; module V202508; module AudienceSegmentService
  class AudienceSegmentService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202508::AudienceSegmentService
    end
  end
end; end; end
