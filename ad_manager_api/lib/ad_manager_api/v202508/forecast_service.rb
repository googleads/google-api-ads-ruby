...
require 'ad_manager_api/v202508/forecast_service_registry'

module AdManagerApi; module V202508; module ForecastService
  class ForecastService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202508::ForecastService
    end
  end
end; end; end
