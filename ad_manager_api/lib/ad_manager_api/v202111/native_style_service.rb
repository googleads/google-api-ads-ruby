...
require 'ad_manager_api/v202111/native_style_service_registry'

module AdManagerApi; module V202111; module NativeStyleService
  class NativeStyleService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202111::NativeStyleService
    end
  end
end; end; end
