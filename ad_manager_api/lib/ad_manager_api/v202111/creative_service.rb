...
require 'ad_manager_api/v202111/creative_service_registry'

module AdManagerApi; module V202111; module CreativeService
  class CreativeService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202111::CreativeService
    end
  end
end; end; end
