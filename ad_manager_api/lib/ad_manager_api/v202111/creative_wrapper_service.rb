...
require 'ad_manager_api/v202111/creative_wrapper_service_registry'

module AdManagerApi; module V202111; module CreativeWrapperService
  class CreativeWrapperService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202111::CreativeWrapperService
    end
  end
end; end; end
