...
require 'ad_manager_api/v202111/company_service_registry'

module AdManagerApi; module V202111; module CompanyService
  class CompanyService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202111::CompanyService
    end
  end
end; end; end
