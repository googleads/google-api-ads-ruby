...
require 'ad_manager_api/v202111/activity_service_registry'

module AdManagerApi; module V202111; module ActivityService
  class ActivityService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202111::ActivityService
    end
  end
end; end; end
