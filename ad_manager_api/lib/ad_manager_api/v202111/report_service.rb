...
require 'ad_manager_api/v202111/report_service_registry'

module AdManagerApi; module V202111; module ReportService
  class ReportService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202111::ReportService
    end
  end
end; end; end
