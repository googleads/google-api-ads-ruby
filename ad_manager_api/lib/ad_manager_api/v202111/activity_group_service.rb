...
require 'ad_manager_api/v202111/activity_group_service_registry'

module AdManagerApi; module V202111; module ActivityGroupService
  class ActivityGroupService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202111::ActivityGroupService
    end
  end
end; end; end
