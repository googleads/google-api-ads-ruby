...
require 'ad_manager_api/v202111/suggested_ad_unit_service_registry'

module AdManagerApi; module V202111; module SuggestedAdUnitService
  class SuggestedAdUnitService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202111::SuggestedAdUnitService
    end
  end
end; end; end
