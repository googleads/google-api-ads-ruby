...
require 'ad_manager_api/v202111/custom_targeting_service_registry'

module AdManagerApi; module V202111; module CustomTargetingService
  class CustomTargetingService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202111::CustomTargetingService
    end
  end
end; end; end
