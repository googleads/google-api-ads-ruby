...
require 'ad_manager_api/v202111/placement_service_registry'

module AdManagerApi; module V202111; module PlacementService
  class PlacementService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202111::PlacementService
    end
  end
end; end; end
