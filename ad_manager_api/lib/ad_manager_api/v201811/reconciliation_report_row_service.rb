...
require 'ad_manager_api/v201811/reconciliation_report_row_service_registry'

module AdManagerApi; module V201811; module ReconciliationReportRowService
  class ReconciliationReportRowService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201811::ReconciliationReportRowService
    end
  end
end; end; end
