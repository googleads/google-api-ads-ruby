...
require 'ad_manager_api/v201811/placement_service_registry'

module AdManagerApi; module V201811; module PlacementService
  class PlacementService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201811::PlacementService
    end
  end
end; end; end
