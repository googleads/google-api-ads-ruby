...
require 'ad_manager_api/v201811/reconciliation_report_service_registry'

module AdManagerApi; module V201811; module ReconciliationReportService
  class ReconciliationReportService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201811::ReconciliationReportService
    end
  end
end; end; end
