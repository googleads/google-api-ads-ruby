...
require 'ad_manager_api/v201811/company_service_registry'

module AdManagerApi; module V201811; module CompanyService
  class CompanyService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201811::CompanyService
    end
  end
end; end; end
