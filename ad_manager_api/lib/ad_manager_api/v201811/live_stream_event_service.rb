...
require 'ad_manager_api/v201811/live_stream_event_service_registry'

module AdManagerApi; module V201811; module LiveStreamEventService
  class LiveStreamEventService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201811::LiveStreamEventService
    end
  end
end; end; end
