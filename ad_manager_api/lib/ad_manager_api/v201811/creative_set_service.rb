...
require 'ad_manager_api/v201811/creative_set_service_registry'

module AdManagerApi; module V201811; module CreativeSetService
  class CreativeSetService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201811::CreativeSetService
    end
  end
end; end; end
