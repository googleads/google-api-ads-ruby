...
require 'ad_manager_api/v201811/custom_targeting_service_registry'

module AdManagerApi; module V201811; module CustomTargetingService
  class CustomTargetingService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201811::CustomTargetingService
    end
  end
end; end; end
