...
require 'ad_manager_api/v201811/contact_service_registry'

module AdManagerApi; module V201811; module ContactService
  class ContactService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201811::ContactService
    end
  end
end; end; end
