...
require 'ad_manager_api/v201811/creative_wrapper_service_registry'

module AdManagerApi; module V201811; module CreativeWrapperService
  class CreativeWrapperService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201811::CreativeWrapperService
    end
  end
end; end; end
