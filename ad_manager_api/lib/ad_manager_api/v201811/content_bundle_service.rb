...
require 'ad_manager_api/v201811/content_bundle_service_registry'

module AdManagerApi; module V201811; module ContentBundleService
  class ContentBundleService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201811::ContentBundleService
    end
  end
end; end; end
