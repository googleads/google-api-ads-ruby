...
require 'ad_manager_api/v201811/reconciliation_order_report_service_registry'

module AdManagerApi; module V201811; module ReconciliationOrderReportService
  class ReconciliationOrderReportService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201811::ReconciliationOrderReportService
    end
  end
end; end; end
