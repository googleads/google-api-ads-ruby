...
require 'ad_manager_api/v201811/ad_rule_service_registry'

module AdManagerApi; module V201811; module AdRuleService
  class AdRuleService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201811::AdRuleService
    end
  end
end; end; end
