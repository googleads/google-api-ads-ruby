...
require 'ad_manager_api/v201811/creative_service_registry'

module AdManagerApi; module V201811; module CreativeService
  class CreativeService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201811::CreativeService
    end
  end
end; end; end
