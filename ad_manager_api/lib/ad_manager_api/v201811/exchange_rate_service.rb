...
require 'ad_manager_api/v201811/exchange_rate_service_registry'

module AdManagerApi; module V201811; module ExchangeRateService
  class ExchangeRateService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201811::ExchangeRateService
    end
  end
end; end; end
