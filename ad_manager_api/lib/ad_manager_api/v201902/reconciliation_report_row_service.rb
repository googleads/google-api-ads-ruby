...
require 'ad_manager_api/v201902/reconciliation_report_row_service_registry'

module AdManagerApi; module V201902; module ReconciliationReportRowService
  class ReconciliationReportRowService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201902::ReconciliationReportRowService
    end
  end
end; end; end
