...
require 'ad_manager_api/v201902/mobile_application_service_registry'

module AdManagerApi; module V201902; module MobileApplicationService
  class MobileApplicationService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201902::MobileApplicationService
    end
  end
end; end; end
