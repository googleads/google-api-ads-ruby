...
require 'ad_manager_api/v201902/base_rate_service_registry'

module AdManagerApi; module V201902; module BaseRateService
  class BaseRateService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201902::BaseRateService
    end
  end
end; end; end
