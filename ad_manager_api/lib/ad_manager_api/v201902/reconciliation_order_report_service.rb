...
require 'ad_manager_api/v201902/reconciliation_order_report_service_registry'

module AdManagerApi; module V201902; module ReconciliationOrderReportService
  class ReconciliationOrderReportService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201902::ReconciliationOrderReportService
    end
  end
end; end; end
