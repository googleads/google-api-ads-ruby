...
require 'ad_manager_api/v201902/creative_service_registry'

module AdManagerApi; module V201902; module CreativeService
  class CreativeService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201902::CreativeService
    end
  end
end; end; end
