...
require 'ad_manager_api/v201902/creative_wrapper_service_registry'

module AdManagerApi; module V201902; module CreativeWrapperService
  class CreativeWrapperService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201902::CreativeWrapperService
    end
  end
end; end; end
