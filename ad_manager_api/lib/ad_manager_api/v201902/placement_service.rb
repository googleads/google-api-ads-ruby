...
require 'ad_manager_api/v201902/placement_service_registry'

module AdManagerApi; module V201902; module PlacementService
  class PlacementService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201902::PlacementService
    end
  end
end; end; end
