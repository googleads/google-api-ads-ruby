...
require 'ad_manager_api/v201902/custom_field_service_registry'

module AdManagerApi; module V201902; module CustomFieldService
  class CustomFieldService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201902::CustomFieldService
    end
  end
end; end; end
