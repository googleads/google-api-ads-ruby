...
require 'ad_manager_api/v201902/cdn_configuration_service_registry'

module AdManagerApi; module V201902; module CdnConfigurationService
  class CdnConfigurationService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201902::CdnConfigurationService
    end
  end
end; end; end
