...
require 'ad_manager_api/v201905/audience_segment_service_registry'

module AdManagerApi; module V201905; module AudienceSegmentService
  class AudienceSegmentService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201905::AudienceSegmentService
    end
  end
end; end; end
