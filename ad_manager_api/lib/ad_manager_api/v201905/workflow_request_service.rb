...
require 'ad_manager_api/v201905/workflow_request_service_registry'

module AdManagerApi; module V201905; module WorkflowRequestService
  class WorkflowRequestService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201905::WorkflowRequestService
    end
  end
end; end; end
