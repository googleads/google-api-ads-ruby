...
require 'ad_manager_api/v201905/creative_service_registry'

module AdManagerApi; module V201905; module CreativeService
  class CreativeService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201905::CreativeService
    end
  end
end; end; end
