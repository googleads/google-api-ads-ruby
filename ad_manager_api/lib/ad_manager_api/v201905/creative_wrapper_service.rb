...
require 'ad_manager_api/v201905/creative_wrapper_service_registry'

module AdManagerApi; module V201905; module CreativeWrapperService
  class CreativeWrapperService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201905::CreativeWrapperService
    end
  end
end; end; end
