...
require 'ad_manager_api/v201905/cdn_configuration_service_registry'

module AdManagerApi; module V201905; module CdnConfigurationService
  class CdnConfigurationService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201905::CdnConfigurationService
    end
  end
end; end; end
