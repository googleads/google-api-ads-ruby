...
require 'ad_manager_api/v201905/custom_field_service_registry'

module AdManagerApi; module V201905; module CustomFieldService
  class CustomFieldService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201905::CustomFieldService
    end
  end
end; end; end
