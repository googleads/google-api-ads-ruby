...
require 'ad_manager_api/v201905/contact_service_registry'

module AdManagerApi; module V201905; module ContactService
  class ContactService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201905::ContactService
    end
  end
end; end; end
