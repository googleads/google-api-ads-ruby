...
require 'ad_manager_api/v201905/activity_service_registry'

module AdManagerApi; module V201905; module ActivityService
  class ActivityService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201905::ActivityService
    end
  end
end; end; end
