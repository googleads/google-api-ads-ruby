...
require 'ad_manager_api/v201905/cms_metadata_service_registry'

module AdManagerApi; module V201905; module CmsMetadataService
  class CmsMetadataService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201905::CmsMetadataService
    end
  end
end; end; end
