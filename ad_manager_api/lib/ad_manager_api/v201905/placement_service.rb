...
require 'ad_manager_api/v201905/placement_service_registry'

module AdManagerApi; module V201905; module PlacementService
  class PlacementService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201905::PlacementService
    end
  end
end; end; end
