...
require 'ad_manager_api/v201905/rate_card_service_registry'

module AdManagerApi; module V201905; module RateCardService
  class RateCardService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201905::RateCardService
    end
  end
end; end; end
