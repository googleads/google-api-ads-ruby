...
require 'ad_manager_api/v201905/native_style_service_registry'

module AdManagerApi; module V201905; module NativeStyleService
  class NativeStyleService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201905::NativeStyleService
    end
  end
end; end; end
