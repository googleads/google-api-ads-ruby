...
require 'ad_manager_api/v201905/targeting_preset_service_registry'

module AdManagerApi; module V201905; module TargetingPresetService
  class TargetingPresetService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201905::TargetingPresetService
    end
  end
end; end; end
