...
require 'ad_manager_api/v201905/reconciliation_report_service_registry'

module AdManagerApi; module V201905; module ReconciliationReportService
  class ReconciliationReportService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201905::ReconciliationReportService
    end
  end
end; end; end
