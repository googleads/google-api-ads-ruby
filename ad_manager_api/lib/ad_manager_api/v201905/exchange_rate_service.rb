...
require 'ad_manager_api/v201905/exchange_rate_service_registry'

module AdManagerApi; module V201905; module ExchangeRateService
  class ExchangeRateService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201905::ExchangeRateService
    end
  end
end; end; end
