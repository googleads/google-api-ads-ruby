...
require 'ad_manager_api/v201905/activity_group_service_registry'

module AdManagerApi; module V201905; module ActivityGroupService
  class ActivityGroupService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201905::ActivityGroupService
    end
  end
end; end; end
