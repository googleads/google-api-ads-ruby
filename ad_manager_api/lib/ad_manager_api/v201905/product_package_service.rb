...
require 'ad_manager_api/v201905/product_package_service_registry'

module AdManagerApi; module V201905; module ProductPackageService
  class ProductPackageService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201905::ProductPackageService
    end
  end
end; end; end
