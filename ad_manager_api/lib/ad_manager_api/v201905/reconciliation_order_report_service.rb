...
require 'ad_manager_api/v201905/reconciliation_order_report_service_registry'

module AdManagerApi; module V201905; module ReconciliationOrderReportService
  class ReconciliationOrderReportService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201905::ReconciliationOrderReportService
    end
  end
end; end; end
