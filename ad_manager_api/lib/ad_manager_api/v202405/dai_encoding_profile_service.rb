...
require 'ad_manager_api/v202405/dai_encoding_profile_service_registry'

module AdManagerApi; module V202405; module DaiEncodingProfileService
  class DaiEncodingProfileService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202405::DaiEncodingProfileService
    end
  end
end; end; end
