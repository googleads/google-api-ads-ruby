...
require 'ad_manager_api/v202405/yield_group_service_registry'

module AdManagerApi; module V202405; module YieldGroupService
  class YieldGroupService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202405::YieldGroupService
    end
  end
end; end; end
