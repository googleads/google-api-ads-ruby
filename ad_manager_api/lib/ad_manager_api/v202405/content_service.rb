...
require 'ad_manager_api/v202405/content_service_registry'

module AdManagerApi; module V202405; module ContentService
  class ContentService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202405::ContentService
    end
  end
end; end; end
