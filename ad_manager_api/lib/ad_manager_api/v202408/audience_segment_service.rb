...
require 'ad_manager_api/v202408/audience_segment_service_registry'

module AdManagerApi; module V202408; module AudienceSegmentService
  class AudienceSegmentService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202408::AudienceSegmentService
    end
  end
end; end; end
