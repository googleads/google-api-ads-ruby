...
require 'ad_manager_api/v202408/content_service_registry'

module AdManagerApi; module V202408; module ContentService
  class ContentService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202408::ContentService
    end
  end
end; end; end
