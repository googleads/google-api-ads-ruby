...
require 'ad_manager_api/v202205/placement_service_registry'

module AdManagerApi; module V202205; module PlacementService
  class PlacementService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202205::PlacementService
    end
  end
end; end; end
