...
require 'ad_manager_api/v202205/activity_service_registry'

module AdManagerApi; module V202205; module ActivityService
  class ActivityService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202205::ActivityService
    end
  end
end; end; end
