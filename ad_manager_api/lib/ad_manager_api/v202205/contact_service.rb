...
require 'ad_manager_api/v202205/contact_service_registry'

module AdManagerApi; module V202205; module ContactService
  class ContactService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202205::ContactService
    end
  end
end; end; end
