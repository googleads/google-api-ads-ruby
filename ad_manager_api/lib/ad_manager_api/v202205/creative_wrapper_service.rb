...
require 'ad_manager_api/v202205/creative_wrapper_service_registry'

module AdManagerApi; module V202205; module CreativeWrapperService
  class CreativeWrapperService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202205::CreativeWrapperService
    end
  end
end; end; end
