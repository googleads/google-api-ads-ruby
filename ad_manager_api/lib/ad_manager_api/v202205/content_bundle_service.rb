...
require 'ad_manager_api/v202205/content_bundle_service_registry'

module AdManagerApi; module V202205; module ContentBundleService
  class ContentBundleService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202205::ContentBundleService
    end
  end
end; end; end
