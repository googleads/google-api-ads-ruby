...
require 'ad_manager_api/v202205/creative_set_service_registry'

module AdManagerApi; module V202205; module CreativeSetService
  class CreativeSetService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202205::CreativeSetService
    end
  end
end; end; end
