...
require 'ad_manager_api/v202108/native_style_service_registry'

module AdManagerApi; module V202108; module NativeStyleService
  class NativeStyleService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202108::NativeStyleService
    end
  end
end; end; end
