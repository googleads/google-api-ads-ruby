...
require 'ad_manager_api/v202108/custom_targeting_service_registry'

module AdManagerApi; module V202108; module CustomTargetingService
  class CustomTargetingService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202108::CustomTargetingService
    end
  end
end; end; end
