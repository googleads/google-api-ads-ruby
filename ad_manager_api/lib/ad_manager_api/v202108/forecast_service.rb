...
require 'ad_manager_api/v202108/forecast_service_registry'

module AdManagerApi; module V202108; module ForecastService
  class ForecastService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202108::ForecastService
    end
  end
end; end; end
