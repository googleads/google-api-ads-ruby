...
require 'ad_manager_api/v202108/audience_segment_service_registry'

module AdManagerApi; module V202108; module AudienceSegmentService
  class AudienceSegmentService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202108::AudienceSegmentService
    end
  end
end; end; end
