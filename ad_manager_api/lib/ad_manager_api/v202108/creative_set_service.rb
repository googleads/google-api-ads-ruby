...
require 'ad_manager_api/v202108/creative_set_service_registry'

module AdManagerApi; module V202108; module CreativeSetService
  class CreativeSetService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202108::CreativeSetService
    end
  end
end; end; end
