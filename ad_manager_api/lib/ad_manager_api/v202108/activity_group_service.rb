...
require 'ad_manager_api/v202108/activity_group_service_registry'

module AdManagerApi; module V202108; module ActivityGroupService
  class ActivityGroupService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202108::ActivityGroupService
    end
  end
end; end; end
