...
require 'ad_manager_api/v202108/content_bundle_service_registry'

module AdManagerApi; module V202108; module ContentBundleService
  class ContentBundleService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202108::ContentBundleService
    end
  end
end; end; end
