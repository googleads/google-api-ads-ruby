...
require 'ad_manager_api/v202108/placement_service_registry'

module AdManagerApi; module V202108; module PlacementService
  class PlacementService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202108::PlacementService
    end
  end
end; end; end
