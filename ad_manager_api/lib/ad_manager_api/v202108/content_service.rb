...
require 'ad_manager_api/v202108/content_service_registry'

module AdManagerApi; module V202108; module ContentService
  class ContentService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202108::ContentService
    end
  end
end; end; end
