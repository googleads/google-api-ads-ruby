...
require 'ad_manager_api/v202108/activity_service_registry'

module AdManagerApi; module V202108; module ActivityService
  class ActivityService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202108::ActivityService
    end
  end
end; end; end
