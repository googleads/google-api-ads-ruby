...
require 'ad_manager_api/v202108/cdn_configuration_service_registry'

module AdManagerApi; module V202108; module CdnConfigurationService
  class CdnConfigurationService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202108::CdnConfigurationService
    end
  end
end; end; end
