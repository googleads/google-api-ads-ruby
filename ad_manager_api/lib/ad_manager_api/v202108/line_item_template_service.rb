...
require 'ad_manager_api/v202108/line_item_template_service_registry'

module AdManagerApi; module V202108; module LineItemTemplateService
  class LineItemTemplateService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202108::LineItemTemplateService
    end
  end
end; end; end
