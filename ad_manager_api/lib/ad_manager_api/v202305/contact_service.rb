...
require 'ad_manager_api/v202305/contact_service_registry'

module AdManagerApi; module V202305; module ContactService
  class ContactService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202305::ContactService
    end
  end
end; end; end
