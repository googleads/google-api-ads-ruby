...
require 'ad_manager_api/v202305/creative_service_registry'

module AdManagerApi; module V202305; module CreativeService
  class CreativeService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202305::CreativeService
    end
  end
end; end; end
