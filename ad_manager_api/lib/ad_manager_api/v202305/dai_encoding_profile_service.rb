...
require 'ad_manager_api/v202305/dai_encoding_profile_service_registry'

module AdManagerApi; module V202305; module DaiEncodingProfileService
  class DaiEncodingProfileService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202305::DaiEncodingProfileService
    end
  end
end; end; end
