...
require 'ad_manager_api/v202305/placement_service_registry'

module AdManagerApi; module V202305; module PlacementService
  class PlacementService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202305::PlacementService
    end
  end
end; end; end
