...
require 'ad_manager_api/v202305/targeting_preset_service_registry'

module AdManagerApi; module V202305; module TargetingPresetService
  class TargetingPresetService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202305::TargetingPresetService
    end
  end
end; end; end
