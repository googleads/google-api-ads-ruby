...
require 'ad_manager_api/v202305/suggested_ad_unit_service_registry'

module AdManagerApi; module V202305; module SuggestedAdUnitService
  class SuggestedAdUnitService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202305::SuggestedAdUnitService
    end
  end
end; end; end
