...
require 'ad_manager_api/v202305/creative_wrapper_service_registry'

module AdManagerApi; module V202305; module CreativeWrapperService
  class CreativeWrapperService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202305::CreativeWrapperService
    end
  end
end; end; end
