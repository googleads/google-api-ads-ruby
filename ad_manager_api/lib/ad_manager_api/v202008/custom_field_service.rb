...
require 'ad_manager_api/v202008/custom_field_service_registry'

module AdManagerApi; module V202008; module CustomFieldService
  class CustomFieldService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202008::CustomFieldService
    end
  end
end; end; end
