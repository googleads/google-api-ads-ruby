...
require 'ad_manager_api/v202008/dai_encoding_profile_service_registry'

module AdManagerApi; module V202008; module DaiEncodingProfileService
  class DaiEncodingProfileService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202008::DaiEncodingProfileService
    end
  end
end; end; end
