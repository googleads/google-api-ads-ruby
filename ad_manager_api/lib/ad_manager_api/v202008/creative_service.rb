...
require 'ad_manager_api/v202008/creative_service_registry'

module AdManagerApi; module V202008; module CreativeService
  class CreativeService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202008::CreativeService
    end
  end
end; end; end
