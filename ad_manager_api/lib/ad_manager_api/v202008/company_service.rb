...
require 'ad_manager_api/v202008/company_service_registry'

module AdManagerApi; module V202008; module CompanyService
  class CompanyService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202008::CompanyService
    end
  end
end; end; end
