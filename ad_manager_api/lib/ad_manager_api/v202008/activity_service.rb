...
require 'ad_manager_api/v202008/activity_service_registry'

module AdManagerApi; module V202008; module ActivityService
  class ActivityService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202008::ActivityService
    end
  end
end; end; end
