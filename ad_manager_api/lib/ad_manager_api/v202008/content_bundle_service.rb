...
require 'ad_manager_api/v202008/content_bundle_service_registry'

module AdManagerApi; module V202008; module ContentBundleService
  class ContentBundleService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202008::ContentBundleService
    end
  end
end; end; end
