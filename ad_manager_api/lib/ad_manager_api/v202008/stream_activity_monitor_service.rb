...
require 'ad_manager_api/v202008/stream_activity_monitor_service_registry'

module AdManagerApi; module V202008; module StreamActivityMonitorService
  class StreamActivityMonitorService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202008::StreamActivityMonitorService
    end
  end
end; end; end
