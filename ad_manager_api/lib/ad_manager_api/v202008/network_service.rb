...
require 'ad_manager_api/v202008/network_service_registry'

module AdManagerApi; module V202008; module NetworkService
  class NetworkService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202008::NetworkService
    end
  end
end; end; end
