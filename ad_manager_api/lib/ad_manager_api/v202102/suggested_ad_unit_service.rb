...
require 'ad_manager_api/v202102/suggested_ad_unit_service_registry'

module AdManagerApi; module V202102; module SuggestedAdUnitService
  class SuggestedAdUnitService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202102::SuggestedAdUnitService
    end
  end
end; end; end
