...
require 'ad_manager_api/v202102/company_service_registry'

module AdManagerApi; module V202102; module CompanyService
  class CompanyService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202102::CompanyService
    end
  end
end; end; end
