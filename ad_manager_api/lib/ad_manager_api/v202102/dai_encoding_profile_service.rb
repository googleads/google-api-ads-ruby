...
require 'ad_manager_api/v202102/dai_encoding_profile_service_registry'

module AdManagerApi; module V202102; module DaiEncodingProfileService
  class DaiEncodingProfileService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202102::DaiEncodingProfileService
    end
  end
end; end; end
