...
require 'ad_manager_api/v202102/contact_service_registry'

module AdManagerApi; module V202102; module ContactService
  class ContactService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202102::ContactService
    end
  end
end; end; end
