...
require 'ad_manager_api/v202102/targeting_preset_service_registry'

module AdManagerApi; module V202102; module TargetingPresetService
  class TargetingPresetService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202102::TargetingPresetService
    end
  end
end; end; end
