...
require 'ad_manager_api/v202102/content_bundle_service_registry'

module AdManagerApi; module V202102; module ContentBundleService
  class ContentBundleService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202102::ContentBundleService
    end
  end
end; end; end
