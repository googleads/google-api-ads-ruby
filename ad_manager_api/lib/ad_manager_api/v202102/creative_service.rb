...
require 'ad_manager_api/v202102/creative_service_registry'

module AdManagerApi; module V202102; module CreativeService
  class CreativeService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202102::CreativeService
    end
  end
end; end; end
