...
require 'ad_manager_api/v202102/creative_template_service_registry'

module AdManagerApi; module V202102; module CreativeTemplateService
  class CreativeTemplateService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202102::CreativeTemplateService
    end
  end
end; end; end
