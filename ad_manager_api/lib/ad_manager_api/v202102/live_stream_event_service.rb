...
require 'ad_manager_api/v202102/live_stream_event_service_registry'

module AdManagerApi; module V202102; module LiveStreamEventService
  class LiveStreamEventService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202102::LiveStreamEventService
    end
  end
end; end; end
