...
require 'ad_manager_api/v202102/custom_targeting_service_registry'

module AdManagerApi; module V202102; module CustomTargetingService
  class CustomTargetingService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202102::CustomTargetingService
    end
  end
end; end; end
