...
require 'ad_manager_api/v202102/placement_service_registry'

module AdManagerApi; module V202102; module PlacementService
  class PlacementService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202102::PlacementService
    end
  end
end; end; end
