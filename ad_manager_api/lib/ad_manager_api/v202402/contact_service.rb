...
require 'ad_manager_api/v202402/contact_service_registry'

module AdManagerApi; module V202402; module ContactService
  class ContactService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202402::ContactService
    end
  end
end; end; end
