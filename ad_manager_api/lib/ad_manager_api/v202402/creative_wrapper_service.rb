...
require 'ad_manager_api/v202402/creative_wrapper_service_registry'

module AdManagerApi; module V202402; module CreativeWrapperService
  class CreativeWrapperService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202402::CreativeWrapperService
    end
  end
end; end; end
