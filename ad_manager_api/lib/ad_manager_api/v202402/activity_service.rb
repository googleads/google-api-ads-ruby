...
require 'ad_manager_api/v202402/activity_service_registry'

module AdManagerApi; module V202402; module ActivityService
  class ActivityService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202402::ActivityService
    end
  end
end; end; end
