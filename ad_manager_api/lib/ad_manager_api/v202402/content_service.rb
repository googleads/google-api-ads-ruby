...
require 'ad_manager_api/v202402/content_service_registry'

module AdManagerApi; module V202402; module ContentService
  class ContentService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202402::ContentService
    end
  end
end; end; end
