...
require 'ad_manager_api/v202402/custom_field_service_registry'

module AdManagerApi; module V202402; module CustomFieldService
  class CustomFieldService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202402::CustomFieldService
    end
  end
end; end; end
