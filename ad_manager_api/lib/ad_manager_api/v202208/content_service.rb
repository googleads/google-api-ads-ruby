...
require 'ad_manager_api/v202208/content_service_registry'

module AdManagerApi; module V202208; module ContentService
  class ContentService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202208::ContentService
    end
  end
end; end; end
