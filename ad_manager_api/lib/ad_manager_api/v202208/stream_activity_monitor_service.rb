...
require 'ad_manager_api/v202208/stream_activity_monitor_service_registry'

module AdManagerApi; module V202208; module StreamActivityMonitorService
  class StreamActivityMonitorService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202208::StreamActivityMonitorService
    end
  end
end; end; end
