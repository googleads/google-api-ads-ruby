...
require 'ad_manager_api/v201711/forecast_service_registry'

module AdManagerApi; module V201711; module ForecastService
  class ForecastService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201711::ForecastService
    end
  end
end; end; end
