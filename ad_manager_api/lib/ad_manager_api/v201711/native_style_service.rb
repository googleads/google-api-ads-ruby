...
require 'ad_manager_api/v201711/native_style_service_registry'

module AdManagerApi; module V201711; module NativeStyleService
  class NativeStyleService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201711::NativeStyleService
    end
  end
end; end; end
