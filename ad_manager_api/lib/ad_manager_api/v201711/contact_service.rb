...
require 'ad_manager_api/v201711/contact_service_registry'

module AdManagerApi; module V201711; module ContactService
  class ContactService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201711::ContactService
    end
  end
end; end; end
