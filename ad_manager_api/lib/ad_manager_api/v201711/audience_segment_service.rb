...
require 'ad_manager_api/v201711/audience_segment_service_registry'

module AdManagerApi; module V201711; module AudienceSegmentService
  class AudienceSegmentService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201711::AudienceSegmentService
    end
  end
end; end; end
