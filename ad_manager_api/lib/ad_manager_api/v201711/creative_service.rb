...
require 'ad_manager_api/v201711/creative_service_registry'

module AdManagerApi; module V201711; module CreativeService
  class CreativeService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201711::CreativeService
    end
  end
end; end; end
