...
require 'ad_manager_api/v201711/rate_card_service_registry'

module AdManagerApi; module V201711; module RateCardService
  class RateCardService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201711::RateCardService
    end
  end
end; end; end
