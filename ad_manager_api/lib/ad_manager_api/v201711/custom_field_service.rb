...
require 'ad_manager_api/v201711/custom_field_service_registry'

module AdManagerApi; module V201711; module CustomFieldService
  class CustomFieldService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201711::CustomFieldService
    end
  end
end; end; end
