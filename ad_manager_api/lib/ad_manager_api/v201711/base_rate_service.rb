...
require 'ad_manager_api/v201711/base_rate_service_registry'

module AdManagerApi; module V201711; module BaseRateService
  class BaseRateService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201711::BaseRateService
    end
  end
end; end; end
