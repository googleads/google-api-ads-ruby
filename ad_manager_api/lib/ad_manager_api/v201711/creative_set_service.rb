...
require 'ad_manager_api/v201711/creative_set_service_registry'

module AdManagerApi; module V201711; module CreativeSetService
  class CreativeSetService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201711::CreativeSetService
    end
  end
end; end; end
