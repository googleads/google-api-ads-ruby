...
require 'ad_manager_api/v201711/custom_targeting_service_registry'

module AdManagerApi; module V201711; module CustomTargetingService
  class CustomTargetingService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201711::CustomTargetingService
    end
  end
end; end; end
