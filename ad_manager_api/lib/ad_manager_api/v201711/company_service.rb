...
require 'ad_manager_api/v201711/company_service_registry'

module AdManagerApi; module V201711; module CompanyService
  class CompanyService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201711::CompanyService
    end
  end
end; end; end
