...
require 'ad_manager_api/v201711/reconciliation_report_row_service_registry'

module AdManagerApi; module V201711; module ReconciliationReportRowService
  class ReconciliationReportRowService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201711::ReconciliationReportRowService
    end
  end
end; end; end
