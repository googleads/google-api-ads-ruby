...
require 'ad_manager_api/v201711/creative_wrapper_service_registry'

module AdManagerApi; module V201711; module CreativeWrapperService
  class CreativeWrapperService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201711::CreativeWrapperService
    end
  end
end; end; end
