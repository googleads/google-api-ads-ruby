...
require 'ad_manager_api/v201711/ad_exclusion_rule_service_registry'

module AdManagerApi; module V201711; module AdExclusionRuleService
  class AdExclusionRuleService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201711::AdExclusionRuleService
    end
  end
end; end; end
