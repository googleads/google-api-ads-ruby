...
require 'ad_manager_api/v201711/product_package_service_registry'

module AdManagerApi; module V201711; module ProductPackageService
  class ProductPackageService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201711::ProductPackageService
    end
  end
end; end; end
