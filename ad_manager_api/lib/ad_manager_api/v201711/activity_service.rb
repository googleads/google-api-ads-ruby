...
require 'ad_manager_api/v201711/activity_service_registry'

module AdManagerApi; module V201711; module ActivityService
  class ActivityService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201711::ActivityService
    end
  end
end; end; end
