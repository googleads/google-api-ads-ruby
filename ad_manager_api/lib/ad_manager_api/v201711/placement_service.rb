...
require 'ad_manager_api/v201711/placement_service_registry'

module AdManagerApi; module V201711; module PlacementService
  class PlacementService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201711::PlacementService
    end
  end
end; end; end
