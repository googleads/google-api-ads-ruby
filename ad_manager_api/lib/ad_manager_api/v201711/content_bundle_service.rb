...
require 'ad_manager_api/v201711/content_bundle_service_registry'

module AdManagerApi; module V201711; module ContentBundleService
  class ContentBundleService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201711::ContentBundleService
    end
  end
end; end; end
