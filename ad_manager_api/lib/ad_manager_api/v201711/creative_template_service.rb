...
require 'ad_manager_api/v201711/creative_template_service_registry'

module AdManagerApi; module V201711; module CreativeTemplateService
  class CreativeTemplateService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201711::CreativeTemplateService
    end
  end
end; end; end
