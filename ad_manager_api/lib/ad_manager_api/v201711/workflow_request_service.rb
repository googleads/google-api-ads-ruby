...
require 'ad_manager_api/v201711/workflow_request_service_registry'

module AdManagerApi; module V201711; module WorkflowRequestService
  class WorkflowRequestService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201711::WorkflowRequestService
    end
  end
end; end; end
