...
require 'ad_manager_api/v202202/activity_service_registry'

module AdManagerApi; module V202202; module ActivityService
  class ActivityService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202202::ActivityService
    end
  end
end; end; end
