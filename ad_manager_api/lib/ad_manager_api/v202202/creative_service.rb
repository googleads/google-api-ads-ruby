...
require 'ad_manager_api/v202202/creative_service_registry'

module AdManagerApi; module V202202; module CreativeService
  class CreativeService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202202::CreativeService
    end
  end
end; end; end
