...
require 'ad_manager_api/v202202/custom_targeting_service_registry'

module AdManagerApi; module V202202; module CustomTargetingService
  class CustomTargetingService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202202::CustomTargetingService
    end
  end
end; end; end
