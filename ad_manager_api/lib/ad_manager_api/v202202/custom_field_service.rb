...
require 'ad_manager_api/v202202/custom_field_service_registry'

module AdManagerApi; module V202202; module CustomFieldService
  class CustomFieldService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202202::CustomFieldService
    end
  end
end; end; end
