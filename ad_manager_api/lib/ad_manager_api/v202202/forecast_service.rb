...
require 'ad_manager_api/v202202/forecast_service_registry'

module AdManagerApi; module V202202; module ForecastService
  class ForecastService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202202::ForecastService
    end
  end
end; end; end
