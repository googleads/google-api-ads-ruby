...
require 'ad_manager_api/v202202/content_service_registry'

module AdManagerApi; module V202202; module ContentService
  class ContentService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202202::ContentService
    end
  end
end; end; end
