...
require 'ad_manager_api/v202202/cdn_configuration_service_registry'

module AdManagerApi; module V202202; module CdnConfigurationService
  class CdnConfigurationService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202202::CdnConfigurationService
    end
  end
end; end; end
