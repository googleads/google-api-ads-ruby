...
require 'ad_manager_api/v201908/creative_wrapper_service_registry'

module AdManagerApi; module V201908; module CreativeWrapperService
  class CreativeWrapperService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201908::CreativeWrapperService
    end
  end
end; end; end
