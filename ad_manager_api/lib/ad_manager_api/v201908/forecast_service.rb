...
require 'ad_manager_api/v201908/forecast_service_registry'

module AdManagerApi; module V201908; module ForecastService
  class ForecastService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201908::ForecastService
    end
  end
end; end; end
