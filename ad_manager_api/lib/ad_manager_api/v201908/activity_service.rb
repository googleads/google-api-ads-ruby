...
require 'ad_manager_api/v201908/activity_service_registry'

module AdManagerApi; module V201908; module ActivityService
  class ActivityService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201908::ActivityService
    end
  end
end; end; end
