...
require 'ad_manager_api/v201908/content_service_registry'

module AdManagerApi; module V201908; module ContentService
  class ContentService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201908::ContentService
    end
  end
end; end; end
