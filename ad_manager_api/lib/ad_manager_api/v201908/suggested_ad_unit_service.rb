...
require 'ad_manager_api/v201908/suggested_ad_unit_service_registry'

module AdManagerApi; module V201908; module SuggestedAdUnitService
  class SuggestedAdUnitService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201908::SuggestedAdUnitService
    end
  end
end; end; end
