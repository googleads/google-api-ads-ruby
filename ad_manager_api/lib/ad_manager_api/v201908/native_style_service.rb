...
require 'ad_manager_api/v201908/native_style_service_registry'

module AdManagerApi; module V201908; module NativeStyleService
  class NativeStyleService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201908::NativeStyleService
    end
  end
end; end; end
