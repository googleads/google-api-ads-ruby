...
require 'ad_manager_api/v201908/placement_service_registry'

module AdManagerApi; module V201908; module PlacementService
  class PlacementService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201908::PlacementService
    end
  end
end; end; end
