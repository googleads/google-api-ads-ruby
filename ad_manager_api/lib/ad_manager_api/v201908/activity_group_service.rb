...
require 'ad_manager_api/v201908/activity_group_service_registry'

module AdManagerApi; module V201908; module ActivityGroupService
  class ActivityGroupService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201908::ActivityGroupService
    end
  end
end; end; end
