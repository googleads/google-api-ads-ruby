...
require 'ad_manager_api/v201908/contact_service_registry'

module AdManagerApi; module V201908; module ContactService
  class ContactService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201908::ContactService
    end
  end
end; end; end
