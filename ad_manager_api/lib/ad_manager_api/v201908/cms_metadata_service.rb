...
require 'ad_manager_api/v201908/cms_metadata_service_registry'

module AdManagerApi; module V201908; module CmsMetadataService
  class CmsMetadataService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201908::CmsMetadataService
    end
  end
end; end; end
