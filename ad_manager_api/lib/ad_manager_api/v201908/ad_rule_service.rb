...
require 'ad_manager_api/v201908/ad_rule_service_registry'

module AdManagerApi; module V201908; module AdRuleService
  class AdRuleService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201908::AdRuleService
    end
  end
end; end; end
