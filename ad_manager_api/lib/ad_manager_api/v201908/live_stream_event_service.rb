...
require 'ad_manager_api/v201908/live_stream_event_service_registry'

module AdManagerApi; module V201908; module LiveStreamEventService
  class LiveStreamEventService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201908::LiveStreamEventService
    end
  end
end; end; end
