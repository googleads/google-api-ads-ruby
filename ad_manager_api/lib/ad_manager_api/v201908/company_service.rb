...
require 'ad_manager_api/v201908/company_service_registry'

module AdManagerApi; module V201908; module CompanyService
  class CompanyService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201908::CompanyService
    end
  end
end; end; end
