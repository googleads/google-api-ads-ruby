...
require 'ad_manager_api/v201908/creative_template_service_registry'

module AdManagerApi; module V201908; module CreativeTemplateService
  class CreativeTemplateService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201908::CreativeTemplateService
    end
  end
end; end; end
