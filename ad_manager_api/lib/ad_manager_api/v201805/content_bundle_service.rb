...
require 'ad_manager_api/v201805/content_bundle_service_registry'

module AdManagerApi; module V201805; module ContentBundleService
  class ContentBundleService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201805::ContentBundleService
    end
  end
end; end; end
