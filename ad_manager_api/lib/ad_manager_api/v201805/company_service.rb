...
require 'ad_manager_api/v201805/company_service_registry'

module AdManagerApi; module V201805; module CompanyService
  class CompanyService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201805::CompanyService
    end
  end
end; end; end
