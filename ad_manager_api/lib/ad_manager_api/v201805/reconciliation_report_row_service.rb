...
require 'ad_manager_api/v201805/reconciliation_report_row_service_registry'

module AdManagerApi; module V201805; module ReconciliationReportRowService
  class ReconciliationReportRowService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201805::ReconciliationReportRowService
    end
  end
end; end; end
