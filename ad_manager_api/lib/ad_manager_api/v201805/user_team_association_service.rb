...
require 'ad_manager_api/v201805/user_team_association_service_registry'

module AdManagerApi; module V201805; module UserTeamAssociationService
  class UserTeamAssociationService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201805::UserTeamAssociationService
    end
  end
end; end; end
