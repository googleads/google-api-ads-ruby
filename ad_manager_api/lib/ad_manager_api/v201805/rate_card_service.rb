...
require 'ad_manager_api/v201805/rate_card_service_registry'

module AdManagerApi; module V201805; module RateCardService
  class RateCardService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201805::RateCardService
    end
  end
end; end; end
