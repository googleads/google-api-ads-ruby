...
require 'ad_manager_api/v201805/product_package_item_service_registry'

module AdManagerApi; module V201805; module ProductPackageItemService
  class ProductPackageItemService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201805::ProductPackageItemService
    end
  end
end; end; end
