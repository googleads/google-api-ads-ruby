...
require 'ad_manager_api/v201805/ad_rule_service_registry'

module AdManagerApi; module V201805; module AdRuleService
  class AdRuleService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201805::AdRuleService
    end
  end
end; end; end
