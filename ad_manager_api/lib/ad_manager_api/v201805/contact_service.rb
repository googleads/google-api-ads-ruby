...
require 'ad_manager_api/v201805/contact_service_registry'

module AdManagerApi; module V201805; module ContactService
  class ContactService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201805::ContactService
    end
  end
end; end; end
