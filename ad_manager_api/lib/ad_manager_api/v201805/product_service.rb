...
require 'ad_manager_api/v201805/product_service_registry'

module AdManagerApi; module V201805; module ProductService
  class ProductService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201805::ProductService
    end
  end
end; end; end
