...
require 'ad_manager_api/v201805/custom_field_service_registry'

module AdManagerApi; module V201805; module CustomFieldService
  class CustomFieldService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201805::CustomFieldService
    end
  end
end; end; end
