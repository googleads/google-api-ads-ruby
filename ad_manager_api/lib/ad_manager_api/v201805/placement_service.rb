...
require 'ad_manager_api/v201805/placement_service_registry'

module AdManagerApi; module V201805; module PlacementService
  class PlacementService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201805::PlacementService
    end
  end
end; end; end
