...
require 'ad_manager_api/v201805/native_style_service_registry'

module AdManagerApi; module V201805; module NativeStyleService
  class NativeStyleService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201805::NativeStyleService
    end
  end
end; end; end
