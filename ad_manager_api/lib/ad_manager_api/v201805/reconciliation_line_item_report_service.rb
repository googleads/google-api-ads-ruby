...
require 'ad_manager_api/v201805/reconciliation_line_item_report_service_registry'

module AdManagerApi; module V201805; module ReconciliationLineItemReportService
  class ReconciliationLineItemReportService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201805::ReconciliationLineItemReportService
    end
  end
end; end; end
