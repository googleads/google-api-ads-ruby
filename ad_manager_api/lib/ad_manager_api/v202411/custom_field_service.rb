...
require 'ad_manager_api/v202411/custom_field_service_registry'

module AdManagerApi; module V202411; module CustomFieldService
  class CustomFieldService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202411::CustomFieldService
    end
  end
end; end; end
