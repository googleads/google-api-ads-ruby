...
require 'ad_manager_api/v202411/stream_activity_monitor_service_registry'

module AdManagerApi; module V202411; module StreamActivityMonitorService
  class StreamActivityMonitorService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202411::StreamActivityMonitorService
    end
  end
end; end; end
