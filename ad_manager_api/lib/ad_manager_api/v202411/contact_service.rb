...
require 'ad_manager_api/v202411/contact_service_registry'

module AdManagerApi; module V202411; module ContactService
  class ContactService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202411::ContactService
    end
  end
end; end; end
