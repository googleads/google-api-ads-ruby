...
require 'ad_manager_api/v202411/cdn_configuration_service_registry'

module AdManagerApi; module V202411; module CdnConfigurationService
  class CdnConfigurationService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202411::CdnConfigurationService
    end
  end
end; end; end
