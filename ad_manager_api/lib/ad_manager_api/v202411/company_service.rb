...
require 'ad_manager_api/v202411/company_service_registry'

module AdManagerApi; module V202411; module CompanyService
  class CompanyService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202411::CompanyService
    end
  end
end; end; end
