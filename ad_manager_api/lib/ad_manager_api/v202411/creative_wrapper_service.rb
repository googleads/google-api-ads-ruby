...
require 'ad_manager_api/v202411/creative_wrapper_service_registry'

module AdManagerApi; module V202411; module CreativeWrapperService
  class CreativeWrapperService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202411::CreativeWrapperService
    end
  end
end; end; end
