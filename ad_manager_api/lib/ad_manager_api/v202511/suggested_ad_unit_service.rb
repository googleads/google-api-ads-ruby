...
require 'ad_manager_api/v202511/suggested_ad_unit_service_registry'

module AdManagerApi; module V202511; module SuggestedAdUnitService
  class SuggestedAdUnitService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202511::SuggestedAdUnitService
    end
  end
end; end; end
