...
require 'ad_manager_api/v202511/company_service_registry'

module AdManagerApi; module V202511; module CompanyService
  class CompanyService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202511::CompanyService
    end
  end
end; end; end
