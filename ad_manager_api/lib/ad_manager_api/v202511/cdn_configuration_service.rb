...
require 'ad_manager_api/v202511/cdn_configuration_service_registry'

module AdManagerApi; module V202511; module CdnConfigurationService
  class CdnConfigurationService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202511::CdnConfigurationService
    end
  end
end; end; end
