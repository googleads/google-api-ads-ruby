...
require 'ad_manager_api/v202511/placement_service_registry'

module AdManagerApi; module V202511; module PlacementService
  class PlacementService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202511::PlacementService
    end
  end
end; end; end
