...
require 'ad_manager_api/v202511/creative_wrapper_service_registry'

module AdManagerApi; module V202511; module CreativeWrapperService
  class CreativeWrapperService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202511::CreativeWrapperService
    end
  end
end; end; end
