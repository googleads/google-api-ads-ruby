...
require 'ad_manager_api/v202511/custom_field_service_registry'

module AdManagerApi; module V202511; module CustomFieldService
  class CustomFieldService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202511::CustomFieldService
    end
  end
end; end; end
