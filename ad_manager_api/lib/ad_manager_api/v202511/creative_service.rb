...
require 'ad_manager_api/v202511/creative_service_registry'

module AdManagerApi; module V202511; module CreativeService
  class CreativeService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202511::CreativeService
    end
  end
end; end; end
