...
require 'ad_manager_api/v202511/dai_encoding_profile_service_registry'

module AdManagerApi; module V202511; module DaiEncodingProfileService
  class DaiEncodingProfileService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202511::DaiEncodingProfileService
    end
  end
end; end; end
