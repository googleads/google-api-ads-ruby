...
require 'ad_manager_api/v202511/yield_group_service_registry'

module AdManagerApi; module V202511; module YieldGroupService
  class YieldGroupService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202511::YieldGroupService
    end
  end
end; end; end
