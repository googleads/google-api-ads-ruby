...
require 'ad_manager_api/v202511/segment_population_service_registry'

module AdManagerApi; module V202511; module SegmentPopulationService
  class SegmentPopulationService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202511::SegmentPopulationService
    end
  end
end; end; end
