...
require 'ad_manager_api/v202511/native_style_service_registry'

module AdManagerApi; module V202511; module NativeStyleService
  class NativeStyleService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202511::NativeStyleService
    end
  end
end; end; end
