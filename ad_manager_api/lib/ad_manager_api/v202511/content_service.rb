...
require 'ad_manager_api/v202511/content_service_registry'

module AdManagerApi; module V202511; module ContentService
  class ContentService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202511::ContentService
    end
  end
end; end; end
