...
require 'ad_manager_api/v202511/contact_service_registry'

module AdManagerApi; module V202511; module ContactService
  class ContactService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202511::ContactService
    end
  end
end; end; end
