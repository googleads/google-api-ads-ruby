...
require 'ad_manager_api/v202502/contact_service_registry'

module AdManagerApi; module V202502; module ContactService
  class ContactService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202502::ContactService
    end
  end
end; end; end
