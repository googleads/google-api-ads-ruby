...
require 'ad_manager_api/v202502/forecast_service_registry'

module AdManagerApi; module V202502; module ForecastService
  class ForecastService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202502::ForecastService
    end
  end
end; end; end
