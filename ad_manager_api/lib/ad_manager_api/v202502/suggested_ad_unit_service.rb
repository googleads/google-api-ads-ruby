...
require 'ad_manager_api/v202502/suggested_ad_unit_service_registry'

module AdManagerApi; module V202502; module SuggestedAdUnitService
  class SuggestedAdUnitService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202502::SuggestedAdUnitService
    end
  end
end; end; end
