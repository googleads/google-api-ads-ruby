...
require 'ad_manager_api/v202502/live_stream_event_service_registry'

module AdManagerApi; module V202502; module LiveStreamEventService
  class LiveStreamEventService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202502::LiveStreamEventService
    end
  end
end; end; end
