...
require 'ad_manager_api/v202502/custom_field_service_registry'

module AdManagerApi; module V202502; module CustomFieldService
  class CustomFieldService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202502::CustomFieldService
    end
  end
end; end; end
