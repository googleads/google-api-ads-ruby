...
require 'ad_manager_api/v202505/report_service_registry'

module AdManagerApi; module V202505; module ReportService
  class ReportService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202505::ReportService
    end
  end
end; end; end
