...
require 'ad_manager_api/v202505/segment_population_service_registry'

module AdManagerApi; module V202505; module SegmentPopulationService
  class SegmentPopulationService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202505::SegmentPopulationService
    end
  end
end; end; end
