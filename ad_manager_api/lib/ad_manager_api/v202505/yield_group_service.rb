...
require 'ad_manager_api/v202505/yield_group_service_registry'

module AdManagerApi; module V202505; module YieldGroupService
  class YieldGroupService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202505::YieldGroupService
    end
  end
end; end; end
