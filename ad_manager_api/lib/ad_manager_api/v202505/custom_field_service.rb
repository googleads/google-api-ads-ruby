...
require 'ad_manager_api/v202505/custom_field_service_registry'

module AdManagerApi; module V202505; module CustomFieldService
  class CustomFieldService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202505::CustomFieldService
    end
  end
end; end; end
