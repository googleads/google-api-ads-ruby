...
require 'ad_manager_api/v202505/contact_service_registry'

module AdManagerApi; module V202505; module ContactService
  class ContactService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202505::ContactService
    end
  end
end; end; end
