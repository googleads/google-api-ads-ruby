...
module AdManagerApi; module V202505; module AdsTxtService
  ...
  class ApiException < ApplicationException
    ...
    def initialize(exception_fault)
      @array_fields ||= []
      @array_fields << 'errors'
      super(exception_fault, AdsTxtServiceRegistry)
    end
  end
end; end; end
