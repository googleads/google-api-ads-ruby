...
require 'ad_manager_api/v202505/company_service_registry'

module AdManagerApi; module V202505; module CompanyService
  class CompanyService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202505::CompanyService
    end
  end
end; end; end
