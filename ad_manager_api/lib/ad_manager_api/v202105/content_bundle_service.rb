...
require 'ad_manager_api/v202105/content_bundle_service_registry'

module AdManagerApi; module V202105; module ContentBundleService
  class ContentBundleService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202105::ContentBundleService
    end
  end
end; end; end
