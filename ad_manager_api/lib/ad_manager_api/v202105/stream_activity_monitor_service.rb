...
require 'ad_manager_api/v202105/stream_activity_monitor_service_registry'

module AdManagerApi; module V202105; module StreamActivityMonitorService
  class StreamActivityMonitorService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202105::StreamActivityMonitorService
    end
  end
end; end; end
