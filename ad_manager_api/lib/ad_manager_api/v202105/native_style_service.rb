...
require 'ad_manager_api/v202105/native_style_service_registry'

module AdManagerApi; module V202105; module NativeStyleService
  class NativeStyleService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202105::NativeStyleService
    end
  end
end; end; end
