...
require 'ad_manager_api/v202105/placement_service_registry'

module AdManagerApi; module V202105; module PlacementService
  class PlacementService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202105::PlacementService
    end
  end
end; end; end
