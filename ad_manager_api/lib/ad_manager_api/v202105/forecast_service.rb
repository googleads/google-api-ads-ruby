...
require 'ad_manager_api/v202105/forecast_service_registry'

module AdManagerApi; module V202105; module ForecastService
  class ForecastService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202105::ForecastService
    end
  end
end; end; end
