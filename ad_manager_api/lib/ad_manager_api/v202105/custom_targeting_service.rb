...
require 'ad_manager_api/v202105/custom_targeting_service_registry'

module AdManagerApi; module V202105; module CustomTargetingService
  class CustomTargetingService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202105::CustomTargetingService
    end
  end
end; end; end
