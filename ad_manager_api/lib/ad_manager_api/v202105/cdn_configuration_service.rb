...
require 'ad_manager_api/v202105/cdn_configuration_service_registry'

module AdManagerApi; module V202105; module CdnConfigurationService
  class CdnConfigurationService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202105::CdnConfigurationService
    end
  end
end; end; end
