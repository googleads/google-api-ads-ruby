...
require 'ad_manager_api/v202105/contact_service_registry'

module AdManagerApi; module V202105; module ContactService
  class ContactService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202105::ContactService
    end
  end
end; end; end
