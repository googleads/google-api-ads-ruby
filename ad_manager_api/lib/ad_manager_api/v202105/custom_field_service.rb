...
require 'ad_manager_api/v202105/custom_field_service_registry'

module AdManagerApi; module V202105; module CustomFieldService
  class CustomFieldService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202105::CustomFieldService
    end
  end
end; end; end
