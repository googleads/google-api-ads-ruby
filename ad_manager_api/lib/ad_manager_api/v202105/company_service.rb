...
require 'ad_manager_api/v202105/company_service_registry'

module AdManagerApi; module V202105; module CompanyService
  class CompanyService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202105::CompanyService
    end
  end
end; end; end
