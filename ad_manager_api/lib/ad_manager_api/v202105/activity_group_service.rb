...
require 'ad_manager_api/v202105/activity_group_service_registry'

module AdManagerApi; module V202105; module ActivityGroupService
  class ActivityGroupService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202105::ActivityGroupService
    end
  end
end; end; end
