...
require 'ad_manager_api/v202105/suggested_ad_unit_service_registry'

module AdManagerApi; module V202105; module SuggestedAdUnitService
  class SuggestedAdUnitService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202105::SuggestedAdUnitService
    end
  end
end; end; end
