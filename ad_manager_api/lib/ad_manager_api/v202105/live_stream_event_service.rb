...
require 'ad_manager_api/v202105/live_stream_event_service_registry'

module AdManagerApi; module V202105; module LiveStreamEventService
  class LiveStreamEventService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202105::LiveStreamEventService
    end
  end
end; end; end
