...
require 'ad_manager_api/v202105/creative_set_service_registry'

module AdManagerApi; module V202105; module CreativeSetService
  class CreativeSetService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202105::CreativeSetService
    end
  end
end; end; end
