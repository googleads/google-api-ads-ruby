...
require 'ad_manager_api/v202105/content_service_registry'

module AdManagerApi; module V202105; module ContentService
  class ContentService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202105::ContentService
    end
  end
end; end; end
