...
require 'ad_manager_api/v202211/content_bundle_service_registry'

module AdManagerApi; module V202211; module ContentBundleService
  class ContentBundleService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202211::ContentBundleService
    end
  end
end; end; end
