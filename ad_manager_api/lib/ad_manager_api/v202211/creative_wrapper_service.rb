...
require 'ad_manager_api/v202211/creative_wrapper_service_registry'

module AdManagerApi; module V202211; module CreativeWrapperService
  class CreativeWrapperService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202211::CreativeWrapperService
    end
  end
end; end; end
