...
require 'ad_manager_api/v202211/creative_service_registry'

module AdManagerApi; module V202211; module CreativeService
  class CreativeService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202211::CreativeService
    end
  end
end; end; end
