...
require 'ad_manager_api/v202211/content_service_registry'

module AdManagerApi; module V202211; module ContentService
  class ContentService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202211::ContentService
    end
  end
end; end; end
