...
require 'ad_manager_api/v201808/creative_wrapper_service_registry'

module AdManagerApi; module V201808; module CreativeWrapperService
  class CreativeWrapperService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201808::CreativeWrapperService
    end
  end
end; end; end
