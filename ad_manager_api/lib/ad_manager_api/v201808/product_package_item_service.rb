...
require 'ad_manager_api/v201808/product_package_item_service_registry'

module AdManagerApi; module V201808; module ProductPackageItemService
  class ProductPackageItemService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201808::ProductPackageItemService
    end
  end
end; end; end
