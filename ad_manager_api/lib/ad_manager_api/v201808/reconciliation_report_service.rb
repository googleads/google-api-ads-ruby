...
require 'ad_manager_api/v201808/reconciliation_report_service_registry'

module AdManagerApi; module V201808; module ReconciliationReportService
  class ReconciliationReportService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201808::ReconciliationReportService
    end
  end
end; end; end
