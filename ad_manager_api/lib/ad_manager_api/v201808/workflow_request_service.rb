...
require 'ad_manager_api/v201808/workflow_request_service_registry'

module AdManagerApi; module V201808; module WorkflowRequestService
  class WorkflowRequestService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201808::WorkflowRequestService
    end
  end
end; end; end
