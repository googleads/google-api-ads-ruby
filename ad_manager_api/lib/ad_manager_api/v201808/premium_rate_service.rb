...
require 'ad_manager_api/v201808/premium_rate_service_registry'

module AdManagerApi; module V201808; module PremiumRateService
  class PremiumRateService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201808::PremiumRateService
    end
  end
end; end; end
