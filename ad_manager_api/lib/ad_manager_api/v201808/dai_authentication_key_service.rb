...
require 'ad_manager_api/v201808/dai_authentication_key_service_registry'

module AdManagerApi; module V201808; module DaiAuthenticationKeyService
  class DaiAuthenticationKeyService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201808::DaiAuthenticationKeyService
    end
  end
end; end; end
