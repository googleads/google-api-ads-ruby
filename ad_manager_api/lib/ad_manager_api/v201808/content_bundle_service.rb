...
require 'ad_manager_api/v201808/content_bundle_service_registry'

module AdManagerApi; module V201808; module ContentBundleService
  class ContentBundleService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201808::ContentBundleService
    end
  end
end; end; end
