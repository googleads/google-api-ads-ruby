...
require 'ad_manager_api/v201808/native_style_service_registry'

module AdManagerApi; module V201808; module NativeStyleService
  class NativeStyleService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201808::NativeStyleService
    end
  end
end; end; end
