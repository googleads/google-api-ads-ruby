...
require 'ad_manager_api/v201808/base_rate_service_registry'

module AdManagerApi; module V201808; module BaseRateService
  class BaseRateService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V201808::BaseRateService
    end
  end
end; end; end
