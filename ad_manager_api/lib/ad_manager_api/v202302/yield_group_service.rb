...
require 'ad_manager_api/v202302/yield_group_service_registry'

module AdManagerApi; module V202302; module YieldGroupService
  class YieldGroupService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202302::YieldGroupService
    end
  end
end; end; end
