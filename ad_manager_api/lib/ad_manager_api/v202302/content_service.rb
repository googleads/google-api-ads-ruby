...
require 'ad_manager_api/v202302/content_service_registry'

module AdManagerApi; module V202302; module ContentService
  class ContentService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202302::ContentService
    end
  end
end; end; end
