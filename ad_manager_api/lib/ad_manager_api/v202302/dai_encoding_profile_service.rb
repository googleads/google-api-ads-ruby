...
require 'ad_manager_api/v202302/dai_encoding_profile_service_registry'

module AdManagerApi; module V202302; module DaiEncodingProfileService
  class DaiEncodingProfileService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202302::DaiEncodingProfileService
    end
  end
end; end; end
