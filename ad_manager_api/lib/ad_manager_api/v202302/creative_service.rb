...
require 'ad_manager_api/v202302/creative_service_registry'

module AdManagerApi; module V202302; module CreativeService
  class CreativeService < AdsCommon::SavonService
    ...
    def get_module()
      return AdManagerApi::V202302::CreativeService
    end
  end
end; end; end
