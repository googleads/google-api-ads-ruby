...
def get_proposals_awaiting_seller_review(ad_manager)
  # Get the ProposalService.
  proposal_service = ad_manager.service(:ProposalService, API_VERSION)

  # Create a statement to select proposals.
  statement = ad_manager.new_statement_builder do |sb|
    sb.where = 'negotiationStatus = :negotiationStatus'
    sb.with_bind_variable('negotiationStatus', 'AWAITING_SELLER_REVIEW')
  end
...
if __FILE__ == $0
  ...
  begin
    get_proposals_awaiting_seller_review(ad_manager)
