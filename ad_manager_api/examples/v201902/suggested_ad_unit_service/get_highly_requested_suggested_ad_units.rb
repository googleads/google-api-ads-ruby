...
def get_highly_requested_suggested_ad_units(ad_manager, num_requests)
  # Get the SuggestedAdUnitService.
  suggested_ad_unit_service =
      ad_manager.service(:SuggestedAdUnitService, API_VERSION)
...
if __FILE__ == $0
  ...
  begin
    num_requests = 50
    get_highly_requested_suggested_ad_units(ad_manager, num_requests)
