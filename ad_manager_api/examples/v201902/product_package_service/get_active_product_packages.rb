...
def get_active_product_packages(ad_manager)
  # Get the ProductPackageService.
  product_package_service = ad_manager.service(
      :ProductPackageService, API_VERSION
  )
...
if __FILE__ == $0
  ...
  begin
    get_active_product_packages(ad_manager)
