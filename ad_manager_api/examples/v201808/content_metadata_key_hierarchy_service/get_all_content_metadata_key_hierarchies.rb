...
def get_all_content_metadata_key_hierarchies(ad_manager)
  content_metadata_key_hierarchy_service =
      ad_manager.service(:ContentMetadataKeyHierarchyService, API_VERSION)
...
if __FILE__ == $0
  ...
  begin
    get_all_content_metadata_key_hierarchies(ad_manager)
