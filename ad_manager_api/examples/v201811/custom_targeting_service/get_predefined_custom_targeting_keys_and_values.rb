...
def get_predefined_custom_targeting_keys_and_values(ad_manager)
  ...
  key_statement = ad_manager.new_statement_builder do |sb|
    sb.where = "type = :type"
...
if __FILE__ == $0
  ...
  begin
    get_predefined_custom_targeting_keys_and_values(ad_manager)
