...
require 'ad_manager_api/v201905/line_item_service'
...
class StubService7 < AdsCommon::SavonService
  ...
  def get_service_registry()
    return AdManagerApi::V201905::LineItemService::LineItemServiceRegistry
  end
end
...
class TestAdManagerIssue7 < Test::Unit::TestCase
  ...
  def get_xml_response_text()
    return <<EOT
  <soap:Body>
    <getLineItemsByStatementResponse xmlns="https://www.google.com/apis/ads/publisher/v201905">
      <rval>
