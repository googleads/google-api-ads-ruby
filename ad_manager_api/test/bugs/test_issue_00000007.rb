...
class StubService7 < AdsCommon::SavonService
  ...
  def get_service_registry()
    return AdManagerApi::V202111::LineItemService::LineItemServiceRegistry
  end
end
...
class TestAdManagerIssue7 < Test::Unit::TestCase
  ...
  def get_xml_response_text()
    return <<EOT
  <soap:Body>
    <getLineItemsByStatementResponse xmlns="https://www.google.com/apis/ads/publisher/v202111">
      <rval>
