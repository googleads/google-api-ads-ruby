...
require 'ad_manager_api/v202511/line_item_service'
...
class StubService81 < AdsCommon::SavonService
  ...
  def get_module()
    return AdManagerApi::V202511::LineItemService
  end
end
...
class TestAdManagerIssue81 < Test::Unit::TestCase
  ...
  def test_issue_81()
    ...
    savon_service =
        StubService81.new(TEST_NAMESPACE, TEST_ENDPOINT, TEST_VERSION)
    assert_instance_of(AdManagerApi::V202511::LineItemService::ApiException,
...
<soap:Envelope xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
  <soap:Header>
    <ResponseHeader xmlns="https://www.google.com/apis/ads/publisher/v202511">
  ...
  <soap:Body>
    <soap:Fault>
      ...
      <detail>
        <ApiExceptionFault
         xmlns="https://www.google.com/apis/ads/publisher/v202511">
          <message>
